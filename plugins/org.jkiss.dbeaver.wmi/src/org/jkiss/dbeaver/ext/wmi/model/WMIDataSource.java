...
import org.jkiss.dbeaver.ext.wmi.WMIDataSourceProvider;
import org.jkiss.dbeaver.ext.wmi.model.plan.MySQLPlanAnalyser;
import org.jkiss.dbeaver.ext.wmi.model.session.MySQLSessionManager;
 ...
 * GenericDataSource
 */
public class WMIDataSource extends JDBCDataSource implements DBSEntitySelector, DBCQueryPlanner, IAdaptable
{
    ...
    {
        return WMIDataSourceProvider.getConnectionsProps();
    }
...
*/
        ...
        throws DBException
    {
        ...
        try {
            JDBCPreparedStatement dbStat = context.prepareStatement("SELECT * FROM wmi.user ORDER BY user");
            try {
                JDBCResultSet dbResult = dbStat.executeQuery();
                try {
    ...
    public List<WMIDataSource> getInformation()
    {
