...
public class PostgreServerDSQL extends PostgreServerPostgreSQL {
    public static final String TYPE_ID = "aurora-dsql";

    public PostgreServerDSQL(PostgreDataSource dataSource) {
        super(dataSource);
    }
