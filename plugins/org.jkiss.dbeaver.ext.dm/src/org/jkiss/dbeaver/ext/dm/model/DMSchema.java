 ...
 * @author Shengkai Bai
 */
public class DMSchema extends GenericSchema implements DBPQualifiedObject, DBPObjectStatisticsCollector {
    private boolean hasStatistics;

    public DMSchema(GenericDataSource dataSource, GenericCatalog catalog, String schemaName) {
        ...
        try (JDBCSession session = DBUtils.openMetaSession(monitor, this, "Load table status")) {
            ...
            try (JDBCResultSet dbResult = dbStat.executeQuery()) {
                while (dbResult.next()) {
                    ...
                    DMTable table = (DMTable) getTable(monitor, tableName);
                    if (table != null) {
