 ...
 * @author Shengkai Bai
 */
public class DMTable extends GenericTable implements DBPObjectStatistics {

    private long tableSize = -1;

    public DMTable(GenericStructContainer container, String tableName, String tableType, JDBCResultSet dbResult) {
        super(container, tableName, tableType, dbResult);
    }

    public DMTable(GenericStructContainer container, String tableName, String tableCatalogName, String tableSchemaName) {
