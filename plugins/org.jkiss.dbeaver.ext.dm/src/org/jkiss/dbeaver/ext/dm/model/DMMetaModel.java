...
public class DMMetaModel extends GenericMetaModel {
    ...
    public JDBCBasicDataTypeCache<GenericStructContainer, ? extends JDBCDataType> createDataTypeCache(GenericStructContainer container) {
        return new DMDataTypeCache(container);
    }
    ...
    @Override
    public DMTableColumn createTableColumnImpl(DBRProgressMonitor monitor, JDBCResultSet dbResult, GenericTableBase table, String columnName, String typeName, int valueType, int sourceType, int ordinalPos, long columnSize, long charLength, Integer scale, Integer precision, int radix, boolean notNull, String remarks, String defaultValue, boolean autoIncrement, boolean autoGenerated) throws DBException {
        return new DMTableColumn(table, columnName, typeName, valueType, sourceType, ordinalPos, columnSize,
