...
public abstract class DmPartitionBase<PARENT extends DBSObject> extends DmObject<PARENT> implements DBSObjectLazy {
	...
	public static class PartitionInfoBase {
		...
		public PartitionInfoBase(DBRProgressMonitor monitor, DmDataSource dataSource, ResultSet dbResult)
				throws DBException {
	...
	protected DmPartitionBase(PARENT parent, boolean subpartition, ResultSet dbResult)
    {
        super(
            parent,
            subpartition ?
