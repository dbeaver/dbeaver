...
function createAttachmentCard(args) {
    ...
    try {
        ...
        items = files.map(f => {
            ...
            return `
        <div class="attachment-item" role="button" tabindex="-1" onclick="window.openFileInExplorer('${escapeAttr(f.path)}');" style="cursor: pointer;" title="Click to show in file explorer">
