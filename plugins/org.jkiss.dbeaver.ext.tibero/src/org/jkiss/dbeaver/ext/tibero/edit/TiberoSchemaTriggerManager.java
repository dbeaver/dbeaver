...
import org.jkiss.dbeaver.ext.tibero.model.TiberoSchemaTrigger;
...
public class TiberoSchemaTriggerManager extends SQLObjectEditor<TiberoSchemaTrigger, TiberoSchema> {
    ...
    @Nullable
    @Override
    public DBSObjectCache<? extends DBSObject, TiberoSchemaTrigger> getObjectsCache(TiberoSchemaTrigger object) {
        return object.getSchema().schemaTriggerCache;
    }

    @Override
    protected TiberoSchemaTrigger createDatabaseObject(
        ...
        throw new UnsupportedOperationException("Tibero schema trigger creation through navigator is not supported yet");
    }
    ...
    protected void addObjectDeleteActions(
        ...
        TiberoSchemaTrigger object = objectDeleteCommand.getObject();
    ...
    private void addCreateOrReplaceAction(@NotNull List<DBEPersistAction> actions, @NotNull TiberoSchemaTrigger trigger) {
        try {
