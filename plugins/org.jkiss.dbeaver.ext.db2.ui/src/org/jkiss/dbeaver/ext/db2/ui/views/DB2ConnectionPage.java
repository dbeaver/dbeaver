...
public class DB2ConnectionPage extends ConnectionPageAbstract implements ICompositeDialogPage {
	...
	public void createControl(Composite composite) {
		...
		{
			Composite addrGroup = UIUtils.createControlGroup(control, DB2Messages.db2_connection_page_tab_database, 4,
					0, 0);
		...
		{
			Composite addrGroup = UIUtils.createControlGroup(control, DB2Messages.db2_connection_page_tab_security, 4,
					0, 0);
			GridData gd = new GridData(GridData.FILL_HORIZONTAL);
			addrGroup.setLayoutData(gd);
	...
	public IDialogPage[] getSubPages(boolean extrasOnly, boolean forceCreate) {
		return new IDialogPage[] { new DB2ConnectionTracePage(), new DriverPropertiesDialogPage(this), };
	}
