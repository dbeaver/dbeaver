...
public final class EasyConfigPageDescriptor extends AbstractDescriptor {
    private final String id;
    private final int order;
    private final ObjectType type;

    EasyConfigPageDescriptor(@NotNull IConfigurationElement config) {
        super(config);
    ...
    @NotNull
    public EasyConfigWizardPage createPage() throws DBException {
        return type.createInstance(EasyConfigWizardPage.class);
    }
}
