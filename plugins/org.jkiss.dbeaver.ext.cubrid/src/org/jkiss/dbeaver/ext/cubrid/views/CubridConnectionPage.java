...
import org.jkiss.dbeaver.ext.cubrid.CubridMessages;
...
/**
 * CubridConnectionPage
 */
public class CubridConnectionPage extends ConnectionPageWithAuth implements IDialogPageProvider {
    private static final Log log = Log.getLog(CubridConnectionPage.class);
    ...
    public void createControl(Composite composite) {
        ...
        settingsGroup = UIUtils.createControlGroup(addrGroup, CubridMessages.dialog_connection_general_tab, 4, GridData.FILL_HORIZONTAL, 0);
...

        {
            ...
            Label urlLabel = UIUtils.createControlLabel(settingsGroup, CubridMessages.dialog_connection_jdbc_url_);
        ...
        }
        {
            ...
            hostLabel.setText(CubridMessages.dialog_connection_host_label);
            ...
            portLabel.setText(CubridMessages.dialog_connection_port_label);
...

        {
            ...
            serverLabel.setText(CubridMessages.dialog_connection_server_label);
...

        {
            ...
            dbLabel.setText(CubridMessages.dialog_connection_database_schema_label);
        ...
        // Path
        {
            ...
            pathLabel.setText(CubridMessages.dialog_connection_path_label);
            ...
            UIUtils.createDialogButton(buttonsPanel, CubridMessages.dialog_connection_browse_button, null, CubridMessages.dialog_connection_browse_button_tip, new SelectionAdapter() {
                @Override
                public void widgetSelected(SelectionEvent e) {
            ...
            if (CommonUtils.toBoolean(site.getDriver().getDriverParameter(CubridConstants.PARAM_SUPPORTS_EMBEDDED_DATABASE_CREATION))) {
                gl.numColumns += 1;
                UIUtils.createDialogButton(
                    buttonsPanel,
                    CubridMessages.dialog_connection_create_button,
                    null,
                    CubridMessages.dialog_connection_create_button_tip,
    ...
    private String showDatabaseFileSelectorDialog(int style) {
        if (metaURL.getAvailableProperties().contains(DBConstants.PROP_FILE)) {
            ...
            dialog.setText(CubridMessages.dialog_connection_db_file_chooser_text);
            return dialog.open();
        } else {
            ...
            dialog.setText(CubridMessages.dialog_connection_db_folder_chooser_text);
            dialog.setMessage(CubridMessages.dialog_connection_db_folder_chooser_message);
            return dialog.open();
        }
    }
    ...
    private boolean canCreateEmbeddedDatabase() {
        final String param = CommonUtils.toString(site.getDriver().getDriverParameter(CubridConstants.PARAM_CREATE_URL_PARAM));
        return !CommonUtils.isEmpty(param) && !CommonUtils.isEmptyTrimmed(pathText.getText());
    }

    private void createEmbeddedDatabase() {
        String paramCreate = CommonUtils.toString(site.getDriver().getDriverParameter(CubridConstants.PARAM_CREATE_URL_PARAM));
