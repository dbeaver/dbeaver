 ...
 */
public class CubridMetaObject {

    private final String type;
    private final String readQuery;
    private final Map<String, CubridMetaColumn> columnsMap = new HashMap<>();

    public CubridMetaObject(IConfigurationElement cfg)
    {
        ...
        for (IConfigurationElement columnCfg : cfg.getChildren("column")) {
            CubridMetaColumn column = new CubridMetaColumn(columnCfg);
    ...
    public CubridMetaColumn getColumn(String id)
    {
