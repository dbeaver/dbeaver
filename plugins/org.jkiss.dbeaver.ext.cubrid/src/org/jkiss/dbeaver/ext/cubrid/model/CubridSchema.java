 ...
 * CubridSchema
 */
public class CubridSchema extends CubridObjectContainer implements DBSSchema, DBPSystemObject, DBPVirtualObject
{
    @Nullable
    private final CubridCatalog catalog;
    @NotNull
    private final String schemaName;
    private boolean virtualSchema;

    public CubridSchema(@NotNull CubridDataSource dataSource, @Nullable CubridCatalog catalog, @NotNull String schemaName)
    {
        super(dataSource);
