...
/**
 * CubridTableForeignKey
 */
public class CubridTableForeignKey extends JDBCTableForeignKey<CubridTableBase, DBSEntityReferrer> {
    private static final Log log = Log.getLog(CubridTableForeignKey.class);

    private DBSForeignKeyDeferability deferability;
    private List<CubridTableForeignKeyColumnTable> columns;
    ...
    @Override
    public List<CubridTableForeignKeyColumnTable> getAttributeReferences(DBRProgressMonitor monitor) {
        return columns;
    }

    public void addColumn(CubridTableForeignKeyColumnTable column) {
        if (columns == null) {
    ...
    void setColumns(DBRProgressMonitor monitor, List<CubridTableForeignKeyColumnTable> columns) {
