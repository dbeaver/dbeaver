 ...
 * Object type support
 */
public class CubridTimestampValueHandler extends JDBCDateTimeValueHandler {

    private final CubridDataSource dataSource;

    public CubridTimestampValueHandler(CubridDataSource dataSource, DBDFormatSettings formatSettings)
    {
