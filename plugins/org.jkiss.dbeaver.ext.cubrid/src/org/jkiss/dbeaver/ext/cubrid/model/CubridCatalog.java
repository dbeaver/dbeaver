 ...
 * CubridCatalog
 */
public class CubridCatalog extends CubridObjectContainer implements DBSCatalog
{
    private final String catalogName;
    private List<CubridSchema> schemas;
    private boolean isInitialized = false;

    public CubridCatalog(@NotNull CubridDataSource dataSource, @NotNull String catalogName)
    {
        super(dataSource);
    ...
    @Override
    public CubridCatalog getObject()
    {
        return this;
    }

    public Collection<CubridSchema> getSchemaList(DBRProgressMonitor monitor)
        throws DBException
    {
    ...
    @Association
    public Collection<CubridSchema> getSchemas(DBRProgressMonitor monitor)
        throws DBException
    {
    ...
    public CubridSchema getSchema(DBRProgressMonitor monitor, String name)
        throws DBException
    {
