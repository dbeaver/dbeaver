 ...
 * CubridPackage
 */
public class CubridPackage extends CubridObjectContainer implements DBPQualifiedObject, CubridScriptObject, DBSPackage
{
    ...
    public void hasProcedure(CubridProcedure procedure)
    {
        procedures.add(procedure);
    }
