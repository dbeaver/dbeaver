 ...
 * CubridDataType
 */
public class CubridDataTypeArray extends CubridDataType
{
    private DBSDataType componentType;

    public CubridDataTypeArray(CubridStructContainer owner, int valueType, String name, @Nullable String remarks, DBSDataType componentDataType) {
        super(owner, valueType, name, remarks, false, false, 0, 0, 0);
        this.componentType = componentDataType;
    }

    public CubridDataTypeArray(CubridStructContainer owner, DBSTypedObject typed) {
        super(owner, typed);
    }
