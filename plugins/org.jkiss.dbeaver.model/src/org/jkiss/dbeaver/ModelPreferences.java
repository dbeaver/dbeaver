...
public final class ModelPreferences
{
    ...
    public static final String REPRESENTATION_CONTENT_MAX_SIZE_KBYTES = "representation.content.max.size";  //$NON-NLS-1$
    ...
    private static void initializeDefaultPreferences(DBPPreferenceStore store) {
        ...
        // Editor
        PrefUtils.setDefaultPreferenceValue(store, ModelPreferences.REPRESENTATION_CONTENT_MAX_SIZE_KBYTES, 1000);
