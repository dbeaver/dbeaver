...
public final class ModelPreferences
{
    ...
    public static final String SQL_PARAMETERS_IN_DDL_AND_DOLLAR_CODE_BLOCKS_ENABLED = "sql.parameter.ddl.dollar.code.blocks.enabled"; //$NON-NLS-1$
    ...
    private static void initializeDefaultPreferences(DBPPreferenceStore store) {
        ...
        PrefUtils.setDefaultPreferenceValue(store, SQL_PARAMETERS_IN_DDL_AND_DOLLAR_CODE_BLOCKS_ENABLED, false);
