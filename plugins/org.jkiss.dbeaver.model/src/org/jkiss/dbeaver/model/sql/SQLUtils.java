...
//        }
    ...
    public static String addQueryIdentificationComment(@NotNull DBCSession session, @NotNull String query) {
        if (query.contains("Query automatically generated by")) {
            return query;
        }
        ...
        return generateCommentLine(session.getDataSource(), "Query automatically generated by " + GeneralUtils.getProductName()) + query;
    }
