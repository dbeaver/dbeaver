...
public final class DBUtils {
    ...
    public static Collection<? extends DBSEntityAttribute> getRealAttributes(Collection<? extends DBSEntityAttribute> attributes) {
        ArrayList<DBSEntityAttribute> list = new ArrayList<>();
