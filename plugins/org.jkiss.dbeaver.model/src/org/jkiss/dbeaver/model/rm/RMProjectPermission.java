...
public enum RMProjectPermission {
    CONNECTIONS_VIEW(RMConstants.PERMISSION_PROJECT_CONNECTIONS_VIEW),
    CONNECTIONS_EDIT(RMConstants.PERMISSION_PROJECT_CONNECTIONS_EDIT, Set.of(CONNECTIONS_VIEW)),
    ...
    TASKS_VIEW(RMConstants.PERMISSION_PROJECT_TASKS_VIEW),
    TASKS_EDIT(RMConstants.PERMISSION_PROJECT_TASKS_EDIT, Set.of(TASKS_VIEW)),

    PROJECT_ADMIN(RMConstants.PERMISSION_PROJECT_ADMIN, Set.of(RESOURCE_EDIT, CONNECTIONS_EDIT));
