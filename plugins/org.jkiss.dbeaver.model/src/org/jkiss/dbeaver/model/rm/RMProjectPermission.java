...
public enum RMProjectPermission {
    DATA_SOURCES_VIEW(RMConstants.PERMISSION_PROJECT_DATA_SOURCES_VIEW),
    DATA_SOURCES_EDIT(RMConstants.PERMISSION_PROJECT_DATA_SOURCES_EDIT, Set.of(DATA_SOURCES_VIEW)),
