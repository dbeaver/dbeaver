...
public final class DBStructUtils {
    ...
    public static String getTableDDL(@NotNull DBRProgressMonitor monitor, @NotNull DBSEntity table, Map<String, Object> options,
        ...
        if (table instanceof DBPScriptObject scriptObject) {
            ...
            if (!CommonUtils.isEmpty(definitionText)) {
                ...
                if (isCompact) {
                    table.getDataSource().getSQLDialect();
