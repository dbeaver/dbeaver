...
public class RelationalObjectType extends AbstractObjectType {
    ...
    public static final DBSObjectType TYPE_PACKAGE = new RelationalObjectType("Package", "Package", DBIcon.TREE_PACKAGE, DBSObject.class);
    public static final DBSObjectType TYPE_SYNONYM = new RelationalObjectType("Synonym", "Synonym", DBIcon.TREE_SYNONYM, DBSObject.class);
