...
public class SQLDialectQueryGenerator implements DialectQueryGenerator {
    private Log log = Log.getLog(SQLDialectQueryGenerator.class);

    public static SQLDialectQueryGenerator INSTANCE = new SQLDialectQueryGenerator();
    ...
    private SQLDialectQueryGenerator() {
