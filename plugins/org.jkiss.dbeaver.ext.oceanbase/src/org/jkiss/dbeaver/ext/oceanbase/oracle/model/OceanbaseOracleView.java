...
public class OceanbaseOracleView extends OracleView{
	...
	private void loadAdditionalInfo(DBRProgressMonitor monitor) throws DBException
    {
        ...
        try (JDBCSession session = DBUtils.openMetaSession(monitor, this, "Load table status")) {
            ...
            try (JDBCPreparedStatement dbStat = session.prepareStatement(
                "SELECT TEXT,OID_TEXT,VIEW_TYPE" + (isOracle9 ? ",SUPERVIEW_NAME" : "") + "\n" +
    ...
    public OracleTableColumn getAttribute(@NotNull DBRProgressMonitor monitor, @NotNull String attributeName)
            throws DBException
    {
        return ((OceanbaseOracleSchema)getContainer()).oceanbaseTableCache.getChild(monitor, (OceanbaseOracleSchema)getContainer(), this, attributeName);
    }
    ...
    public List<OracleTableColumn> getAttributes(@NotNull DBRProgressMonitor monitor)
        throws DBException
    {
        return ((OceanbaseOracleSchema)getContainer()).oceanbaseTableCache.getChildren(monitor, (OceanbaseOracleSchema)getContainer(), this);
    }
    ...
    public DBSObject refreshObject(@NotNull DBRProgressMonitor monitor) throws DBException {
        ...
        return ((OceanbaseOracleSchema)getContainer()).oceanbaseTableCache.refreshObject(monitor, (OceanbaseOracleSchema)getContainer(), this);
	}
