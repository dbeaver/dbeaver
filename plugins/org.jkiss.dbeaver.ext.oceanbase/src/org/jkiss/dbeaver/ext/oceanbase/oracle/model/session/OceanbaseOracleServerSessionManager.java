...
public class OceanbaseOracleServerSessionManager implements DBAServerSessionManager<OceanbaseOracleServerSession>,
	...
	@Override
	public Collection<OceanbaseOracleServerSession> getSessions(DBCSession session, Map<String, Object> options)
			throws DBException {
		try {
