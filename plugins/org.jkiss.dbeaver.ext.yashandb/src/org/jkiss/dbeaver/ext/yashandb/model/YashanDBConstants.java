...
public class YashanDBConstants {
    ...
    public static final String CMD_COMPILE = "org.jkiss.dbeaver.ext.yashan.code.compile";
    ...
    /**
     * It will be filtered according to the schema list shown here.
     */
    public static final String[] SYSTEM_SCHEMAS = {

    };

    public static final String PREF_EXPLAIN_TABLE_NAME = "yashan.explain.table";
    ...
    public static final String TYPE_YASHAN_GEOMETRY = "MDSYS.\"MDSYS.ST_GEOMETRY\"";
    ...
    public static final String PREF_DBMS_READ_ALL_SYNONYMS = "yashan.read.all.synonyms";
