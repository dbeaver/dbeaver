...
//        this.state = JDBCUtils.safeGetString(dbResult, "STATE");
        ...
        this.sqlChildNumber = JDBCUtils.safeGetLong(dbResult, "SQL_CHILD_NUMBER");//v$session没有设置此字段，使用v$sql的代替
        this.sql = JDBCUtils.safeGetString(dbResult, "SQL_TEXT");//v$sql的sql_full_text字段展示哟问题，暂时用sql_Text替代
...
//        this.blockGets = JDBCUtils.safeGetLong(dbResult, "BLOCK_GETS"); yashandb么有v$sessio视图，这些字段不展示
...
//    }
    ...
    public boolean equals(Object o) {
        ...
        YashanDBServerSession that = (YashanDBServerSession) o;
