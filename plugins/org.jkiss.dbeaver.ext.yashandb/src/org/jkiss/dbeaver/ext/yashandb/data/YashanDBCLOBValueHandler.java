 ...
 * CLOB handler
 */
public class YashanDBCLOBValueHandler extends JDBCContentValueHandler {

    public static final YashanDBCLOBValueHandler INSTANCE = new YashanDBCLOBValueHandler();
