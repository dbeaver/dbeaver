...
/**
 * YashanDB geometry handler
 */
public class YashanDBGeometryValueHandler extends JDBCAbstractValueHandler {
    public static final YashanDBGeometryValueHandler INSTANCE = new YashanDBGeometryValueHandler();

    private static final Log log = Log.getLog(YashanDBGeometryValueHandler.class);
    ...
    protected void bindParameter(JDBCSession session, JDBCPreparedStatement statement, DBSTypedObject paramType, int paramIndex, Object value) throws DBCException, SQLException {
        ...
        } else if (value.getClass().getName().equals(YashanDBConstants.GEOMETRY_CLASS_NAME)) {
    ...
    public Object getValueFromObject(@NotNull DBCSession session, @NotNull DBSTypedObject type, Object object, boolean copy, boolean validateValue) throws DBCException {
        ...
        } else if (object.getClass().getName().equals(YashanDBConstants.GEOMETRY_CLASS_NAME)) {
            return makeGeometryFromPGGeometry(session, object);
        } else if (YashanDBUtils.isYashanDBObject(object)) {
            return makeGeometryFromWKB(CommonUtils.toString(YashanDBUtils.extractYashanDBObjectValue(object)));
        } else {
