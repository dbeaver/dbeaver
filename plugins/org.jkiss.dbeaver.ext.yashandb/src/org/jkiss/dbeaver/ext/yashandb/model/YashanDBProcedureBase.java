...
public abstract class YashanDBProcedureBase<PARENT extends DBSObjectContainer> extends YashanDBObject<PARENT>
	...
	public YashanDBProcedureBase(PARENT parent, String name, long objectId, DBSProcedureType procedureType) {
	...
	static class ArgumentsCache extends JDBCObjectCache<YashanDBProcedureBase, YashanDBProcedureArgument> {
		...
		protected JDBCStatement prepareObjectsStatement(@NotNull JDBCSession session,
				@NotNull YashanDBProcedureBase procedure) throws SQLException {
			JDBCPreparedStatement dbStat = session.prepareStatement(
					"SELECT * FROM " + YashanDBUtils.isAdminPriv(procedure.getDataSource(), "ARGUMENTS") + " WHERE "
		...
		@Override
		protected YashanDBProcedureArgument fetchObject(@NotNull JDBCSession session,
				@NotNull YashanDBProcedureBase procedure, @NotNull JDBCResultSet resultSet)
				throws SQLException, DBException {
			return new YashanDBProcedureArgument(session.getProgressMonitor(), procedure, resultSet);
		}

		@Override
		protected void invalidateObjects(DBRProgressMonitor monitor, YashanDBProcedureBase owner,
				Iterator<YashanDBProcedureArgument> objectIter) {
