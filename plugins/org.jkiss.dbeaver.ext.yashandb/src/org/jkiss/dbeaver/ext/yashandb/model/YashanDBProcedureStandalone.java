 ...
 * @Description:
 */
public class YashanDBProcedureStandalone extends YashanDBProcedureBase<YashanDBSchema> implements YashanDBSourceObject, DBPRefreshableObject {
...
//               DBSProcedureType.valueOf(JDBCUtils.safeGetString(dbResult, "OBJECT_TYPE")));
    ...
    public YashanDBSourceType getSourceType() {
        return getProcedureType() == DBSProcedureType.PROCEDURE ?
                YashanDBSourceType.PROCEDURE :YashanDBSourceType.UDF;
        ...
        return new DBEPersistAction[]{
                new YashanDBObjectPersistAction(
                        getProcedureType() == DBSProcedureType.PROCEDURE ?
                                YashanDBObjectType.PROCEDURE : YashanDBObjectType.FUNCTION,
                        "Compile procedure",
