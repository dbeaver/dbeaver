 ...
 */
public class YashanDBServerSessionManager implements DBAServerSessionManager<YashanDBServerSession>, DBAServerSessionManagerSQL, DBAServerSessionDetailsProvider {
...
//    public static final String PROP_IMMEDIATE = "immediate";
    ...
    @Override
    public Collection<YashanDBServerSession> getSessions(DBCSession session, Map<String, Object> options) throws DBException {
        try {
    ...
    @Override
    public void alterSession(DBCSession session, YashanDBServerSession sessionType, Map<String, Object> options) throws DBException
    {
