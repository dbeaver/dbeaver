...
public class YashanDBDataTypeAttribute extends YashanDBDataTypeMember implements DBSEntityAttribute, DBSTypedObjectEx {
	...
	public YashanDBDataTypeAttribute(DBRProgressMonitor monitor, YashanDBDataType dataType, ResultSet dbResult) {
		...
		this.attrType = YashanDBDataType.resolveDataType(monitor, getDataSource(),
