 ...
 * CLOB handler
 */
public class YashanDBBLOBValueHandler extends JDBCContentValueHandler {

    public static final YashanDBBLOBValueHandler INSTANCE = new YashanDBBLOBValueHandler();
            ...
            throws DBCException, SQLException
    {
        ...
        }else if(value.toString().equals("[BLOB]")){

            //YasBlob yasBlob = new YasBlob(true);
            //yasBlob.setBytes(1, value1.getBytes(1, (int)value1.length()));
           //statement.setBlob(paramIndex, yasBlob);
           statement.setBinaryStream(paramIndex,  ((Blob)((JDBCContentBLOB) value).getRawValue()).getBinaryStream());
        }
        else {
