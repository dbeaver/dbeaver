 ...
 * @Description:
 */
public class YashanDBPackage extends YashanDBSchemaObject
        implements YashanDBSourceObject, DBPScriptObjectExt, DBSObjectContainer, DBSPackage, DBPRefreshableObject, DBSProcedureContainer {
    ...
    public DBEPersistAction[] getCompileActions(DBRProgressMonitor monitor) {
        ...
        try {
            if (!CommonUtils.isEmpty(getExtendedDefinitionText(monitor))) {
                actions.add(
                        new YashanDBObjectPersistAction(
                                YashanDBObjectType.PACKAGE_BODY,
    ...
    static class ProceduresCache extends JDBCObjectCache<YashanDBPackage, YashanDBProcedurePackaged> {
        ...
        @Override
        protected YashanDBProcedurePackaged fetchObject(@NotNull JDBCSession session, @NotNull YashanDBPackage owner, @NotNull JDBCResultSet dbResult)
                throws SQLException, DBException {
            return new YashanDBProcedurePackaged(owner, dbResult);
        }

        @Override
        protected void invalidateObjects(DBRProgressMonitor monitor, YashanDBPackage owner, Iterator<YashanDBProcedurePackaged> objectIter) {
