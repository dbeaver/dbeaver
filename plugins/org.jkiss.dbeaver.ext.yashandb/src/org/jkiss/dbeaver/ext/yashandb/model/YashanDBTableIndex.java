 ...
 * YashanDBTableIndex
 */
public class YashanDBTableIndex extends JDBCTableIndex<YashanDBSchema, YashanDBTablePhysical> implements DBSObjectLazy, DBPScriptObject {
    ...
    public YashanDBTableIndex(
            YashanDBSchema schema,
            YashanDBTablePhysical table,
            String indexName,
            ResultSet dbResult) {
        ...
        } else if (YashanDBConstants.INDEX_TYPE_BITMAP.getId().equals(indexTypeName)) {
            indexType = YashanDBConstants.INDEX_TYPE_BITMAP;
        ...
        } else if (YashanDBConstants.INDEX_TYPE_FUNCTION_BASED_BITMAP.getId().equals(indexTypeName)) {
            indexType = YashanDBConstants.INDEX_TYPE_FUNCTION_BASED_BITMAP;
        } else if (YashanDBConstants.INDEX_TYPE_DOMAIN.getId().equals(indexTypeName)) {
            indexType = YashanDBConstants.INDEX_TYPE_DOMAIN;
        } else {
    ...
    public YashanDBTableIndex(YashanDBSchema schema, YashanDBTablePhysical parent, String name, boolean unique, DBSIndexType indexType) {
