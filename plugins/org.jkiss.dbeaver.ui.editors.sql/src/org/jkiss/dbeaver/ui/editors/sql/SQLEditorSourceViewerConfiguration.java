...
public class SQLEditorSourceViewerConfiguration extends TextSourceViewerConfiguration {
    ...
    public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer) {
        ...
        addContentTypeDamageRepairer(reconciler, SQLParserPartitions.CONTENT_TYPE_SQL_MULTILINE_COMMENT, SQLEditorThemeConstants.SQL_EDITOR_COLOR_COMMENT);
        // Add a "damager-repairer" for changes within one-line SQL comments.
        addContentTypeDamageRepairer(reconciler, SQLParserPartitions.CONTENT_TYPE_SQL_COMMENT, SQLEditorThemeConstants.SQL_EDITOR_COLOR_COMMENT);
        ...
        if (SQLEditorUtils.isSQLSyntaxParserApplied(sqlEditor.getEditorInput())) {
            ...
            if (sqlEditor.isAdvancedHighlightingEnabled()) {
                ...
                // Add a "damager-repairer" for changes within quoted literals.
                addContentTypeDamageRepairer(reconciler, SQLParserPartitions.CONTENT_TYPE_SQL_QUOTED, SQLEditorThemeConstants.SQL_EDITOR_COLOR_DATATYPE);
            }
        } else {
            // Add a "damager-repairer" for changes within string literals.
            addContentTypeDamageRepairer(reconciler, SQLParserPartitions.CONTENT_TYPE_SQL_STRING, SQLEditorThemeConstants.SQL_EDITOR_COLOR_STRING);
            // Add a "damager-repairer" for changes within quoted literals.
            addContentTypeDamageRepairer(reconciler, SQLParserPartitions.CONTENT_TYPE_SQL_QUOTED, SQLEditorThemeConstants.SQL_EDITOR_COLOR_DATATYPE);
        }
