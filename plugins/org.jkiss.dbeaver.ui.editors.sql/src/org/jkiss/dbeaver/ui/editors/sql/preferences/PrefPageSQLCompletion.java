...
public class PrefPageSQLCompletion extends TargetPrefPage
{
    ...
    protected Control createPreferenceContent(Composite parent)
    {
        ...
        // Content assistant
        {
            ...
            csInsertCase.add(SQLEditorMessages.pref_page_sql_completion_double_click_behavior_default);
            csInsertCase.add(SQLEditorMessages.pref_page_sql_completion_double_click_behavior_upper_case);
            csInsertCase.add(SQLEditorMessages.pref_page_sql_completion_double_click_behavior_lower_case);
