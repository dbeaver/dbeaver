...
public class PrefPageSQLExecute extends TargetPrefPage
{
    ...
    private Button enableParametersInDDLAndDollarCodeBlocks;
    ...
    protected boolean hasDataSourceSpecificOptions(DBPDataSourceContainer dataSourceDescriptor)
    {
        ...
        return
            ...
            store.contains(ModelPreferences.SQL_PARAMETERS_IN_DDL_AND_DOLLAR_CODE_BLOCKS_ENABLED) ||
    ...
    protected Control createPreferenceContent(Composite parent)
    {
        ...
        // Parameters
        {
            ...
            enableParametersInDDLAndDollarCodeBlocks = UIUtils.createCheckbox(paramsGroup, SQLEditorMessages.pref_page_sql_editor_enable_parameters_in_ddl, SQLEditorMessages.pref_page_sql_editor_enable_parameters_in_ddl_tip, false, 2);
    ...
    protected void loadPreferences(DBPPreferenceStore store)
    {
        try {
            ...
            enableParametersInDDLAndDollarCodeBlocks.setSelection(store.getBoolean(ModelPreferences.SQL_PARAMETERS_IN_DDL_AND_DOLLAR_CODE_BLOCKS_ENABLED));
    ...
    protected void savePreferences(DBPPreferenceStore store)
    {
        try {
            ...
            store.setValue(ModelPreferences.SQL_PARAMETERS_IN_DDL_AND_DOLLAR_CODE_BLOCKS_ENABLED, enableParametersInDDLAndDollarCodeBlocks.getSelection());
    ...
    protected void clearPreferences(DBPPreferenceStore store)
    {
        ...
        store.setToDefault(ModelPreferences.SQL_PARAMETERS_IN_DDL_AND_DOLLAR_CODE_BLOCKS_ENABLED);
