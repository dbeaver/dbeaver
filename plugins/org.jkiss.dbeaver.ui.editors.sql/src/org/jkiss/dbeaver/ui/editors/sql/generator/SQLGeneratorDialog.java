...
class SQLGeneratorDialog extends ViewSQLDialog {
    ...
    private static final String PROP_USE_SEPARATE_CONSTRAINT_INDEXES = "GenerateSQL.useSeparateConstraintIndexes";
    ...
    protected Composite createDialogArea(Composite parent) {
        ...
        sqlGenerator.setUseSeparateConstraintIndexes(getDialogBoundsSettings().get(PROP_USE_SEPARATE_CONSTRAINT_INDEXES) != null &&
                getDialogBoundsSettings().getBoolean(PROP_USE_SEPARATE_CONSTRAINT_INDEXES));
        ...
        boolean supportSeparateConstraintIndexes = false;
        ...
        for (Object object : sqlGenerator.getObjects()) {
            if (object instanceof DBPScriptObjectExt2 sourceObject) {
                ...
                if (sourceObject.supportsObjectDefinitionOption(DBPScriptObject.OPTION_DDL_SEPARATE_CONSTRAINT_INDEXES)) {
                    supportSeparateConstraintIndexes = true;
                }
        ...
        useFQNames.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
        ...
        useCompactSQL.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
        ...
        if (sqlGenerator.isInsertOption()) {
            ...
            excludeAutoGeneratedColumn.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
        ...
        if (sqlGenerator.isDMLOption()) {
            ...
            useCustomDateFormat.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
        ...
        if (sqlGenerator.isDDLOption()) {
            if (supportComments) {
                ...
                useShowComments.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
            ...
            if (supportPermissions) {
                ...
                useShowPermissions.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
        ...
        if (supportFullDDL) {
            ...
            useShowFullDdl.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
        ...
        if (supportSeparateFKStatements) {
            ...
            useSeparateFkStatements.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
        ...
        if (supportSeparateConstraintIndexes) {
            Button useSeparateConstraintIndexes = UIUtils.createCheckbox(
                settings,
        ...
        if (supportsPartitionsDDL) {
            ...
            supportsPartitionsDDLButton.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
        ...
        if (sqlGenerator.supportCastParams()) {
            ...
            supportsCastParamsButton.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
        ...
        if (supportsFormatting) {
            ...
            chkFormatSql.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
