...
/**
 * Abstract handler for trimming spaces from text
 */
public abstract class AbstractTrimSpacesHandler extends AbstractTextHandler {
                        ...
                        if (textSelection.getLength() > 0) {
                            ...
                            if (startLine != endLine) {
                                ...
                                for (int i = startLine; i <= endLine; i++) {
                                    ...
                                    allStrings.append(trimString(untrimmedString));
                                    if (i != endLine) {
                                ...
                                String trimmedSelection = trimString(textSelection.getText());
                            ...
                            String trimmedString = trimString(untrimmedString);
