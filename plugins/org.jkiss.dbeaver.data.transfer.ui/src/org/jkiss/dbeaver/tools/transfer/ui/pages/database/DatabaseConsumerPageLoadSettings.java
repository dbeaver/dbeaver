...
public class DatabaseConsumerPageLoadSettings extends ActiveWizardPage<DataTransferWizard> {
    ...
    public DatabaseConsumerPageLoadSettings() {
        super(DTUIMessages.data_transfer_wizard_final_data_load);
        setTitle(DTUIMessages.data_transfer_wizard_final_data_load_settings);
        setDescription(DTUIMessages.data_transfer_wizard_final_configuration_of_table_data_load);
    }
    ...
    public void createControl(Composite parent) {
        ...
        {
            Group loadSettings = UIUtils.createControlGroup(composite, DTUIMessages.data_transfer_wizard_final_data_load, 1, GridData.FILL_HORIZONTAL, 0);

            transferAutoGeneratedColumns = UIUtils.createCheckbox(
                loadSettings,
                DTUIMessages.data_transfer_wizard_final_data_load_transger_auto_generated_columns,
                DTUIMessages.data_transfer_wizard_final_data_load_transger_auto_generated_columns_tooltip,
            ...
            truncateTargetTable = UIUtils.createCheckbox(loadSettings, DTUIMessages.data_transfer_wizard_final_data_load_truncate_target_table_before_load, settings.isTruncateBeforeLoad());
        ...
        {
            Group performanceSettings = UIUtils.createControlGroup(composite, DTUIMessages.data_transfer_wizard_final_performance, 4, GridData.FILL_HORIZONTAL, 0);
            ...
            final Button useTransactionsCheck = UIUtils.createCheckbox(performanceSettings, DTUIMessages.data_transfer_wizard_final_performance_use_transactions, null, settings.isUseTransactions(), 4);
            ...
            final Spinner commitAfterEdit = UIUtils.createLabelSpinner(performanceSettings, DTUIMessages.data_transfer_wizard_final_performance_commit_after_insert_of, settings.getCommitAfterRows(), 1, Integer.MAX_VALUE);
        ...
        {
            Group generalSettings = UIUtils.createControlGroup(composite, DTUIMessages.data_transfer_wizard_final_general, 4, GridData.FILL_HORIZONTAL, 0);
            final Button showTableCheckbox = UIUtils.createCheckbox(generalSettings, DTUIMessages.data_transfer_wizard_final_general_open_table_editor_on_finish, null, settings.isOpenTableOnFinish(), 4);
            ...
            final Button showFinalMessageCheckbox = UIUtils.createCheckbox(generalSettings, DTUIMessages.data_transfer_wizard_final_general_show_finish_message, null, getWizard().getSettings().isShowFinalMessage(), 4);
    ...
    private boolean confirmDataTruncate() {
        ...
        if (shell.isVisible() || getSettings().isTruncateBeforeLoad()) {
            ...
            if (!UIUtils.confirmAction(shell, 
            		DTUIMessages.data_transfer_wizard_final_data_load_truncate_attention, 
            		NLS.bind(DTUIMessages.data_transfer_wizard_final_data_load_remove_all_data_from_target_table_task, tableNames)))
            {
                return false;
            }
        }
