...
public class DatabaseConsumerPageLoadSettings extends ActiveWizardPage<DataTransferWizard> {
    ...
    public DatabaseConsumerPageLoadSettings() {
        super(DTUIMessages.data_transfer_wizard_output_name);
        setTitle(DTUIMessages.data_transfer_wizard_output_title);
        setDescription(DTUIMessages.data_transfer_wizard_output_description);
    }
    ...
    public void createControl(Composite parent) {
        ...
        {
            Group loadSettings = UIUtils.createControlGroup(composite, DTUIMessages.data_transfer_wizard_output_group_data_load, 1, GridData.FILL_HORIZONTAL, 0);

            transferAutoGeneratedColumns = UIUtils.createCheckbox(
                loadSettings,
                DTUIMessages.data_transfer_wizard_output_checkbox_transfer_auto_generated_columns,
                DTUIMessages.data_transfer_wizard_output_hover_transfer_auto_generated_columns,
            ...
            truncateTargetTable = UIUtils.createCheckbox(loadSettings, DTUIMessages.data_transfer_wizard_output_checkbox_truncate_target_table_before_load, settings.isTruncateBeforeLoad());
        ...
        {
            Group performanceSettings = UIUtils.createControlGroup(composite, DTUIMessages.data_transfer_wizard_output_group_perfomance, 4, GridData.FILL_HORIZONTAL, 0);
            ...
            final Spinner commitAfterEdit = UIUtils.createLabelSpinner(performanceSettings, DTUIMessages.data_transfer_wizard_output_label_commit_after_insert_of, settings.getCommitAfterRows(), 1, Integer.MAX_VALUE);
        ...
        {
            Group generalSettings = UIUtils.createControlGroup(composite, DTUIMessages.data_transfer_wizard_output_group_general, 4, GridData.FILL_HORIZONTAL, 0);
            final Button showTableCheckbox = UIUtils.createCheckbox(generalSettings, DTUIMessages.data_transfer_wizard_output_checkbox_table_editor_on_finish, null, settings.isOpenTableOnFinish(), 4);
            ...
            final Button showFinalMessageCheckbox = UIUtils.createCheckbox(generalSettings, DTUIMessages.data_transfer_wizard_output_checkbox_finish_message, null, getWizard().getSettings().isShowFinalMessage(), 4);
    ...
    private boolean confirmDataTruncate() {
        ...
        if (shell.isVisible() || getSettings().isTruncateBeforeLoad()) {
            ...
            if (!UIUtils.confirmAction(shell, DTUIMessages.data_transfer_wizard_output_dialog_directory_message, DTUIMessages.data_transfer_wizard_output_dialog_directory_text_first_lane +
                DTUIMessages.data_transfer_wizard_output_dialog_directory_text_second_lane + tableNames + ").\n" +
                DTUIMessages.data_transfer_wizard_output_dialog_directory_text_third_lane +
                DTUIMessages.data_transfer_wizard_output_dialog_directory_text_fourth_lane))
            {
                return false;
            }
        }
