...
public class DatabaseConsumerPageLoadSettings extends ActiveWizardPage<DataTransferWizard> {
    ...
    public DatabaseConsumerPageLoadSettings() {
        ...
        super(DTUIMessages.data_transfer_data_load);
        setTitle(DTUIMessages.data_transfer_data_load_settings);
        setDescription(DTUIMessages.data_transfer_configuration_of_the_table_data_load);
    }
    ...
    public void createControl(Composite parent) {
        ...
        {
            Group loadSettings = UIUtils.createControlGroup(composite, DTUIMessages.data_transfer_data_load, 1, GridData.FILL_HORIZONTAL, 0);

            transferAutoGeneratedColumns = UIUtils.createCheckbox(
                loadSettings,
                DTUIMessages.data_transfer_transfer_auto_generated_columns,
                DTUIMessages.data_transfer_transfer_values_of_auto_generated_columns_description,
            ...
            truncateTargetTable = UIUtils.createCheckbox(loadSettings, DTUIMessages.data_transfer_truncate_target_table_before_load, settings.isTruncateBeforeLoad());
        ...
        {
            Group performanceSettings = UIUtils.createControlGroup(composite, DTUIMessages.data_transfer_performance, 4, GridData.FILL_HORIZONTAL, 0);
            ...
            final Button useTransactionsCheck = UIUtils.createCheckbox(performanceSettings, DTUIMessages.data_transfer_use_transactions, null, settings.isUseTransactions(), 4);
            ...
            final Spinner commitAfterEdit = UIUtils.createLabelSpinner(performanceSettings, DTUIMessages.data_transfer_commit_after_insert_of, settings.getCommitAfterRows(), 1, Integer.MAX_VALUE);
        ...
        {
            Group generalSettings = UIUtils.createControlGroup(composite, DTUIMessages.data_transfer_general, 4, GridData.FILL_HORIZONTAL, 0);
            final Button showTableCheckbox = UIUtils.createCheckbox(generalSettings, DTUIMessages.data_transfer_open_table_editor_on_finish, null, settings.isOpenTableOnFinish(), 4);
            ...
            final Button showFinalMessageCheckbox = UIUtils.createCheckbox(generalSettings, DTUIMessages.data_transfer_show_finish_message, null, getWizard().getSettings().isShowFinalMessage(), 4);
    ...
    private boolean confirmDataTruncate() {
        ...
        if (shell.isVisible() || getSettings().isTruncateBeforeLoad()) {
            ...
            if (!UIUtils.confirmAction(shell, DTUIMessages.data_transfer_confirmDataTruncate_method_description_1, tableNames +
                DTUIMessages.data_transfer_confirmDataTruncate_method_description_2))
            {
                return false;
            }
        }
