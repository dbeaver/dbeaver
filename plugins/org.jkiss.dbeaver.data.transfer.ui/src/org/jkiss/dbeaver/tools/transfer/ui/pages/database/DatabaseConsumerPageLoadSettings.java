...
public class DatabaseConsumerPageLoadSettings extends DataTransferPageNodeSettings {
    ...
    public void createControl(Composite parent) {
...

        {
            ...
            transferAutoGeneratedColumns.addSelectionListener(SelectionListener.widgetSelectedAdapter(e ->
            ...
            truncateTargetTable.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
            ...
            disableReferentialIntegrity.addSelectionListener(SelectionListener.widgetSelectedAdapter(e ->
            ...
            onDuplicateKeyInsertMethods.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
            ...
            Link urlLabel = UIUtils.createLink(loadSettings, "<a href=\"" + HelpUtils.getHelpExternalReference(HELP_TOPIC_REPLACE_METHOD) + "\">"
                    + DTUIMessages.database_consumer_wizard_link_label_replace_method_wiki + "</a>", SelectionListener.widgetSelectedAdapter(e ->
...

        {
            ...
            final Button newConnectionCheckbox = UIUtils.createCheckbox(
                ...
                4);
            newConnectionCheckbox.addSelectionListener(SelectionListener.widgetSelectedAdapter(e ->
            ...
            useTransactionsCheck.addSelectionListener(SelectionListener.widgetSelectedAdapter(e ->
            ...
            showTableCheckbox.addSelectionListener(SelectionListener.widgetSelectedAdapter(e ->
...

        {
            ...
            useMultiRowInsert.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
            ...
            if (settings.getContainer() != null && settings.getContainer().getDataSource().getInfo().supportsStatementBinding()) {
                ...
                skipBindValues.addSelectionListener(SelectionListener.widgetSelectedAdapter(e ->
            ...
            useBatchCheck = UIUtils.createCheckbox(
                ...
                4);
            useBatchCheck.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
            ...
            ignoreDuplicateRows.addSelectionListener(SelectionListener.widgetSelectedAdapter(e ->
            ...
            useBulkLoadCheck = UIUtils.createCheckbox(
                ...
                4);
            useBulkLoadCheck.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
