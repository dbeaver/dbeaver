...
public class DatabaseConsumerPageLoadSettings extends ActiveWizardPage<DataTransferWizard> {
    ...
    public DatabaseConsumerPageLoadSettings() {
        super(DTUIMessages.data_transfer_wizard_data_load);
        setTitle(DTUIMessages.data_transfer_wizard_data_load_title);
        setDescription(DTUIMessages.data_transfer_wizard_data_load_description);
    }
    ...
    public void createControl(Composite parent) {
        ...
        {
            Group loadSettings = UIUtils.createControlGroup(composite, DTUIMessages.data_transfer_wizard_data_load, 1, GridData.FILL_HORIZONTAL, 0);

            transferAutoGeneratedColumns = UIUtils.createCheckbox(
                loadSettings,
                DTUIMessages.data_transfer_wizard_data_transfer_columns,
                DTUIMessages.data_transfer_wizard_data_transfer_values_ignore_message,
            ...
            truncateTargetTable = UIUtils.createCheckbox(loadSettings, DTUIMessages.data_transfer_wizard_data_truncate, settings.isTruncateBeforeLoad());
        ...
        {
            Group performanceSettings = UIUtils.createControlGroup(composite, DTUIMessages.data_transfer_wizard_data_performance, 4, GridData.FILL_HORIZONTAL, 0);
            ...
            final Button useTransactionsCheck = UIUtils.createCheckbox(performanceSettings, DTUIMessages.data_transfer_wizard_data_transactions, null, settings.isUseTransactions(), 4);
            ...
            final Spinner commitAfterEdit = UIUtils.createLabelSpinner(performanceSettings, DTUIMessages.data_transfer_wizard_data_commit_after_insert, settings.getCommitAfterRows(), 1, Integer.MAX_VALUE);
        ...
        {
            Group generalSettings = UIUtils.createControlGroup(composite, DTUIMessages.data_transfer_wizard_data_general, 4, GridData.FILL_HORIZONTAL, 0);
            final Button showTableCheckbox = UIUtils.createCheckbox(generalSettings, DTUIMessages.data_transfer_wizard_data_table_editor, null, settings.isOpenTableOnFinish(), 4);
            ...
            final Button showFinalMessageCheckbox = UIUtils.createCheckbox(generalSettings, DTUIMessages.data_transfer_wizard_data_finish_message, null, getWizard().getSettings().isShowFinalMessage(), 4);
    ...
    private boolean confirmDataTruncate() {
        ...
        if (shell.isVisible() || getSettings().isTruncateBeforeLoad()) {
            ...
            if (!UIUtils.confirmAction(shell, DTUIMessages.data_transfer_wizard_data_truncate_attention, 
                String.format(DTUIMessages.data_transfer_wizard_data_remove_data_warning, tableNames)
                ))
            {
                return false;
            }
