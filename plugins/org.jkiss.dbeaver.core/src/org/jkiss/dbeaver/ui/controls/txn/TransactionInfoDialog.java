...
public abstract class TransactionInfoDialog extends Dialog {
    ...
    protected void createTransactionLogPanel(Composite composite) {
        ...
        showAllCheck = UIUtils.createCheckbox(composite, CoreMessages.action_transactioninfo_dialog_checkbox_show_all_queries, CoreMessages.action_transactioninfo_dialog_description_all_transaction_queries, false, 1);
        ...
        showPreviousCheck = UIUtils.createCheckbox(composite, CoreMessages.action_transactioninfo_dialog_checkbox_show_previous_transactions, CoreMessages.action_transactioninfo_dialog_description_show_only_active_one, false, 1);
