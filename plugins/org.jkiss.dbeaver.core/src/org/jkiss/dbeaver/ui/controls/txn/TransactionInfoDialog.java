...
public abstract class TransactionInfoDialog extends Dialog {
    ...
    protected void createTransactionLogPanel(Composite composite) {
        ...
        showPreviousCheck = UIUtils.createCheckbox(composite, CoreMessages.pref_page_transaction_info_dialog_checkbox_show_previous_transaction, CoreMessages.pref_page_transaction_info_dialog_label_otherwise, false, 1);
