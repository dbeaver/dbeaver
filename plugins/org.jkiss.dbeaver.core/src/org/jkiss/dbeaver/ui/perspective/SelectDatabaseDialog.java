    ...
    protected void createUpperControls(Composite dialogArea) {
        ...
        if (currentInstanceName != null && dataSource != null) {
            ...
            if (instanceSelector != null && instanceContainer != null) {
                ...
                Combo instanceCombo = UIUtils.createLabelCombo(instancePanel, PerspectiveMessages.label_instance, "Active server instance", SWT.DROP_DOWN | SWT.READ_ONLY);  //$NON-NLS-2$ //$NON-NLS-1$
...
//                databaseTermLabel.setLayoutData(gd);
                ...
                try {
                    ...
                    log.error("Error loading instance list", e); //$NON-NLS-1$
                }
