...
public final class MySQLUIMessages extends NLS {
    ...
    public static String editors_user_editor_privileges_dialog_add_catalog_title;
    public static String editors_user_editor_privileges_dialog_add_catalog_message;
    public static String editors_user_editor_privileges_dialog_add_table_title;
    public static String editors_user_editor_privileges_dialog_add_table_message;
    public static String editors_user_editor_privileges_dialog_add_procedure_title;
    public static String editors_user_editor_privileges_dialog_add_procedure_message;
    public static String dialog_object_privileges_title;
    public static String dialog_object_privileges_object_label;
    public static String dialog_object_privileges_group_users;
    public static String editors_object_privileges_control_schema_inherited;
    ...
    public static String editors_user_editor_privileges_group_columns;
    public static String editors_user_editor_privileges_control_column_privileges;
    public static String editors_user_editor_privileges_service_load_columns;
    public static String editors_user_editor_privileges_column_procedure;
    public static String editors_user_editor_privileges_group_procedures;
    public static String editors_user_editor_privileges_control_procedure_privileges;
    public static String editors_user_editor_privileges_service_load_procedures;
