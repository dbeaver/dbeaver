...
public class KingbaseIntervalTypeHandler extends KingbaseTypeHandler {

    public static final KingbaseIntervalTypeHandler INSTANCE = new KingbaseIntervalTypeHandler();
    ...
    private KingbaseIntervalTypeHandler() {
    }
    ...
    public String getTypeModifiersString(@NotNull KingbaseDataType type, int typmod) {
        ...
        if (typmod > 0) {
            if (type.getName().endsWith(KingbaseConstants.TYPE_INTERVAL) && isTypedInterval(typmod)) {
