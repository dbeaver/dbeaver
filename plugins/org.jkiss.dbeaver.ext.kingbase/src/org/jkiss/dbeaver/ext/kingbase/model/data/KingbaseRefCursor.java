 ...
 */
public class KingbaseRefCursor implements DBDCursor {

    private static final Log log = Log.getLog(KingbaseRefCursor.class);
    ...
    public KingbaseRefCursor(JDBCSession session, @NotNull String cursorName) throws SQLException {
