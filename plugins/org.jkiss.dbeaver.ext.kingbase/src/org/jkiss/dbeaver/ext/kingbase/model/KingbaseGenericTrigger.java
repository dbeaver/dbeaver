...
/**
 * KingbaseGenericTrigger
 */
@Deprecated
public class KingbaseGenericTrigger extends GenericTableTrigger {
    ...
    public KingbaseGenericTrigger(GenericTableBase table, String name, String description, String manipulation, String orientation, @Nullable String timing, String statement) {
