 ...
 * KingbaseTablespace
 */
public class KingbaseTablespace extends KingbaseInformation implements KingbaseScriptObject {
    ...
    public KingbaseTablespace(KingbaseDatabase database, ResultSet dbResult)
        throws SQLException {
        super(database);
        this.loadInfo(dbResult);
    }

    public KingbaseTablespace(KingbaseDatabase database) {
        super(database);
        this.oid = 0;
    ...
    private void loadInfo(ResultSet dbResult) {
        ...
        String[] opts = KingbaseUtils.safeGetStringArray(dbResult, "spcoptions");
