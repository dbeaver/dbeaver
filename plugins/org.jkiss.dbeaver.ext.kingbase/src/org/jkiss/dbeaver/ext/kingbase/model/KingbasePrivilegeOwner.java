 ...
 */
public interface KingbasePrivilegeOwner extends KingbaseObject, DBAPrivilegeOwner {

    @DPIContainer
    KingbaseSchema getSchema();

    KingbaseRole getOwner(DBRProgressMonitor monitor) throws DBException;
     ...
     */
    @Override
    Collection<KingbasePrivilege> getPrivileges(@NotNull DBRProgressMonitor monitor, boolean includeNestedObjects) throws DBException;
