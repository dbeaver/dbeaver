...
/**
 * Kingbase sequence manager
 */
public class KingbaseSequenceManager extends SQLObjectEditor<KingbaseTableBase, KingbaseSchema> implements DBEObjectRenamer<KingbaseTableBase> {

    @Override
    public DBSObjectCache<? extends DBSObject, KingbaseTableBase> getObjectsCache(KingbaseTableBase object) {
    ...
    @Override
    protected KingbaseSequence createDatabaseObject(@NotNull DBRProgressMonitor monitor, @NotNull DBECommandContext context, final Object container, Object copyFrom, @NotNull Map<String, Object> options)
    {
    ...
    protected void addObjectModifyActions(@NotNull DBRProgressMonitor monitor, @NotNull DBCExecutionContext executionContext, @NotNull List<DBEPersistAction> actions, @NotNull ObjectChangeCommand command, @NotNull Map<String, Object> options) {
        final KingbaseSequence sequence = (KingbaseSequence) command.getObject();
