 ...
 * JSON content
 */
public class KingbaseContentJSON extends JDBCContentChars {

    public KingbaseContentJSON(DBCExecutionContext executionContext, String json)
    {
        super(executionContext, json);
    }

    private KingbaseContentJSON(KingbaseContentJSON copyFrom) {
        super(copyFrom);
    }
    ...
    @Override
    public KingbaseContentJSON cloneValue(DBRProgressMonitor monitor)
    {
        return new KingbaseContentJSON(this);
    }
