...
public class KingbaseRoleReference implements Comparable<KingbaseRoleReference> {
    ...
    public KingbaseRoleReference(@NotNull KingbaseDatabase database, @NotNull String roleName, @Nullable String roleType) {
    ...
    @Override
    public int compareTo(KingbaseRoleReference other) {
    ...
    public boolean equals(Object o) {
        if (this == o) {
            return true;
        } else if (o instanceof KingbaseRoleReference other) {
