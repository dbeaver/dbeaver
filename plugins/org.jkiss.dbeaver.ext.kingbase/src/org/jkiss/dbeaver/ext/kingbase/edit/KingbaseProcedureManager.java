 ...
 */
public class KingbaseProcedureManager extends SQLObjectEditor<KingbaseProcedure, KingbaseSchema> implements DBEObjectRenamer<KingbaseProcedure> {
    ...
    public boolean canCreateObject(@NotNull Object container) {
        return container instanceof KingbaseSchema;
    }
    ...
    @Override
    protected KingbaseProcedure createDatabaseObject(@NotNull DBRProgressMonitor monitor, @NotNull DBECommandContext context, final Object container, Object copyFrom, @NotNull Map<String, Object> options)
    {
        return new KingbaseProcedure((KingbaseSchema) container);
    }
    ...
    @Override
    protected void addObjectExtraActions(@NotNull DBRProgressMonitor monitor, @NotNull DBCExecutionContext executionContext, @NotNull List<DBEPersistAction> actions, @NotNull NestedObjectCommand<KingbaseProcedure, PropertyHandler> command, @NotNull Map<String, Object> options) {
        ...
        if (isDDL) {
            try {
                KingbaseUtils.getObjectGrantPermissionActions(monitor, command.getObject(), actions, options);
            } catch (DBException e) {
                log.error(e);
            }
        }
    ...
    @Override
    public void renameObject(@NotNull DBECommandContext commandContext, @NotNull KingbaseProcedure object, @NotNull Map<String, Object> options, @NotNull String newName) throws DBException {
        ...
        actions.add(
            new SQLDatabasePersistAction(
                ...
                "ALTER " + command.getObject().getProcedureTypeName() + " " +
                    ...
                    KingbaseProcedure.makeOverloadedName(
                        procedure.getSchema(),
                        command.getOldName(),
