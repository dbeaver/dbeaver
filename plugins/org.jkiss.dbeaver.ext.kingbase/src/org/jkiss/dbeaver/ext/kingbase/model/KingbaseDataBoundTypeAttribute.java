 ...
 */
public class KingbaseDataBoundTypeAttribute extends KingbaseAttribute<KingbaseTableBase>
    implements DBSEntityAttribute, DBSAttributeEnumerable, DBSContextBoundAttribute {

    private final DBSEntityAttribute context;
    private final KingbaseDataTypeAttribute member;
    
    public KingbaseDataBoundTypeAttribute(
        @NotNull DBRProgressMonitor monitor,
        @NotNull KingbaseTableBase container,
        @NotNull DBSEntityAttribute context,
        @NotNull KingbaseDataTypeAttribute attr
    ) throws DBException {
    ...
    public String formatMemberReference(
        ...
        while (context instanceof KingbaseDataBoundTypeAttribute) {
            KingbaseDataBoundTypeAttribute boundAttr = (KingbaseDataBoundTypeAttribute) context;
