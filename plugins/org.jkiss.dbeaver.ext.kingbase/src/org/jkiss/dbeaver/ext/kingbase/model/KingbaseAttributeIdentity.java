...
/**
 * KingbaseAttributeIdentity
 */
public enum KingbaseAttributeIdentity implements DBPNamedObject {
    ...
    KingbaseAttributeIdentity(String code, String name, String definitionClause) {
        this.code = code;
        this.name = name;
    ...
    public static KingbaseAttributeIdentity getByCode(String code) {
        for (KingbaseAttributeIdentity id : values()) {
