...
public class KingbaseTimeTypeHandler extends KingbaseTypeHandler {

    public static final KingbaseTimeTypeHandler INSTANCE = new KingbaseTimeTypeHandler();

    private KingbaseTimeTypeHandler() {
    }
