...
public class KingbaseConstants {
    ...
    public static final String PROP_DD_PLAIN_STRING = "kingbase.dd.plain.string";
    public static final String PROP_DD_TAG_STRING = "kingbase.dd.tag.string";
    ...
    // Settings names from 'kb_options' view
    ...
    public static final String KB_GEOMETRY_CLASS = "com.kingbase8.KBgeometry";
    ...
    public static final String KB_INSTALL_REG_KEY = "SOFTWARE\\Kingbase\\Installations";
    public static final String KB_INSTALL_PROP_BASE_DIRECTORY = "Base Directory";
    public static final String KB_INSTALL_PROP_BRANDING = "Branding";
    ...
    public static final String KB_PASS_HOSTNAME = "overriddenUsername";
