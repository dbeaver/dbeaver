 ...
 */
public abstract class KingbasePlanNodeBase<NODE extends KingbasePlanNodeBase<?>> extends AbstractExecutionPlanNode implements DBCPlanCostNode, DBPPropertySource {
    ...
    protected KingbasePlanNodeBase(DBPDataSource dataSource, NODE parent) {
        this.parent = parent;
