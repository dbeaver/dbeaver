...
/**
 * KingbaseStringValueHandler
 */
public class KingbaseStringValueHandler extends JDBCStringValueHandler {

    public static final KingbaseStringValueHandler INSTANCE = new KingbaseStringValueHandler();
    ...
    public void bindParameter(JDBCSession session, JDBCPreparedStatement statement, DBSTypedObject paramType, int paramIndex, Object value) throws SQLException {
        if (paramType.getTypeID() == Types.OTHER || ArrayUtils.contains(KingbaseDataType.getOidTypes(), paramType.getTypeName())) {
            if (value == null) {
