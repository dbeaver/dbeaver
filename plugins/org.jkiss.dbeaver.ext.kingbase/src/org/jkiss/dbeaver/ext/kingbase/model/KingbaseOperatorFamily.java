...
/**
 * KingbaseOperatorFamily
 */
public class KingbaseOperatorFamily extends KingbaseInformation {

    private long oid;
    private KingbaseAccessMethod accessMethod;
    private String name;
    private long namespaceId;
    private long ownerId;

    public KingbaseOperatorFamily(KingbaseAccessMethod accessMethod, ResultSet dbResult)
        throws SQLException
    {
