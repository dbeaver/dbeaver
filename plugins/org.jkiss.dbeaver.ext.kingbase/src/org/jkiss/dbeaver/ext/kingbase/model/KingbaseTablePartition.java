...
public class KingbaseTablePartition extends KingbaseTable implements DBSTablePartition {

    public static final String CAT_PARTITIONING = "Partitioning";

    private String partitionExpression;
    private KingbaseTable partitionOf;

    public KingbaseTablePartition(KingbaseTable container) {
        super(container);
    ...
    public KingbaseTablePartition(KingbaseTableContainer container, ResultSet dbResult) {
    ...
    public KingbaseTable getPartitionOf() {
        return partitionOf;
    }

    @Override
    public boolean isSubPartition() {
        return partitionOf instanceof KingbaseTablePartition;
    }

    @Nullable
    @Override
    public DBSTablePartition getPartitionParent() {
        if (partitionOf instanceof KingbaseTablePartition) {
            return (KingbaseTablePartition) partitionOf;
        }
        return null;
    }
}
