 ...
 */
public class KingbaseDatabaseManager extends SQLObjectEditor<KingbaseDatabase, KingbaseDataSource> implements DBEObjectRenamer<KingbaseDatabase> {
    ...
    @Nullable
    @Override
    public DBSObjectCache<KingbaseDataSource, KingbaseDatabase> getObjectsCache(KingbaseDatabase object) {
        return object.getDataSource().getDatabaseCache();
    }

    @Override
    public void deleteObject(@NotNull DBECommandContext commandContext, @NotNull KingbaseDatabase object, @NotNull Map<String, Object> options) throws DBException {
    ...
    @Override
    protected KingbaseDatabase createDatabaseObject(@NotNull DBRProgressMonitor monitor, @NotNull DBECommandContext context, Object container, Object copyFrom, @NotNull Map<String, Object> options) throws DBException {
    ...
    @Override
    public void renameObject(@NotNull DBECommandContext commandContext, @NotNull KingbaseDatabase database, @NotNull Map<String, Object> options, @NotNull String newName) throws DBException {
    ...
    private static class CreateDatabaseAction extends SQLDatabasePersistActionAtomic {
        ...
        public CreateDatabaseAction(KingbaseDatabase database, StringBuilder sql) {
    ...
    @Override
    protected void addObjectExtraActions(@NotNull DBRProgressMonitor monitor, @NotNull DBCExecutionContext executionContext, @NotNull List<DBEPersistAction> actions, @NotNull NestedObjectCommand<KingbaseDatabase, PropertyHandler> command, @NotNull Map<String, Object> options) throws DBException {
        if (command.hasProperty(DBConstants.PROP_ID_DESCRIPTION)) {
            KingbaseDatabase database = command.getObject();
