 ...
 */
public class KingbaseIntervalValueHandler extends JDBCStringValueHandler {

    private static final Log log = Log.getLog(KingbaseIntervalValueHandler.class);

    public static final KingbaseIntervalValueHandler INSTANCE = new KingbaseIntervalValueHandler();
    ...
    public String getValueDisplayString(@NotNull DBSTypedObject column, Object value, @NotNull DBDDisplayFormat format) {
        if (value != null && value.getClass().getName().equals(KingbaseConstants.KB_INTERVAL_CLASS)) {
            try {
