...
/**
 * KingbaseTableRegular
 */
public class KingbaseTableRegular extends KingbaseTable implements DBPReferentialIntegrityController {
    public KingbaseTableRegular(KingbaseSchema catalog) {
        super(catalog);
    }
    ...
    public KingbaseTableRegular(DBRProgressMonitor monitor, KingbaseSchema catalog, KingbaseTableRegular source) throws DBException {
        super(monitor, catalog, source, false);
    }

    public KingbaseTableRegular(KingbaseSchema catalog, ResultSet dbResult) {
