...
public class KingbaseDataTypeManager extends SQLObjectEditor<KingbaseDataType, KingbaseSchema> implements DBEObjectRenamer<KingbaseDataType> {
    ...
    @Override
    protected KingbaseDataType createDatabaseObject(@NotNull DBRProgressMonitor monitor, @NotNull DBECommandContext context, Object container, Object copyFrom, @NotNull Map<String, Object> options) throws DBException {
    ...
    @Nullable
    @Override
    public DBSObjectCache<? extends DBSObject, KingbaseDataType> getObjectsCache(KingbaseDataType object) {
        return object.getParentObject().getDataTypeCache();
    }

    @Override
    public void renameObject(@NotNull DBECommandContext commandContext, @NotNull KingbaseDataType object, @NotNull Map<String, Object> options, @NotNull String newName) throws DBException {
        processObjectRename(commandContext, object, options, newName);
    }

    @Override
    protected void addObjectRenameActions(@NotNull DBRProgressMonitor monitor, @NotNull DBCExecutionContext executionContext, @NotNull List<DBEPersistAction> actions, @NotNull ObjectRenameCommand command, @NotNull Map<String, Object> options) {
        KingbaseDataType dataType = command.getObject();
        actions.add(
    ...
    @Override
    protected void addObjectExtraActions(@NotNull DBRProgressMonitor monitor, @NotNull DBCExecutionContext executionContext, @NotNull List<DBEPersistAction> actions, @NotNull NestedObjectCommand<KingbaseDataType, PropertyHandler> command, @NotNull Map<String, Object> options) throws DBException {
        KingbaseDataType dataType = command.getObject();
