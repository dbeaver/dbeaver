...
public class KingbaseServerType extends AbstractDescriptor {
    ...
    KingbaseServerType(IConfigurationElement config) {
        super(config);
    ...
    public KingbaseServerExtension createServerExtension(KingbaseDataSource dataSource) throws DBException {
        try {
            return (KingbaseServerExtension) type.getObjectClass().getConstructor(KingbaseDataSource.class).newInstance(dataSource);
        } catch (Throwable e) {
