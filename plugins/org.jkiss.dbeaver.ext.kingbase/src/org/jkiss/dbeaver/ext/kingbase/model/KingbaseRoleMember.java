 ...
 * KingbaseRoleMember
 */
public class KingbaseRoleMember implements DBSObject {

    private final KingbaseRole owner;
    private long role;
    private long member;
    private long grantor;
    private boolean adminOption;

    public KingbaseRoleMember(KingbaseRole owner, ResultSet dbResult)
        throws SQLException
    {
        this.owner = owner;
    ...
    public KingbaseRole getMember(DBRProgressMonitor monitor) throws DBException {
        return owner.getDatabase().getRoleById(monitor, member);
    }

    @Property(viewable = true, order = 3)
    public KingbaseRole getGrantor(DBRProgressMonitor monitor) throws DBException {
