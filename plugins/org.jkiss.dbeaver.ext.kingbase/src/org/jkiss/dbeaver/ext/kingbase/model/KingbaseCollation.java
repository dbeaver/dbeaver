 ...
 * KingbaseCollation
 */
public class KingbaseCollation extends KingbaseInformation {
    ...
    public KingbaseCollation(DBRProgressMonitor monitor, KingbaseDatabase database, ResultSet dbResult)
    ...
    public KingbaseRole getOwnerId(DBRProgressMonitor monitor) throws DBException {
