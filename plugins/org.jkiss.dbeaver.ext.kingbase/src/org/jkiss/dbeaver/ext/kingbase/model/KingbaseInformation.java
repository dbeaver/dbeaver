...
/**
 * Kingbase informational object
 */
public abstract class KingbaseInformation implements DBSObject, DBPSystemInfoObject, KingbaseObject {

    private KingbaseDatabase database;

    protected KingbaseInformation(KingbaseDatabase database)
    {
