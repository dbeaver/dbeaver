 ...
 */
public class KingbasePlanNodeExternal extends KingbasePlanNodeBase<KingbasePlanNodeExternal> {

    private KingbasePlanNodeExternal(KingbaseDataSource dataSource, KingbasePlanNodeExternal parent) {
        super(dataSource, parent);
    }

    protected KingbasePlanNodeExternal(KingbaseDataSource dataSource, JsonObject data, KingbasePlanNodeExternal parent) {
        super(dataSource, parent);

        Map<String, String> attributes = new HashMap<String, String>(); 
        JsonArray attrs =  data.getAsJsonArray(AbstractExecutionPlanSerializer.PROP_ATTRIBUTES);

        attributes.put(KingbasePlanNodeBase.ATTR_NODE_TYPE, data.get(AbstractExecutionPlanSerializer.PROP_TYPE).getAsString());
