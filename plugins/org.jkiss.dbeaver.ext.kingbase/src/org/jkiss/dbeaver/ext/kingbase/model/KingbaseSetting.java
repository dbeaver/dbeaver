...
public class KingbaseSetting implements DBSObject, DBPSystemInfoObject {
    private final KingbaseDataSource database;
    private final String name;
    private final String value;
    private final String unit;
    private final String description;

    protected KingbaseSetting(KingbaseDataSource database, ResultSet dbResult) {
