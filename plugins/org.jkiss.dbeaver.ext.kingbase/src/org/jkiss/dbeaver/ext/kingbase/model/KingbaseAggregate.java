 ...
 * KingbaseAggregate
 */
public class KingbaseAggregate implements KingbaseObject, DBPOverloadedObject, DBPObjectWithLazyDescription {

    private long oid;
    private final KingbaseSchema schema;
    private String name;
    private boolean persisted;
    private KingbaseProcedure function;

    public KingbaseAggregate(DBRProgressMonitor monitor, KingbaseSchema schema, ResultSet dbResult)
    ...
    public List<KingbaseDataType> getInputTypes(DBRProgressMonitor monitor) throws DBException {
        if (function == null) {
            return null;
        }
        List<KingbaseDataType> result = new ArrayList<>();
        for (KingbaseProcedureParameter param : function.getInputParameters()) {
    ...
    public KingbaseDataType getOutputType(DBRProgressMonitor monitor) throws DBException {
    ...
    public KingbaseProcedure getFunction() throws DBException {
        return function;
    }
    ...
    public String getOverloadedName() {
        return function == null ? name : KingbaseProcedure.makeOverloadedName(
            schema,
            name,
