...
class SQLToolTaskWizardPageSettings extends ActiveWizardPage<SQLToolTaskWizard> implements DBPContextProvider {
    ...
    SQLToolTaskWizardPageSettings(SQLToolTaskWizard wizard) {
        super(NLS.bind(TSQLUIMessages.sql_tool_task_wizard_page_settings_name, wizard.getTaskType().getName()));
        setTitle(NLS.bind(TSQLUIMessages.sql_tool_task_wizard_page_settings_title, wizard.getTaskType().getName()));
        setDescription(NLS.bind(TSQLUIMessages.sql_tool_task_wizard_page_settings_description, wizard.getTaskType().getName()));
    ...
    public void createControl(Composite parent) {
        ...
        {
            Group objectsPanel = UIUtils.createControlGroup(settingsPanel, TSQLUIMessages.sql_tool_task_wizard_page_settings_group_label_objects, 2, GridData.FILL_BOTH, 0);
            ...
            UIUtils.createToolItem(buttonsToolbar, TSQLUIMessages.sql_tool_task_wizard_page_settings_tool_item_text_add_string, UIIcon.ROW_ADD, new SelectionAdapter() {
                @Override
            ...
            ToolItem deleteItem = UIUtils.createToolItem(buttonsToolbar, TSQLUIMessages.sql_tool_task_wizard_page_settings_tool_item_text_remove_string, UIIcon.ROW_DELETE, new SelectionAdapter() {
                @Override
                public void widgetSelected(SelectionEvent e) {
            ...
            ToolItem moveUpItem = UIUtils.createToolItem(buttonsToolbar, TSQLUIMessages.sql_tool_task_wizard_page_settings_tool_item_text_move_script_up, UIIcon.ARROW_UP, new SelectionAdapter() {
                @Override
                public void widgetSelected(SelectionEvent e) {
            ...
            ToolItem moveDownItem = UIUtils.createToolItem(buttonsToolbar, TSQLUIMessages.sql_tool_task_wizard_page_settings_tool_item_text_move_script_down, UIIcon.ARROW_DOWN, new SelectionAdapter() {
                @Override
                public void widgetSelected(SelectionEvent e) {
                    int selectionIndex = objectTable.getSelectionIndex();
        ...
        {
            Group optionsPanel = UIUtils.createControlGroup(settingsPanel, TSQLUIMessages.sql_tool_task_wizard_page_settings_group_label_settings, 1, GridData.FILL_BOTH, 0);
        ...
        if (serviceSQL != null) {
            try {
                sqlPreviewPanel = serviceSQL.createSQLPanel(
                    ...
                    previewPanel,
                    this,
                    TSQLUIMessages.sql_tool_task_wizard_page_settings_sql_panel_name,
                    true,
                    "");
            } catch (DBException e) {
        ...
        UIUtils.createDialogButton(controlsPanel, TSQLUIMessages.sql_tool_task_wizard_page_settings_dialog_button_label_copy, new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
