...
public enum FireBirdFieldType {
    ...
    // Since Firebird 3.0
    // https://www.firebirdsql.org/file/documentation/release_notes/html/en/3_0/rlsnotes30.html#rnfb30-new
    BOOLEAN(23, Types.BOOLEAN, DBPDataKind.BOOLEAN, "BOOLEAN", 3, 0),
    // Since Firebird 4.0
    ...
    FireBirdFieldType(int typeID, int valueType, DBPDataKind dataKind, String name) {
        this(typeID, valueType, dataKind, name, 0, 0);
    }

    FireBirdFieldType(int typeID, int valueType, DBPDataKind dataKind, String name, int minMajorVersion, int minMinorVersion) {
        this.typeID = typeID;
