...
public class FireBirdDataType extends GenericDataType {
    ...
    public FireBirdDataType(FireBirdDataSource genericDataSource, FireBirdFieldType fieldType, int subType, String name, String remarks, boolean unsigned, boolean searchable, int precision, int minScale, int maxScale) {
