...
public class TimeplusJdbcStatement extends JDBCStatementImpl<Statement> {

    public TimeplusJdbcStatement(
        @NotNull JDBCSession session,
        @NotNull JDBCObjectSupplier<Statement> stmtSupplier,
        boolean disableLogging
    ) throws SQLException {
        super(session, stmtSupplier, null, disableLogging);
    }
    ...
    private static boolean isDDL(@Nullable String sql) {
        ...
        String trimmed = sql.stripLeading().toUpperCase(Locale.ENGLISH);
