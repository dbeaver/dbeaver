...
public class SQLConstraintKeysCache extends ConstraintKeysCache {

    SQLConstraintKeysCache(TableCache tableCache) {
        super(tableCache);
    }
    ...
    protected GenericTableConstraintColumn[] fetchObjectRow(
        ...
        String name = JDBCUtils.safeGetStringTrimmed(dbResult, "name"); //$NON-NLS-1$
        Integer keyOrder = JDBCUtils.safeGetInteger(dbResult, "pk"); //$NON-NLS-1$
