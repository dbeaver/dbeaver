...
public class UIIcon {
    ...
    public static final DBIcon SQL_MULTIPLE_RESULTS_PER_TAB_FALSE = new DBIcon("sql_tab_per_result_true", "sql/sql_multiple_results_per_tab_false.png"); //$NON-NLS-1$ //$NON-NLS-2$
    public static final DBIcon SQL_MULTIPLE_RESULTS_PER_TAB_TRUE = new DBIcon("sql_tab_per_result_false", "sql/sql_multiple_results_per_tab_true.png"); //$NON-NLS-1$ //$NON-NLS-2$
