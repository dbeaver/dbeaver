...
public class FindReplaceOverlay {
    ...
    @Nullable
    private FindReplaceUIControl uiControl = null;
    ...
    public FindReplaceOverlay(
        ...
        this.findReplaceTarget = target;
        this.selectionProvider = selectionProvider;
    }

    @NotNull
    private FindReplaceUIControl getControl() {
        if (this.uiControl == null) {
            this.uiControl = this.createControl();
        }
        return this.uiControl;
    }

    @NotNull
    protected FindReplaceUIControl createControl() {
        return new FindReplaceUIControl();
    }

    public void setFilterState(@Nullable SearchQuickFilterInfo quickFilter) {
        if (this.uiControl != null || quickFilter != null) {
            this.getControl().setFilterState(quickFilter);
        }
    }

    public boolean isOpened() {
        return this.uiControl != null && this.uiControl.isOpened();
    }
    ...
    protected void raizeEvent(@NotNull Consumer<EventListener> operation) {
    ...
    protected Point obtainControlTopLeftPadding(@NotNull Control control) {
        int x;
        int y;
        if (this.uiControl.insertedInTargetParent()) {
    ...
    protected class FindReplaceUIControl {
        @NotNull
        ...
        public FindReplaceUIControl() {
            this.createFindReplaceLogic(findReplaceTarget);
            this.createContainerAndSearchControls(targetControl);
            this.containerControl.setVisible(false);
            PlatformUI.getWorkbench().getHelpSystem()
                .setHelp(this.containerControl, IAbstractTextEditorHelpContextIds.FIND_REPLACE_OVERLAY);
        }
        ...
        private final ControlListener targetMovementListener = ControlListener.controlResizedAdapter(e -> asyncExecIfOpen(
            () -> FindReplaceUIControl.this.updatePlacementAndVisibility(true)
        ));
        ...
        public void close() {
            ...
            this.isOpened = false;
            raizeEvent(l -> l.closed(FindReplaceOverlay.this));
        }
        ...
        public void open() {
            ...
            this.isOpened = true;
            raizeEvent(l -> l.opened(FindReplaceOverlay.this));
        }
        ...
        private void unbindListeners() {
            targetControl.removeFocusListener(this.targetFocusListener);
            targetControl.removeControlListener(this.targetMovementListener);
            targetControl.removeKeyListener(this.closeOnTargetEscapeListener);
        ...
        private void bindListeners() {
            targetControl.addFocusListener(this.targetFocusListener);
            targetControl.addControlListener(this.targetMovementListener);
            targetControl.addKeyListener(this.closeOnTargetEscapeListener);
            if (selectionProvider != null) {
        ...
        private void retrieveColors() {
            ...
            } else if (targetControl instanceof StyledText targetWidget) {
                this.widgetBackgroundColor = targetWidget.getBackground();
                this.normalTextForegroundColor = targetWidget.getForeground();
            } else {
            ...
            this.errorTextForegroundColor = JFaceColors.getErrorText(targetControl.getShell().getDisplay());
        ...
        private void createMainContainer(@NotNull final Composite parent) {
            ...
            createExtraContent(this.realContainerControl);

            this.containerControl.addDisposeListener(e -> {
                raizeEvent(l -> {
                    this.isOpened = false;
                    l.disposed(FindReplaceOverlay.this);
                });
        ...
        private void createSearchBar() {
            ...
            this.searchHistory = new HistoryStore(getDialogSettings(), "findhistory", HISTORY_SIZE); //$NON-NLS-1$
        ...
        protected void updatePlacementAndVisibility(boolean keepLocation) {
            ...
            Rectangle targetControlBounds = this.calculateControlBounds(targetControl);
        ...
        private Rectangle calculateControlBounds(@NotNull Control control) {
            ...
            Point topLeft = obtainControlTopLeftPadding(control);
            Point rightBottom = obtainControlRightBottomPadding(control);
        ...
        private Rectangle calculateDesiredOverlayBounds(@NotNull Rectangle targetControlBounds, boolean keepLocation) {
            ...
            if (selectionProvider != null) {
                ...
                if (!hasSelectionBoundsConflict(selection, overlayBounds)) {
        ...
        private void updateContentAssistAvailability() {
            ...
            this.setContentAssistsEnablement(true); // this.findReplaceLogic.isAvailableAndActive(SearchOptions.REGEX));
        }
