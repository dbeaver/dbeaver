 ...
 * Lake meta model
 */
public class LakeMetaModel extends GenericMetaModel implements DBCQueryTransformProvider {
    ...
    public String getTableDDL(@NotNull DBRProgressMonitor monitor, @NotNull GenericTableBase sourceObject, @NotNull Map<String, Object> options) throws DBException {
        ...
        try (JDBCSession session = DBUtils.openMetaSession(monitor, sourceObject, "Read Lake object DDL")) {
