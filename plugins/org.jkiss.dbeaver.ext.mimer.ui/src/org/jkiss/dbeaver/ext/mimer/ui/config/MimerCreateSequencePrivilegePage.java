 ...
 * MimerCreateRoutinePrivilegePage}, only one privilege type exists so there's no picker.
 *
...
public class MimerCreateSequencePrivilegePage extends BaseObjectEditPage {
    ...
    public MimerCreateSequencePrivilegePage(@NotNull MimerSequencePrivilege privilege) {
        super("Grant USAGE");
    ...
    protected Control createPageContents(@NotNull Composite parent) {
        ...
        UIUtils.createLabelText(composite, "Sequence", privilege.getSequence().getName()).setEditable(false);
