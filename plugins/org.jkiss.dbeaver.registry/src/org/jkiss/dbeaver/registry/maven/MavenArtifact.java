...
public class MavenArtifact implements IMavenIdentifier
{
    ...
    public void loadMetadata(DBRProgressMonitor monitor, String version) throws IOException {
        ...
        try (InputStream mdStream = WebUtils.openConnection(metadataPath, getRepository().getAuthInfo(), null, monitor).getInputStream()) {
            ...
            try (InputStream dirStream = WebUtils.openConnection(getBaseArtifactURL(), getRepository().getAuthInfo(), null, monitor).getInputStream()) {
