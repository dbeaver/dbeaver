        ...
        try {
            if (!isCustomDriverLoader()) {
                try {
                    ...
                    throw new DBCDriverException("Driver libraries (.jars) is not supplied in the product delivery"
                        + " or libraries (.jars) not found in path."
                        + "\nDriver configuration is not valid",
                        driverClassName,
                        getFullName(),
                        this,
                        e);
