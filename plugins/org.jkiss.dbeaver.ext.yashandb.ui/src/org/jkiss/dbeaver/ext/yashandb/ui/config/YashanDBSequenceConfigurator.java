...
public class YashanDBSequenceConfigurator implements DBEObjectConfigurator<YashanDBSequence> {
	...
	@Override
	public YashanDBSequence configureObject(@Nullable DBRProgressMonitor monitor,
			@Nullable DBECommandContext commandContext, @Nullable Object container, @Nullable YashanDBSequence sequence,
