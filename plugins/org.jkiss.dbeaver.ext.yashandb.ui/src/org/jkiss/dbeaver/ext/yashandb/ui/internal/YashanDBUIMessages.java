...
public final class YashanDBUIMessages extends NLS {
    private static final String BUNDLE_NAME = "org.jkiss.dbeaver.ext.yashandb.ui.internal.YashanDBUIMessages"; //$NON-NLS-1$
    ...
    public static String edit_yashandb_data_type_manager_dialog_title;
    ...
    public static String edit_yashandb_package_manager_dialog_title;
    public static String edit_yashandb_schema_manager_dialog_title;
    public static String edit_yashandb_trigger_manager_dialog_title;
    public static String editors_yashandb_session_editor_action__session;
    public static String editors_yashandb_session_editor_action_disconnect;
    ...
    public static String editors_yashandb_session_editor_title_disconnect_session;
    public static String editors_yashandb_session_editor_title_kill_session;
    public static String editors_yashandb_source_abstract_editor_action_name;
    public static String editors_yashandb_source_abstract_editor_state;
    ...
    public static String views_yashandb_compiler_dialog_button_compile;
    public static String views_yashandb_compiler_dialog_button_compile_all;
    public static String views_yashandb_compiler_dialog_column_name;
    public static String views_yashandb_compiler_dialog_column_type;
    public static String views_yashandb_compiler_dialog_message_compilation_error;
    public static String views_yashandb_compiler_dialog_message_compilation_success;
    public static String views_yashandb_compiler_dialog_message_compile_unit;
    public static String views_yashandb_compiler_dialog_title;
    public static String views_yashandb_compiler_log_viewer_action_clear_log;
    public static String views_yashandb_compiler_log_viewer_action_copy;
    public static String views_yashandb_compiler_log_viewer_action_select_all;
    public static String views_yashandb_compiler_log_viewer_column_line;
    public static String views_yashandb_compiler_log_viewer_column_message;
    public static String views_yashandb_compiler_log_viewer_column_pos;

    public static String dialog_connection_yashandb_properties;
    public static String dialog_connection_yashandb_properties_description;
    ...
    public static String pref_page_yashandb_checkbox_disable_escape_processing;
    public static String pref_page_yashandb_checkbox_enable_dbms_output;
    public static String pref_page_yashandb_checkbox_use_rowid_to_identify_rows;
    public static String pref_page_yashandb_checkbox_read_all_synonyms;
    public static String pref_page_yashandb_label_by_default_plan_table;
    public static String pref_page_yashandb_label_disable_client_side_parser;
    public static String pref_page_yashandb_label_if_unchecked_java_classes;
    public static String pref_page_yashandb_label_plan_table;
    public static String pref_page_yashandb_legend_execution_plan;
    public static String pref_page_yashandb_legend_misc;
    public static String pref_page_yashandb_legend_performance;
