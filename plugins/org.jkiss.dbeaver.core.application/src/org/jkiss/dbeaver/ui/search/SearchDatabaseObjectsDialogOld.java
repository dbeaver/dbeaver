...
public class SearchDatabaseObjectsDialogOld extends HelpEnabledDialog {
    ...
    private volatile static SearchDatabaseObjectsDialogOld instance;
    ...
    private SearchDatabaseObjectsDialogOld(Shell shell, DBSDataSourceContainer currentDataSource)
    {
    ...
    public static void open(Shell shell, DBSDataSourceContainer currentDataSource)
    {
        ...
        SearchDatabaseObjectsDialogOld dialog = new SearchDatabaseObjectsDialogOld(shell, currentDataSource);
        instance = dialog;
        try {
            dialog.open();
        } finally {
    ...
    private class SearchResultsControl extends NodeListControl {
        ...
        protected void fillCustomToolbar(ToolBarManager toolbarManager) {
            toolbarManager.add(new Action(CoreMessages.dialog_search_objects_button_close, Action.AS_PUSH_BUTTON) {
                @Override
                public void run() {
                    SearchDatabaseObjectsDialogOld.this.close();
                }
            });
        }
