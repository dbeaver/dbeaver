 ...
 */
public class MimerRoutinePrivilegeManager extends SQLObjectEditor<MimerRoutinePrivilege, MimerProcedure> {
    ...
    @Override
    public boolean canEditObject(@NotNull MimerRoutinePrivilege object) {
        return false;
    }

    @Nullable
    @Override
    public DBSObjectCache<? extends DBSObject, MimerRoutinePrivilege> getObjectsCache(MimerRoutinePrivilege object) {
