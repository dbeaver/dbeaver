...
/**
 * Mimer SQL table constraint. Carries the CHECK clause for CHECK constraints
 * (read from {@code INFORMATION_SCHEMA.CHECK_CONSTRAINTS}).
 *
 * @author Mimer Information Technology
 */
public class MimerTableConstraint extends GenericUniqueKey implements DBSTableCheckConstraint {
