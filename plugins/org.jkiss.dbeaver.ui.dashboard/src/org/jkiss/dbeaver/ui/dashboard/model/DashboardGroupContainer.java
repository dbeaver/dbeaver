...
public interface DashboardGroupContainer {
    ...
    void removeItem(@NotNull DashboardItemConfiguration descriptor);

    void updateItem(@NotNull DashboardItemConfiguration item, @NotNull DashboardItemConfiguration descriptor);
