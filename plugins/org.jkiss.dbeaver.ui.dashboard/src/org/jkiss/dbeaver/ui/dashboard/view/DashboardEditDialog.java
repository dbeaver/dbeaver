...
public class DashboardEditDialog extends BaseDialog {
    ...
    {
        super(shell, UIDashboardMessages.dashboard_edit_dialog_title + " [" + dashboardDescriptor.getName() + "]", null);
    ...
    protected Composite createDialogArea(Composite parent)
    {
        ...
        if (readOnly) {
            UIUtils.createInfoLabel(composite, UIDashboardMessages.dashboard_edit_dialog_info_label);
        }

        {
            Group infoGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dashboard_edit_dialog_group_info_title, 4, GridData.FILL_HORIZONTAL, 0);

            idText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.dashboard_edit_dialog_group_info_id, dashboardDescriptor.getId(), SWT.BORDER | baseStyle);
            ...
            nameText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.dashboard_edit_dialog_group_info_name, dashboardDescriptor.getName(), SWT.BORDER | baseStyle);
            ...
            {
                UIUtils.createControlLabel(infoGroup, UIDashboardMessages.dashboard_edit_dialog_group_info_database);
                ...
                UIUtils.createPushButton(dbSelectorPanel, UIDashboardMessages.dashboard_edit_dialog_group_info_database_select_button, null, new SelectionAdapter() {
                    @Override
...
//                .setLayoutData(new GridData(GridData.FILL, GridData.BEGINNING, true, false, 3, 1));
            dataTypeCombo = UIUtils.createLabelCombo(
            		infoGroup,
            		UIDashboardMessages.dashboard_edit_dialog_group_info_data_type,
            		UIDashboardMessages.dashboard_edit_dialog_group_info_data_type_description, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            calcTypeCombo = UIUtils.createLabelCombo(
            		infoGroup,
            		UIDashboardMessages.dashboard_edit_dialog_group_info_calc_type,
            		UIDashboardMessages.dashboard_edit_dialog_group_info_calc_type_description, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            valueTypeCombo = UIUtils.createLabelCombo(
            		infoGroup,
            		UIDashboardMessages.dashboard_edit_dialog_group_info_value_type,
            		UIDashboardMessages.dashboard_edit_dialog_group_info_value_type_description, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            intervalCombo = UIUtils.createLabelCombo(
            		infoGroup,
            		UIDashboardMessages.dashboard_edit_dialog_group_info_interval,
            		UIDashboardMessages.dashboard_edit_dialog_group_info_interval_description, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            fetchTypeCombo = UIUtils.createLabelCombo(
            		infoGroup,
            		UIDashboardMessages.dashboard_edit_dialog_group_info_fetch_type,
            		UIDashboardMessages.dashboard_edit_dialog_group_info_fetch_type_description, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            descriptionText = UIUtils.createLabelText(
            		infoGroup,
            		UIDashboardMessages.dashboard_edit_dialog_group_info_description,
            		CommonUtils.notEmpty(dashboardDescriptor.getDescription()), SWT.BORDER | SWT.MULTI | SWT.WRAP | SWT.V_SCROLL | baseStyle);
        ...
        {
            Group sqlGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dashboard_edit_dialog_group_queries_title, 1, GridData.FILL_BOTH, 0);
            queryText = new Text(sqlGroup, SWT.BORDER | SWT.MULTI | SWT.V_SCROLL | SWT.WRAP | baseStyle);
            GridData gd = new GridData(GridData.FILL_BOTH);
            gd.heightHint = 100;
            gd.widthHint = 400;
            queryText.setLayoutData(gd);
            UIUtils.createInfoLabel(sqlGroup, UIDashboardMessages.dashboard_edit_dialog_group_queries_info_label);
        ...
        {
            Group updateGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dashboard_edit_dialog_group_rendering_title, 2, GridData.FILL_HORIZONTAL, 0);

            viewTypeCombo = UIUtils.createLabelCombo(
            		updateGroup,
            		UIDashboardMessages.dashboard_edit_dialog_group_rendering_default_view,
            		UIDashboardMessages.dashboard_edit_dialog_group_rendering_default_view_description, SWT.BORDER | SWT.READ_ONLY);
            ...
            updatePeriodText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.dashboard_edit_dialog_group_rendering_update_period, String.valueOf(dashboardDescriptor.getUpdatePeriod()), SWT.BORDER | baseStyle, new GridData(GridData.FILL_HORIZONTAL));
            maxItemsText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.dashboard_edit_dialog_group_rendering_maximum_items, String.valueOf(dashboardDescriptor.getMaxItems()), SWT.BORDER | baseStyle, new GridData(GridData.FILL_HORIZONTAL));
