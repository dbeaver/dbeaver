...
public class DashboardEditDialog extends BaseDialog {
    ...
    {
        super(shell, UIDashboardMessages.dialog_dashboard_edit_title + "[" + dashboardDescriptor.getName() + "]", null);
    ...
    protected Composite createDialogArea(Composite parent)
    {
        ...
        if (readOnly) {
            UIUtils.createInfoLabel(composite, UIDashboardMessages.dialog_dashboard_edit_error_read_only);
        }

        {
            Group infoGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dialog_dashboard_edit_label_main_info, 4, GridData.FILL_HORIZONTAL, 0);

            idText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.dialog_dashboard_edit_label_id, dashboardDescriptor.getId(), SWT.BORDER | baseStyle);
            ...
            nameText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.dialog_dashboard_edit_label_name, dashboardDescriptor.getName(), SWT.BORDER | baseStyle);
            ...
            {
                UIUtils.createControlLabel(infoGroup, UIDashboardMessages.dialog_dashboard_edit_label_database);
                ...
                UIUtils.createPushButton(dbSelectorPanel, UIDashboardMessages.dialog_dashboard_edit_button_select, null, new SelectionAdapter() {
                    @Override
...
//           UIUtils.createLabelText(infoGroup, UIDashboardMessages.dialog_dashboard_edit_group_info_name, CommonUtils.notEmpty(dashboardDescriptor.getGroup()), SWT.BORDER | baseStyle)
//                .setLayoutData(new GridData(GridData.FILL, GridData.BEGINNING, true, false, 3, 1));
            dataTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dialog_dashboard_edit_combo_data_type_name, UIDashboardMessages.dialog_dashboard_edit_combo_data_type_tooltip, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            calcTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dialog_dashboard_edit_combo_calc_type_name, UIDashboardMessages.dialog_dashboard_edit_combo_calc_type_tooltip, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            valueTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dialog_dashboard_edit_combo_data_type_name, UIDashboardMessages.dialog_dashboard_edit_combo_data_type_tooltip, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            intervalCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dialog_dashboard_edit_combo_interval_name, UIDashboardMessages.dialog_dashboard_edit_combo_interval_tooltip, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            fetchTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dialog_dashboard_edit_combo_fetch_type_name, UIDashboardMessages.dialog_dashboard_edit_combo_fetch_type_tooltip, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            descriptionText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.dialog_dashboard_edit_label_description, CommonUtils.notEmpty(dashboardDescriptor.getDescription()), SWT.BORDER | SWT.MULTI | SWT.WRAP | SWT.V_SCROLL | baseStyle);
        ...
        {
            Group sqlGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dialog_dashboard_edit_group_sql_name, 1, GridData.FILL_BOTH, 0);
            queryText = new Text(sqlGroup, SWT.BORDER | SWT.MULTI | SWT.V_SCROLL | SWT.WRAP | baseStyle);
            GridData gd = new GridData(GridData.FILL_BOTH);
            gd.heightHint = 100;
            gd.widthHint = 400;
            queryText.setLayoutData(gd);
            UIUtils.createInfoLabel(sqlGroup, UIDashboardMessages.dialog_dashboard_edit_group_sql_label_info);
            ...
            if (dashboardDescriptor.getMapQuery() != null) {
                ...
                if (!ArrayUtils.isEmpty(dashboardDescriptor.getMapKeys())) {
                    sql.append(UIDashboardMessages.dialog_dashboard_edit_group_sql_text_map_keys).append(Arrays.toString(dashboardDescriptor.getMapKeys())).append(lineSeparator);
                }
                if (!ArrayUtils.isEmpty(dashboardDescriptor.getMapLabels())) {
                    sql.append(UIDashboardMessages.dialog_dashboard_edit_group_sql_text_map_label).append(Arrays.toString(dashboardDescriptor.getMapLabels())).append(lineSeparator);
                }
            }
        ...
        {
            Group updateGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dialog_dashboard_edit_group_update_name, 2, GridData.FILL_HORIZONTAL, 0);

            viewTypeCombo = UIUtils.createLabelCombo(updateGroup, UIDashboardMessages.dialog_dashboard_edit_combo_view_type_name, UIDashboardMessages.dialog_dashboard_edit_combo_view_type_tooltip, SWT.BORDER | SWT.READ_ONLY);
            ...
            updatePeriodText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.dialog_dashboard_edit_label_update_period, String.valueOf(dashboardDescriptor.getUpdatePeriod()), SWT.BORDER | baseStyle, new GridData(GridData.FILL_HORIZONTAL));
            maxItemsText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.dialog_dashboard_edit_label_max_items, String.valueOf(dashboardDescriptor.getMaxItems()), SWT.BORDER | baseStyle, new GridData(GridData.FILL_HORIZONTAL));
            //maxAgeText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.dialog_dashboard_edit_label_max_age, DashboardUtils.formatDuration(dashboardDescriptor.getMaxAge()), SWT.BORDER | baseStyle, new GridData(GridData.FILL_HORIZONTAL));
        }
