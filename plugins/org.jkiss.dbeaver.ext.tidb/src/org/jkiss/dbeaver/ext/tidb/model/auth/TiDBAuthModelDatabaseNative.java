...
package org.jkiss.dbeaver.ext.tidb.model.auth;
...
public class TiDBAuthModelDatabaseNative extends AuthModelDatabaseNative<AuthModelDatabaseNativeCredentials> {

    public static final String ID = "tidb_native";
