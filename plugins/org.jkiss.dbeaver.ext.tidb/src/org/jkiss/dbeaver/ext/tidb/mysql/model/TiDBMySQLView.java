...
public class TiDBMySQLView extends MySQLView {
    ...
    public MySQLTableColumn getAttribute(@NotNull DBRProgressMonitor monitor, @NotNull String attributeName)
            throws DBException {
        return getContainer().getTiDBTableCache().getChild(monitor, getContainer(), this, attributeName);
    }

    @Override
    public TiDBMySQLCatalog getContainer() {
        return (TiDBMySQLCatalog) super.getContainer();
    }
