...
class TiDBPlanNodeJSON extends AbstractExecutionPlanNode implements DBCPlanCostNode, DBPPropertySource {

    private final TiDBPlanNodeJSON parent;
    private final Map<String, String> nodeProps = new LinkedHashMap<>();
    private final List<TiDBPlanNodeJSON> nested = new ArrayList<>();

    private String name;
    private JsonObject object;

    TiDBPlanNodeJSON(TiDBPlanNodeJSON parent, String name, JsonObject object) {
        this.parent = parent;
        this.name = name;
        this.object = object;
    ...
    TiDBPlanNodeJSON(TiDBPlanNodeJSON parent, Map<String, String> attributes) {
        this.parent = parent;
    ...
    private void addNested(String name, JsonObject value) {
        nested.add(new TiDBPlanNodeJSON(this, name, value));
    }
    ...
    public Number getNodeCost() {
        ...
        if (readCost == null) {
            if (nested != null) {
                long totalCost = 0;
                for (TiDBPlanNodeJSON child : nested) {
    ...
    @Override
    public TiDBPlanNodeJSON getParent() {
        return parent;
    }

    @Override
    public Collection<TiDBPlanNodeJSON> getNested() {
        return nested;
    }
