...
public class NavigatorHandlerCreateColumnConstraint extends NavigatorHandlerObjectCreateBase {
    private static final Log log = Log.getLog(NavigatorHandlerCreateColumnConstraint.class);

    @Override
    public Object execute(ExecutionEvent event) throws ExecutionException { //FIXME code duplication
