...
public class FileSystemExplorerDropAction implements IDropActionDelegate {

	private static final String CN_PLUGIN_ACTION_ID = "com.dbeaver.fs.navigator.PluginDropAction"; //$NON-NLS-1$

	public FileSystemExplorerDropAction() {
		super();
	}
