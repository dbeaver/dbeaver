...
public class NavigatorPreferences {
    ...
    public static final String NAVIGATOR_RESTORE_FILTER = "navigator.restore.filters"; //$NON-NLS-1$
    ...
    public static final String NAVIGATOR_GROUP_BY_DRIVER = ModelPreferences.NAVIGATOR_GROUP_BY_DRIVER;
    ...
    public static final String NAVIGATOR_SHOW_CHILD_COUNT = "navigator.show.child.count"; //$NON-NLS-1$
