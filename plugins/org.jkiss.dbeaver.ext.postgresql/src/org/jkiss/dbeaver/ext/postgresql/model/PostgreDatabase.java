        ...
        DBPObjectWithLazyDescription
{
    ...
    public List<PostgreDataType> allDataTypes = new ArrayList<>();
...
*/
        ...
        if (dataTypeCache.isEmpty() || forceRefresh) {
            ...
            for (final PostgreSchema pgSchema : getSchemas(monitor)) {
                if (PostgreConstants.CATALOG_SCHEMA_NAME.equals(pgSchema.getName())) {
                    pgSchema.getDataTypes(monitor, readAllDataTypes);
                }
            }
        }
    }
    ...
    public boolean isReadAllDataTypes() {
        return readAllDataTypes;
    }

    public List<PostgreDataType> getAllDataTypes() {
        return allDataTypes;
    }
