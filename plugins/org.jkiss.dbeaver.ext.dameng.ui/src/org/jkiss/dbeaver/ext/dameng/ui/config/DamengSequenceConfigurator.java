...
public class DamengSequenceConfigurator implements DBEObjectConfigurator<DamengSequence> {
    @Override
    public DamengSequence configureObject(@NotNull DBRProgressMonitor monitor, @Nullable DBECommandContext commandContext, @Nullable Object container, @NotNull DamengSequence sequence, @NotNull Map<String, Object> options) {
        return UITask.run(() -> {
