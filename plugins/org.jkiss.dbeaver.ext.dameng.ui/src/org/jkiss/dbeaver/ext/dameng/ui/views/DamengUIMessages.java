...
package org.jkiss.dbeaver.ext.dameng.ui.views;
 ...
 * @author Shengkai Bai
 */
public class DamengUIMessages extends NLS {
    static final String BUNDLE_NAME = "org.jkiss.dbeaver.ext.mssql.ui.DMUIMessages";
    ...
    static {
        ...
        NLS.initializeMessages(BUNDLE_NAME, DamengUIMessages.class);
    }
}
