...
public class TiberoPackageSourceDeclarationEditor extends SQLSourceViewer<TiberoSourceObject> {
    ...
    public void runPostSaveCommands(Map<String, Object> context) {
        if (savedDirtySource) {
            ...
            TiberoSourceEditorUtils.runPostSave(this, context, TiberoSourceType.PACKAGE);
        }
    }
    ...
    protected void setSourceText(org.jkiss.dbeaver.model.runtime.DBRProgressMonitor monitor, String sourceText) {
        getInputPropertySource().setPropertyValue(
            monitor,
            TiberoConstants.PROP_OBJECT_DEFINITION,
            sourceText
        );
    }
