...
public class TiberoProcedureSourceEditor extends SQLSourceViewer<TiberoSourceObject> {
    ...
    public void runPostSaveCommands(Map<String, Object> context) {
        if (savedDirtySource) {
            ...
            TiberoSourceEditorUtils.runPostSave(this, context);
        }
    }
    ...
    protected String getCompileCommandId() {
        TiberoSourceObject sourceObject = getSourceObject();
