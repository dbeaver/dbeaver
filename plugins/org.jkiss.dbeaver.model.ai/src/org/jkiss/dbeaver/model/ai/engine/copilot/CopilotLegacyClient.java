...
public class CopilotLegacyClient extends CopilotBaseClient<CopilotChatRequest, CopilotChatResponseLegacy> {
    private static final Log log = Log.getLog(CopilotLegacyClient.class);
