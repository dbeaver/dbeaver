 ...
 */
public class KingbaseIndexConfigurator implements DBEObjectConfigurator<KingbaseIndex> {


    @Override
    public KingbaseIndex configureObject(@NotNull DBRProgressMonitor monitor, @Nullable DBECommandContext commandContext, @Nullable Object parent, @NotNull KingbaseIndex index, @NotNull Map<String, Object> options) {
        return new UITask<KingbaseIndex>() {
            @Override
            protected KingbaseIndex runTask() {
