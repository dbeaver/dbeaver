...
import org.jkiss.dbeaver.ext.kingbase.model.lock.KingbaseLock;
import org.jkiss.dbeaver.ext.kingbase.model.lock.KingbaseLockManager;
...
public class KingbaseLockEditor extends AbstractLockEditor {
    ...
    protected LockManagerViewer createLockViewer(DBCExecutionContext executionContext, Composite parent) {
        ...
        DBAServerLockManager<DBAServerLock, DBAServerLockItem> lockManager = (DBAServerLockManager) new KingbaseLockManager((KingbaseDataSource) executionContext.getDataSource());
        ...
        return new LockManagerViewer(this, parent, lockManager) {
            ...
            protected void onLockSelect(final DBAServerLock lock) {
                ...
                if (lock != null) {
                    final KingbaseLock pLock = (KingbaseLock) lock;
                    super.refreshDetail(new HashMap<String, Object>() {{
                        put(KingbaseLockManager.pidHold, pLock.getHold_pid());
                        put(KingbaseLockManager.pidWait, pLock.getWait_pid());
                    }});
                }
            }
        };
