 ...
 * PrefPageKingbase
 */
public class PrefPageKingbase extends AbstractPrefPage implements IWorkbenchPreferencePage
{
    public static final String PAGE_ID = "org.jkiss.dbeaver.preferences.kingbase.general";
    ...
    protected Control createPreferenceContent(@NotNull Composite parent) {
...

        {
            ...
            showNonDefault = UIUtils.createCheckbox(secureGroup,
                ...
                globalPrefs.getBoolean(KingbaseConstants.PROP_SHOW_NON_DEFAULT_DB),
                2);
            ...
            showTemplates = UIUtils.createCheckbox(secureGroup,
            	KingbaseMessages.dialog_setting_connection_show_templates,
                KingbaseMessages.dialog_setting_connection_show_templates_tip,
                globalPrefs.getBoolean(KingbaseConstants.PROP_SHOW_TEMPLATES_DB),
                2);
            showUnavailable = UIUtils.createCheckbox(
                    secureGroup,
                    KingbaseMessages.dialog_setting_connection_show_not_available_for_conn,
                    KingbaseMessages.dialog_setting_connection_show_not_available_for_conn_tip,
            ...
            showDatabaseStatistics = UIUtils.createCheckbox(
                secureGroup,
                KingbaseMessages.dialog_setting_connection_database_statistics,
                KingbaseMessages.dialog_setting_connection_database_statistics_tip,
            ...
            readAllDataTypes = UIUtils.createCheckbox(secureGroup,
            		KingbaseMessages.dialog_setting_connection_read_all_data_types,
            		KingbaseMessages.dialog_setting_connection_read_all_data_types_tip,
...

        {
            ...
            ddPlainBehaviorCombo.select(globalPrefs.getBoolean(KingbaseConstants.PROP_DD_PLAIN_STRING) ? 0 : 1);
            ddTagBehaviorCombo.select(globalPrefs.getBoolean(KingbaseConstants.PROP_DD_TAG_STRING) ? 0 : 1);
        }
    ...
    public boolean performOk() {
        ...
        preferenceStore.setValue(KingbaseConstants.PROP_SHOW_NON_DEFAULT_DB, String.valueOf(showNonDefault.getSelection()));
        preferenceStore.setValue(KingbaseConstants.PROP_SHOW_TEMPLATES_DB, String.valueOf(showTemplates.getSelection()));
        preferenceStore.setValue(KingbaseConstants.PROP_SHOW_UNAVAILABLE_DB, String.valueOf(showUnavailable.getSelection()));
        preferenceStore.setValue(KingbaseConstants.PROP_SHOW_DATABASE_STATISTICS, String.valueOf(showDatabaseStatistics.getSelection()));
        preferenceStore.setValue(KingbaseConstants.PROP_READ_ALL_DATA_TYPES, String.valueOf(readAllDataTypes.getSelection()));
        preferenceStore.setValue(KingbaseConstants.PROP_READ_KEYS_WITH_COLUMNS, String.valueOf(readKeysWithColumns.getSelection()));

        preferenceStore.setValue(KingbaseConstants.PROP_DD_PLAIN_STRING, ddPlainBehaviorCombo.getSelectionIndex() == 0);
        preferenceStore.setValue(KingbaseConstants.PROP_DD_TAG_STRING, ddTagBehaviorCombo.getSelectionIndex() == 0);
    ...
    protected void performDefaults() {
        ...
        showNonDefault.setSelection(store.getDefaultBoolean(KingbaseConstants.PROP_SHOW_NON_DEFAULT_DB));
        showTemplates.setSelection(store.getDefaultBoolean(KingbaseConstants.PROP_SHOW_TEMPLATES_DB));
        showUnavailable.setSelection(store.getDefaultBoolean(KingbaseConstants.PROP_SHOW_UNAVAILABLE_DB));
        showDatabaseStatistics.setSelection(store.getDefaultBoolean(KingbaseConstants.PROP_SHOW_DATABASE_STATISTICS));
        readAllDataTypes.setSelection(store.getDefaultBoolean(KingbaseConstants.PROP_READ_ALL_DATA_TYPES));
        readKeysWithColumns.setSelection(store.getDefaultBoolean(KingbaseConstants.PROP_READ_KEYS_WITH_COLUMNS));
        ddPlainBehaviorCombo.select(store.getDefaultInt(KingbaseConstants.PROP_DD_PLAIN_STRING));
        ddTagBehaviorCombo.select(store.getDefaultInt(KingbaseConstants.PROP_DD_TAG_STRING));
        setCheckboxesState();
