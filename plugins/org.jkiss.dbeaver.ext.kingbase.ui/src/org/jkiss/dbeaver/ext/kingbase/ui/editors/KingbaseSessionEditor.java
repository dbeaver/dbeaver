...
import org.jkiss.dbeaver.ext.kingbase.model.session.KingbaseSession;
...
/**
 * KingbaseSessionEditor
 */
public class KingbaseSessionEditor extends AbstractSessionEditor
{
    ...
    protected SessionManagerViewer createSessionViewer(DBCExecutionContext executionContext, Composite parent) {
        return new SessionManagerViewer<KingbaseSession>(this, parent, new KingbaseSessionManager((KingbaseDataSource) executionContext.getDataSource())) {
            @Override
