...
import org.jkiss.dbeaver.ext.kingbase.model.KingbaseTableForeignKeyColumn;
...
/**
 * Kingbase index configurator
 */
public class KingbaseForeignKeyConfigurator implements DBEObjectConfigurator<KingbaseTableForeignKey> {


    @Override
    public KingbaseTableForeignKey configureObject(@NotNull DBRProgressMonitor monitor, @Nullable DBECommandContext commandContext, @Nullable Object table, @NotNull KingbaseTableForeignKey foreignKey, @NotNull Map<String, Object> options) {
        return UITask.run(() -> {
            EditKingbaseForeignKeyPage editPage = new EditKingbaseForeignKeyPage(
            	KingbaseMessages.kingbase_foreign_key_manager_header_edit_foreign_key,
                foreignKey);
            ...
            for (EditForeignKeyPage.FKColumnInfo tableColumn : editPage.getColumns()) {
                foreignKey.addColumn(
                    new KingbaseTableForeignKeyColumn(
                        foreignKey,
    ...
    private static class EditKingbaseForeignKeyPage extends EditForeignKeyPage {

        private boolean isDeferrable;
        private boolean isDeferred;

        public EditKingbaseForeignKeyPage(String title, DBSTableForeignKey foreignKey) {
        ...
        protected Composite createPageContents(Composite parent) {
            ...
            final Composite defGroup = UIUtils.createComposite(panel, 2);
            {
                ...
                final Button deferrableCheck = UIUtils.createCheckbox(defGroup, KingbaseMessages.kingbase_foreign_key_manager_checkbox_deferrable, false);
                ...
                final Button deferredCheck = UIUtils.createCheckbox(defGroup, KingbaseMessages.kingbase_foreign_key_manager_checkbox_deferred, false);
