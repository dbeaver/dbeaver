...
public class KingbaseMessages extends NLS {
	static final String BUNDLE_NAME = "org.jkiss.dbeaver.ext.kingbase.KingbaseResources"; //$NON-NLS-1$
    ...
    /* KingbaseSSLConfigurator */
    public static String dialog_connection_network_kingbase_ssl_advanced;
    public static String dialog_connection_network_kingbase_ssl_advanced_ssl_mode;
    public static String dialog_connection_network_kingbase_ssl_advanced_ssl_factory;
    public static String dialog_connection_network_kingbase_ssl_advanced_use_proxy;
    public static String dialog_connection_network_kingbase_ssl_advanced_use_proxy_tip;
    ...
    public static String kingbase_foreign_key_manager_checkbox_deferrable;
    public static String kingbase_foreign_key_manager_checkbox_deferred;
    public static String kingbase_foreign_key_manager_header_edit_foreign_key;
    ...
    /* Kingbase create event trigger dialog */
    ...
    public static String dialog_connection_kbpass_hostname_override;
    public static String dialog_connection_kbpass_hostname_override_tip;
