...
/**
 * KingbaseCreateSchemaDialog
 */
public class KingbaseCreateSchemaDialog extends BaseDialog
{
    ...
    public KingbaseCreateSchemaDialog(Shell parentShell, KingbaseSchema schema) {
        super(parentShell, KingbaseMessages.dialog_create_schema_title, null);
        this.schema = schema;
    }
    ...
    protected Composite createDialogArea(Composite parent) {
        ...
        final Text nameText = UIUtils.createLabelText(group, KingbaseMessages.dialog_create_schema_name, ""); //$NON-NLS-2$
        ...
        final Combo userCombo = UIUtils.createLabelCombo(group, KingbaseMessages.dialog_create_schema_owner, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
        ...
        new AbstractJob("Load users") {
            ...
            protected IStatus run(DBRProgressMonitor monitor) {
                try {
                    ...
                    final KingbaseRole dba = schema.getDatabase().getDBA(monitor);
