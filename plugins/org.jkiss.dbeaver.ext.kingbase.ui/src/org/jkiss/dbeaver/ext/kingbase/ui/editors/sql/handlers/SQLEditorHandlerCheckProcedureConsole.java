 ...
 */
package org.jkiss.dbeaver.ext.kingbase.ui.editors.sql.handlers;
...
import org.jkiss.dbeaver.ext.kingbase.model.sql.generator.SQLGeneratorProcedureCheck;
...
public class SQLEditorHandlerCheckProcedureConsole extends SQLEditorHandlerOpenObjectConsole {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        String title = KingbaseMessages.procedure_check_label_ext;
        if (entities.size() == 1 && !CommonUtils.isEmpty(procName)) {
            title = NLS.bind(KingbaseMessages.procedure_check_label2, procName); 
        }
        ...
        try {
            ...
            DBWorkbench.getPlatformUI().showError(KingbaseMessages.message_open_console, 
            		KingbaseMessages.error_cant_open_sql_editor, e);
        }
        return null;
    }
}
