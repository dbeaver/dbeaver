...
public class MSSQLTrigger extends AbstractTrigger implements MSSQLSourceObject
{
        ...
        ResultSet dbResult)
    {
        ...
        this.charsetClient = JDBCUtils.safeGetString(dbResult, MSSQLConstants.COL_TRIGGER_CHARACTER_SET_CLIENT);
        this.sqlMode = JDBCUtils.safeGetString(dbResult, MSSQLConstants.COL_TRIGGER_SQL_MODE);
    }
