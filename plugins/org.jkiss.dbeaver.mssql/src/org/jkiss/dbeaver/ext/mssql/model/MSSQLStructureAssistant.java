...
public class MSSQLStructureAssistant extends JDBCStructureAssistant
{
    ...
    private void findTablesByMask(JDBCExecutionContext context, final MSSQLCatalog catalog, String tableNameMask, int maxResults, List<DBSObjectReference> objects)
    ...
    private void findProceduresByMask(JDBCExecutionContext context, final MSSQLCatalog catalog, String procNameMask, int maxResults, List<DBSObjectReference> objects)
        throws SQLException, DBException
    {
        DBRProgressMonitor monitor = context.getProgressMonitor();
    ...
    private void findConstraintsByMask(JDBCExecutionContext context, final MSSQLCatalog catalog, String constrNameMask, int maxResults, List<DBSObjectReference> objects)
        throws SQLException, DBException
    {
        DBRProgressMonitor monitor = context.getProgressMonitor();
    ...
    private void findTableColumnsByMask(JDBCExecutionContext context, final MSSQLCatalog catalog, String constrNameMask, int maxResults, List<DBSObjectReference> objects)
        throws SQLException, DBException
    {
        DBRProgressMonitor monitor = context.getProgressMonitor();
