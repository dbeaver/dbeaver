 ...
 * OraclePrivilege
 */
public class OraclePrivilege implements DBAPrivilege
{
    static final Log log = LogFactory.getLog(OraclePrivilege.class);
    ...
    public OraclePrivilege(OracleDataSource dataSource, ResultSet resultSet) {
