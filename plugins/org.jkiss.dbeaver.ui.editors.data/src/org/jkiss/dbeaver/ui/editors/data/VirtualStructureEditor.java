...
//        attrsComposite.setLayoutData(new GridData(GridData.FILL_BOTH));
    ...
    private void createUniqueKeysPage(Composite parent) {
...

        {
            ...
            Button btnAdd = UIUtils.createDialogButton(
                buttonsPanel,
                DataEditorsMessages.virtual_structure_editor_dialog_button_add,
                new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
                        DBVEntityConstraint newConstraint = new DBVEntityConstraint(
                            vEntity,
                        ...
                        EditConstraintPage editPage = new EditConstraintPage(
                            DataEditorsMessages.virtual_structure_editor_constraint_page_edit_key,
                            newConstraint
                        );
                        ...
                        if (editPage.edit()) {
                            ...
                            try {
                                ...
                                DBWorkbench.getPlatformUI().showError(
                                    ...
                                    "An error occurred while creating the virtual unique key.",
                                    ex
                                );
                            }
                        }
