...
public class DataEditorsPreferencesInitializer extends AbstractPreferenceInitializer {
    ...
    public void initializeDefaultPreferences() {
        ...
        PrefUtils.setDefaultPreferenceValue(store, ResultSetPreferences.RESULT_SET_COLUMN_HEADER_EXTRA, ResultSetPreferences.ColumnHeaderExtraContent.NOTHING.name());
