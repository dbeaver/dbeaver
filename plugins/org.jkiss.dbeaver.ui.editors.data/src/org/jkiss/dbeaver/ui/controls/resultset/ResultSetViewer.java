...
//        }
    ...
    private boolean verifyQuerySafety() {
        return !(((SQLQueryContainer) container).isModifying() && UIUtils.confirmAction(null, ResultSetMessages.confirm_modifying_query_title, ResultSetMessages.confirm_modifying_query_message, DBIcon.STATUS_WARNING));
    }
