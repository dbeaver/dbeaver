            ...
            switch (localName) {
                ...
                case "attribute": {
                    if (attrsInfo != null) {
                        ...
                        DBPDataKind dataKind = DBPDataKind.valueOf(atts.getValue("dataKind"));
                        int ordinalPosition = CommonUtils.toInt(atts.getValue("ordinalPosition"));
                        long maxLength = CommonUtils.toLong(atts.getValue("maxLength"));
                        Integer scale = CommonUtils.toInt(atts.getValue("scale"), -1); 
                        Integer precision = CommonUtils.toInt(atts.getValue("precision"), -1); 
