...
public class ResultSetMessages extends NLS {
    ...
    public static String pref_page_database_resultsets_label_replace_nulls_on_default;
    public static String pref_page_database_resultsets_label_replace_nulls_on_default_tip;
