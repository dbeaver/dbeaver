...
public class ResultSetMessages extends NLS {
    ...
    public static String pref_page_data_format_numeric_use_align_with_decimal;
    public static String pref_page_data_format_numeric_use_align_with_decimal_tip;
