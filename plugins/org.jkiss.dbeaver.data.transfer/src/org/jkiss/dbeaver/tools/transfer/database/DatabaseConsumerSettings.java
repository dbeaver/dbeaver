...
public class DatabaseConsumerSettings implements IDataTransferConsumerSettings {
    ...
    private boolean migratePrimaryKeys = true;
    ...
    public boolean isMigratePrimaryKeys() {
        return migratePrimaryKeys;
    }

    public void setMigratePrimaryKeys(boolean migratePrimaryKeys) {
        this.migratePrimaryKeys = migratePrimaryKeys;
    }

    public boolean isMigrateForeignKeys() {
        return migrateForeignKeys;
    }
    ...
    public void loadSettings(DBRRunnableContext runnableContext, DataTransferSettings dataTransferSettings, Map<String, Object> settings) {
        ...
        migratePrimaryKeys = CommonUtils.getBoolean(settings.get("migratePrimaryKeys"), migratePrimaryKeys);
        migrateForeignKeys = CommonUtils.getBoolean(settings.get("migrateForeignKeys"), migrateForeignKeys);
    ...
    public void saveSettings(Map<String, Object> settings) {
        ...
        settings.put("migratePrimaryKeys", migratePrimaryKeys);
        settings.put("migrateForeignKeys", migrateForeignKeys);
    ...
    public String getSettingsSummary() {
        ...
        DTUtils.addSummary(summary, DTMessages.database_consumer_settings_option_migrate_primary_keys, migratePrimaryKeys);
        DTUtils.addSummary(summary, DTMessages.database_consumer_settings_option_migrate_foreign_keys, migrateForeignKeys);
