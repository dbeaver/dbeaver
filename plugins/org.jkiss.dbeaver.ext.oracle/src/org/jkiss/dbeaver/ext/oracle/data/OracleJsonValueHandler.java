...
public class OracleJsonValueHandler extends JDBCContentValueHandler {

    public static final OracleJsonValueHandler INSTANCE = new OracleJsonValueHandler();
    ...
    protected DBDContent fetchColumnValue(DBCSession session, JDBCResultSet resultSet, DBSTypedObject type, int index) throws SQLException {
        ...
        return new StringContent(session.getExecutionContext(), json);
    }
}
