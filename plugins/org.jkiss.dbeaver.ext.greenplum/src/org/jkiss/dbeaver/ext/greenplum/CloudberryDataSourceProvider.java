...
public class CloudberryDataSourceProvider extends PostgreDataSourceProvider {
    public CloudberryDataSourceProvider() {
        super(CloudberryDataSource.class);
    }

    @NotNull
    @Override
    public CloudberryDataSource openDataSource(@NotNull DBRProgressMonitor monitor, @NotNull DBPDataSourceContainer container) throws DBException {
