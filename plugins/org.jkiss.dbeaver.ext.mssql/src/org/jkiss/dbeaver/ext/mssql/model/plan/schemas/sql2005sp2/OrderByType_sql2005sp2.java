...
public class OrderByType_sql2005sp2 {

    @XmlElement(name = "OrderByColumn", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
    protected List<OrderByType_sql2005sp2 .OrderByColumn_sql2005sp2> orderByColumn;
     ...
     * {@link OrderByType_sql2005sp2 .OrderByColumn_sql2005sp2 }
     * 
     * 
     */
    public List<OrderByType_sql2005sp2 .OrderByColumn_sql2005sp2> getOrderByColumn() {
        if (orderByColumn == null) {
            orderByColumn = new ArrayList<OrderByType_sql2005sp2 .OrderByColumn_sql2005sp2>();
        }
    ...
    public static class OrderByColumn_sql2005sp2 {
         ...
         * @return
         *     possible object is
         *     {@link ColumnReferenceType_sql2005sp2 }
         *     
         */
        public ColumnReferenceType_sql2005sp2 getColumnReference() {
         ...
         *     
         */
        public void setColumnReference(ColumnReferenceType_sql2005sp2 value) {
