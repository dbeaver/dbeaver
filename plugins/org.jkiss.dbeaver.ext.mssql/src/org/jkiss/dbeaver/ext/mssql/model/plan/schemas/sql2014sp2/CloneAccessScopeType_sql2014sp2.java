...
@XmlEnum
public enum CloneAccessScopeType_sql2014sp2 {
    ...
    CloneAccessScopeType_sql2014sp2(String v) {
        value = v;
    }
    ...
    public static CloneAccessScopeType_sql2014sp2 fromValue(String v) {
        for (CloneAccessScopeType_sql2014sp2 c: CloneAccessScopeType_sql2014sp2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
