...
public class ShowPlanXML {
    ...
    protected ShowPlanXML.BatchSequence_sql2017 batchSequence;
     ...
     * @return
     *     possible object is
     *     {@link ShowPlanXML.BatchSequence_sql2017 }
     *     
     */
    public ShowPlanXML.BatchSequence_sql2017 getBatchSequence() {
     ...
     *     
     */
    public void setBatchSequence(ShowPlanXML.BatchSequence_sql2017 value) {
    ...
    public static class BatchSequence_sql2017 {

        @XmlElement(name = "Batch", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
        protected List<ShowPlanXML.BatchSequence_sql2017 .Batch_sql2017> batch;
         ...
         * {@link ShowPlanXML.BatchSequence_sql2017 .Batch_sql2017 }
         * 
         * 
         */
        public List<ShowPlanXML.BatchSequence_sql2017 .Batch_sql2017> getBatch() {
            if (batch == null) {
                batch = new ArrayList<ShowPlanXML.BatchSequence_sql2017 .Batch_sql2017>();
            }
            return this.batch;
        }
        ...
        public static class Batch_sql2017 {
             ...
             * 
             */
            public List<StmtBlockType_sql2017> getStatements() {
                if (statements == null) {
                    statements = new ArrayList<StmtBlockType_sql2017>();
                }
