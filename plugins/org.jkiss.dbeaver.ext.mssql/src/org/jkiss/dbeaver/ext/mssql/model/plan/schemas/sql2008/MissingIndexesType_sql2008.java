...
public class MissingIndexesType_sql2008 {
     ...
     * {@link MissingIndexGroupType_sql2008 }
     * 
     * 
     */
    public List<MissingIndexGroupType_sql2008> getMissingIndexGroup() {
        if (missingIndexGroup == null) {
            missingIndexGroup = new ArrayList<MissingIndexGroupType_sql2008>();
        }
