...
@XmlEnum
public enum SetPredicateType_sql2012 {
    ...
    SetPredicateType_sql2012(String v) {
        value = v;
    }
    ...
    public static SetPredicateType_sql2012 fromValue(String v) {
        for (SetPredicateType_sql2012 c: SetPredicateType_sql2012 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
