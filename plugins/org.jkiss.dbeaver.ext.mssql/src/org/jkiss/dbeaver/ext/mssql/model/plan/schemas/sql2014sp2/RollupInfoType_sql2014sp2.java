...
public class RollupInfoType_sql2014sp2 {
     ...
     * {@link RollupLevelType_sql2014sp2 }
     * 
     * 
     */
    public List<RollupLevelType_sql2014sp2> getRollupLevel() {
        if (rollupLevel == null) {
            rollupLevel = new ArrayList<RollupLevelType_sql2014sp2>();
        }
