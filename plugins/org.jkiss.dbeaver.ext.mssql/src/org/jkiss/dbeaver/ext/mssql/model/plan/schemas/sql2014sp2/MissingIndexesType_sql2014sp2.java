...
public class MissingIndexesType_sql2014sp2 {
     ...
     * {@link MissingIndexGroupType_sql2014sp2 }
     * 
     * 
     */
    public List<MissingIndexGroupType_sql2014sp2> getMissingIndexGroup() {
        if (missingIndexGroup == null) {
            missingIndexGroup = new ArrayList<MissingIndexGroupType_sql2014sp2>();
        }
