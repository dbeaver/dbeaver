...
public class StmtBlockType_sql2005 {

    @XmlElements({
        @XmlElement(name = "StmtSimple", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtSimpleType_sql2005 .class),
        @XmlElement(name = "StmtCond", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtCondType_sql2005 .class),
        @XmlElement(name = "StmtCursor", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtCursorType_sql2005 .class),
        @XmlElement(name = "StmtReceive", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtReceiveType_sql2005 .class),
        @XmlElement(name = "StmtUseDb", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtUseDbType_sql2005 .class)
    })
    protected List<BaseStmtInfoType_sql2005> stmtSimpleOrStmtCondOrStmtCursor;
     ...
     * {@link StmtSimpleType_sql2005 }
     * {@link StmtCondType_sql2005 }
     * {@link StmtCursorType_sql2005 }
     * {@link StmtReceiveType_sql2005 }
     * {@link StmtUseDbType_sql2005 }
     * 
     * 
     */
    public List<BaseStmtInfoType_sql2005> getStmtSimpleOrStmtCondOrStmtCursor() {
        if (stmtSimpleOrStmtCondOrStmtCursor == null) {
            stmtSimpleOrStmtCondOrStmtCursor = new ArrayList<BaseStmtInfoType_sql2005>();
        }
