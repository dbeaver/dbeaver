...
@XmlEnum
public enum SubqueryOperationType_sql2016sp1 {
    ...
    SubqueryOperationType_sql2016sp1(String v) {
        value = v;
    }
    ...
    public static SubqueryOperationType_sql2016sp1 fromValue(String v) {
        for (SubqueryOperationType_sql2016sp1 c: SubqueryOperationType_sql2016sp1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
