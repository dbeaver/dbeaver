...
@XmlEnum
public enum TraceFlagScopeType_sql2016sp1 {
    ...
    TraceFlagScopeType_sql2016sp1(String v) {
        value = v;
    }
    ...
    public static TraceFlagScopeType_sql2016sp1 fromValue(String v) {
        for (TraceFlagScopeType_sql2016sp1 c: TraceFlagScopeType_sql2016sp1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
