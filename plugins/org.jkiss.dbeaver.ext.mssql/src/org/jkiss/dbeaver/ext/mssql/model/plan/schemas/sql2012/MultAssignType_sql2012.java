...
public class MultAssignType_sql2012 {
     ...
     * {@link AssignType_sql2012 }
     * 
     * 
     */
    public List<AssignType_sql2012> getAssign() {
        if (assign == null) {
            assign = new ArrayList<AssignType_sql2012>();
        }
        return this.assign;
    }
