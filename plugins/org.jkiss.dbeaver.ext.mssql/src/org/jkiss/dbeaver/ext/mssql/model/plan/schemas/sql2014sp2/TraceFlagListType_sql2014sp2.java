...
public class TraceFlagListType_sql2014sp2 {
     ...
     * {@link TraceFlagType_sql2014sp2 }
     * 
     * 
     */
    public List<TraceFlagType_sql2014sp2> getTraceFlag() {
        if (traceFlag == null) {
            traceFlag = new ArrayList<TraceFlagType_sql2014sp2>();
        }
