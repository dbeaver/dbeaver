...
@XmlEnum
public enum MemoryGrantWarningType_sql2016sp1 {
    ...
    MemoryGrantWarningType_sql2016sp1(String v) {
        value = v;
    }
    ...
    public static MemoryGrantWarningType_sql2016sp1 fromValue(String v) {
        for (MemoryGrantWarningType_sql2016sp1 c: MemoryGrantWarningType_sql2016sp1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
