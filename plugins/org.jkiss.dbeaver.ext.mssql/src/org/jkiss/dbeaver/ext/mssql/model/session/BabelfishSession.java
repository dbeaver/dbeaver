...
/**
 * This is clone of PostgreSession class
 */

public class BabelfishSession extends AbstractServerSession {
    ...
    BabelfishSession(ResultSet dbResult) {
    ...
    @Property(category = CAT_CLIENT, order = 3)
    public String getClientHost()
    {
        return clientHost;
    }

    @Property(category = CAT_CLIENT, order = 4)
    ...
    @Property(category = CAT_TIMING, order = 30)
    public Date getBackendStart() {
        return backendStart;
    }

    @Property(category = CAT_TIMING, order = 31)
    ...
    @Property(category = CAT_TIMING, order = 33)
    ...
    public boolean equals(Object o) {
        ...
        BabelfishSession that = (BabelfishSession) o;
