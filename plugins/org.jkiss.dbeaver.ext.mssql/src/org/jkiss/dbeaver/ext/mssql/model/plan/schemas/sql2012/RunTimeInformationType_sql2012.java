...
public class RunTimeInformationType_sql2012 {

    @XmlElement(name = "RunTimeCountersPerThread", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
    protected List<RunTimeInformationType_sql2012 .RunTimeCountersPerThread_sql2012> runTimeCountersPerThread;
     ...
     * {@link RunTimeInformationType_sql2012 .RunTimeCountersPerThread_sql2012 }
     * 
     * 
     */
    public List<RunTimeInformationType_sql2012 .RunTimeCountersPerThread_sql2012> getRunTimeCountersPerThread() {
        if (runTimeCountersPerThread == null) {
            runTimeCountersPerThread = new ArrayList<RunTimeInformationType_sql2012 .RunTimeCountersPerThread_sql2012>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class RunTimeCountersPerThread_sql2012 {
        ...
        protected ExecutionModeType_sql2012 actualExecutionMode;
         ...
         *     
         */
        public ExecutionModeType_sql2012 getActualExecutionMode() {
         ...
         *     
         */
        public void setActualExecutionMode(ExecutionModeType_sql2012 value) {
