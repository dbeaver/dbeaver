...
@XmlEnum
public enum ExecutionModeType_sql2014sp2 {
    ...
    ExecutionModeType_sql2014sp2(String v) {
        value = v;
    }
    ...
    public static ExecutionModeType_sql2014sp2 fromValue(String v) {
        for (ExecutionModeType_sql2014sp2 c: ExecutionModeType_sql2014sp2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
