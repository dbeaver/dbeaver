...
@XmlEnum
public enum PhysicalOpType_sql2016 {
    ...
    PhysicalOpType_sql2016(String v) {
        value = v;
    }
    ...
    public static PhysicalOpType_sql2016 fromValue(String v) {
        for (PhysicalOpType_sql2016 c: PhysicalOpType_sql2016 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
