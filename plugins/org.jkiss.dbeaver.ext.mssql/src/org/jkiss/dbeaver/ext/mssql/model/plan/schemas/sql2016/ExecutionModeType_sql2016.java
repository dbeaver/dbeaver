...
@XmlEnum
public enum ExecutionModeType_sql2016 {
    ...
    ExecutionModeType_sql2016(String v) {
        value = v;
    }
    ...
    public static ExecutionModeType_sql2016 fromValue(String v) {
        for (ExecutionModeType_sql2016 c: ExecutionModeType_sql2016 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
