...
@XmlEnum
public enum CompareOpType_sql2016 {
    ...
    CompareOpType_sql2016(String v) {
        value = v;
    }
    ...
    public static CompareOpType_sql2016 fromValue(String v) {
        for (CompareOpType_sql2016 c: CompareOpType_sql2016 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
