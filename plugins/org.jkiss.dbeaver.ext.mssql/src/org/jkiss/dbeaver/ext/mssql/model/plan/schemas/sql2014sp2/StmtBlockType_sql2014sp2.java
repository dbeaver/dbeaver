...
public class StmtBlockType_sql2014sp2 {

    @XmlElements({
        @XmlElement(name = "StmtSimple", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtSimpleType_sql2014sp2 .class),
        @XmlElement(name = "StmtCond", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtCondType_sql2014sp2 .class),
        @XmlElement(name = "StmtCursor", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtCursorType_sql2014sp2 .class),
        @XmlElement(name = "StmtReceive", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtReceiveType_sql2014sp2 .class),
        @XmlElement(name = "StmtUseDb", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtUseDbType_sql2014sp2 .class)
    })
    protected List<BaseStmtInfoType_sql2014sp2> stmtSimpleOrStmtCondOrStmtCursor;
     ...
     * {@link StmtSimpleType_sql2014sp2 }
     * {@link StmtCondType_sql2014sp2 }
     * {@link StmtCursorType_sql2014sp2 }
     * {@link StmtReceiveType_sql2014sp2 }
     * {@link StmtUseDbType_sql2014sp2 }
     * 
     * 
     */
    public List<BaseStmtInfoType_sql2014sp2> getStmtSimpleOrStmtCondOrStmtCursor() {
        if (stmtSimpleOrStmtCondOrStmtCursor == null) {
            stmtSimpleOrStmtCondOrStmtCursor = new ArrayList<BaseStmtInfoType_sql2014sp2>();
        }
