...
@XmlEnum
public enum PartitionType_sql2008 {
    ...
    PartitionType_sql2008(String v) {
        value = v;
    }
    ...
    public static PartitionType_sql2008 fromValue(String v) {
        for (PartitionType_sql2008 c: PartitionType_sql2008 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
