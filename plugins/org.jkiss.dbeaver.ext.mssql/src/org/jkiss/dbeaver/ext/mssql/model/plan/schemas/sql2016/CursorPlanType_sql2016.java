...
public class CursorPlanType_sql2016 {

    @XmlElement(name = "Operation", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
    protected List<CursorPlanType_sql2016 .Operation_sql2016> operation;
    @XmlAttribute(name = "CursorName")
    protected String cursorName;
    @XmlAttribute(name = "CursorActualType")
    protected CursorType_sql2016 cursorActualType;
    @XmlAttribute(name = "CursorRequestedType")
    protected CursorType_sql2016 cursorRequestedType;
     ...
     * {@link CursorPlanType_sql2016 .Operation_sql2016 }
     * 
     * 
     */
    public List<CursorPlanType_sql2016 .Operation_sql2016> getOperation() {
        if (operation == null) {
            operation = new ArrayList<CursorPlanType_sql2016 .Operation_sql2016>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CursorType_sql2016 }
     *     
     */
    public CursorType_sql2016 getCursorActualType() {
     ...
     *     
     */
    public void setCursorActualType(CursorType_sql2016 value) {
     ...
     *     
     */
    public CursorType_sql2016 getCursorRequestedType() {
     ...
     *     
     */
    public void setCursorRequestedType(CursorType_sql2016 value) {
    ...
    public static class Operation_sql2016 {
