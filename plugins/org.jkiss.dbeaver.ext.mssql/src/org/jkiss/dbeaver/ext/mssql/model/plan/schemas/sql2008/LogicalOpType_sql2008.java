...
@XmlEnum
public enum LogicalOpType_sql2008 {
    ...
    LogicalOpType_sql2008(String v) {
        value = v;
    }
    ...
    public static LogicalOpType_sql2008 fromValue(String v) {
        for (LogicalOpType_sql2008 c: LogicalOpType_sql2008 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
