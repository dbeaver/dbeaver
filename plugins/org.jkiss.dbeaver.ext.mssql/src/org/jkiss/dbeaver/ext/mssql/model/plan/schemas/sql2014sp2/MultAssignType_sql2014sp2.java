...
public class MultAssignType_sql2014sp2 {
     ...
     * 
     */
    public List<AssignType_sql2014sp2> getAssign() {
        if (assign == null) {
            assign = new ArrayList<AssignType_sql2014sp2>();
        }
        return this.assign;
    }
