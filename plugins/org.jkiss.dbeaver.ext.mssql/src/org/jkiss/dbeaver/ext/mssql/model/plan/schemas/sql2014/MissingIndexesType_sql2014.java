...
public class MissingIndexesType_sql2014 {
     ...
     * {@link MissingIndexGroupType_sql2014 }
     * 
     * 
     */
    public List<MissingIndexGroupType_sql2014> getMissingIndexGroup() {
        if (missingIndexGroup == null) {
            missingIndexGroup = new ArrayList<MissingIndexGroupType_sql2014>();
        }
