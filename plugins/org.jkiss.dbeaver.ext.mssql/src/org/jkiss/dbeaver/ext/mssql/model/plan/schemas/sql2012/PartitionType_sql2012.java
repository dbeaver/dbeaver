...
@XmlEnum
public enum PartitionType_sql2012 {
    ...
    PartitionType_sql2012(String v) {
        value = v;
    }
    ...
    public static PartitionType_sql2012 fromValue(String v) {
        for (PartitionType_sql2012 c: PartitionType_sql2012 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
