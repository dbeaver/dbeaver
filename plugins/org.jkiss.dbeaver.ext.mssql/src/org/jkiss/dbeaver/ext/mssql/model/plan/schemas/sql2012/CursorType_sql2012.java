...
@XmlEnum
public enum CursorType_sql2012 {
    ...
    public static CursorType_sql2012 fromValue(String v) {
        for (CursorType_sql2012 c: CursorType_sql2012 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
