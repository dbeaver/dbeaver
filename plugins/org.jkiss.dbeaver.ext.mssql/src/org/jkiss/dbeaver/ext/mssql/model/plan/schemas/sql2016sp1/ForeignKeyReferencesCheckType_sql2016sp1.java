...
public class ForeignKeyReferencesCheckType_sql2016sp1
    extends RelOpBaseType_sql2016sp1
{
    ...
    protected List<ForeignKeyReferenceCheckType_sql2016sp1> foreignKeyReferenceCheck;
     ...
     * {@link ForeignKeyReferenceCheckType_sql2016sp1 }
     * 
     * 
     */
    public List<ForeignKeyReferenceCheckType_sql2016sp1> getForeignKeyReferenceCheck() {
        if (foreignKeyReferenceCheck == null) {
            foreignKeyReferenceCheck = new ArrayList<ForeignKeyReferenceCheckType_sql2016sp1>();
        }
