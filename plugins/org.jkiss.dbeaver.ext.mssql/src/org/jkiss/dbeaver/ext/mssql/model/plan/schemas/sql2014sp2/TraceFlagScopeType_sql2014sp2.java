...
@XmlEnum
public enum TraceFlagScopeType_sql2014sp2 {
    ...
    TraceFlagScopeType_sql2014sp2(String v) {
        value = v;
    }
    ...
    public static TraceFlagScopeType_sql2014sp2 fromValue(String v) {
        for (TraceFlagScopeType_sql2014sp2 c: TraceFlagScopeType_sql2014sp2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
