...
public class CursorPlanType_sql2014sp2 {

    @XmlElement(name = "Operation", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
    protected List<CursorPlanType_sql2014sp2 .Operation_sql2014sp2> operation;
    @XmlAttribute(name = "CursorName")
    protected String cursorName;
    @XmlAttribute(name = "CursorActualType")
    protected CursorType_sql2014sp2 cursorActualType;
    @XmlAttribute(name = "CursorRequestedType")
    protected CursorType_sql2014sp2 cursorRequestedType;
     ...
     * {@link CursorPlanType_sql2014sp2 .Operation_sql2014sp2 }
     * 
     * 
     */
    public List<CursorPlanType_sql2014sp2 .Operation_sql2014sp2> getOperation() {
        if (operation == null) {
            operation = new ArrayList<CursorPlanType_sql2014sp2 .Operation_sql2014sp2>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CursorType_sql2014sp2 }
     *     
     */
    public CursorType_sql2014sp2 getCursorActualType() {
     ...
     *     
     */
    public void setCursorActualType(CursorType_sql2014sp2 value) {
     ...
     *     
     */
    public CursorType_sql2014sp2 getCursorRequestedType() {
     ...
     *     
     */
    public void setCursorRequestedType(CursorType_sql2014sp2 value) {
    ...
    public static class Operation_sql2014sp2 {
