 ...
 *       &lt;sequence>
 *         &lt;element name="Assign" type="{http://schemas.microsoft.com/sqlserver/2004/07/showplan}AssignType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class MultAssignType_sql2016sp1 {
     ...
     * 
     */
    public List<AssignType_sql2016sp1> getAssign() {
        if (assign == null) {
            assign = new ArrayList<AssignType_sql2016sp1>();
        }
        return this.assign;
    }
