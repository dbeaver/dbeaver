...
public class SeekPredicatesType_sql2017 {
     ...
     * 
     */
    public List<SeekPredicateType_sql2017> getSeekPredicate() {
        if (seekPredicate == null) {
            seekPredicate = new ArrayList<SeekPredicateType_sql2017>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SeekPredicateNewType_sql2017 }
     * 
     * 
     */
    public List<SeekPredicateNewType_sql2017> getSeekPredicateNew() {
        if (seekPredicateNew == null) {
            seekPredicateNew = new ArrayList<SeekPredicateNewType_sql2017>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SeekPredicatePartType_sql2017 }
     * 
     * 
     */
    public List<SeekPredicatePartType_sql2017> getSeekPredicatePart() {
        if (seekPredicatePart == null) {
            seekPredicatePart = new ArrayList<SeekPredicatePartType_sql2017>();
        }
