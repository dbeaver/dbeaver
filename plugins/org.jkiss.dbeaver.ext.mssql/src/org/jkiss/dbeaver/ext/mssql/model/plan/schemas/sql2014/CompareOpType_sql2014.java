...
@XmlEnum
public enum CompareOpType_sql2014 {
    ...
    CompareOpType_sql2014(String v) {
        value = v;
    }
    ...
    public static CompareOpType_sql2014 fromValue(String v) {
        for (CompareOpType_sql2014 c: CompareOpType_sql2014 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
