...
public class TraceFlagListType_sql2016sp1 {
     ...
     * {@link TraceFlagType_sql2016sp1 }
     * 
     * 
     */
    public List<TraceFlagType_sql2016sp1> getTraceFlag() {
        if (traceFlag == null) {
            traceFlag = new ArrayList<TraceFlagType_sql2016sp1>();
        }
