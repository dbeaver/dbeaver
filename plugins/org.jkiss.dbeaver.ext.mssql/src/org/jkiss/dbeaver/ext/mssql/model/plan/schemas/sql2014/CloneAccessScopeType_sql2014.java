...
@XmlEnum
public enum CloneAccessScopeType_sql2014 {
    ...
    CloneAccessScopeType_sql2014(String v) {
        value = v;
    }
    ...
    public static CloneAccessScopeType_sql2014 fromValue(String v) {
        for (CloneAccessScopeType_sql2014 c: CloneAccessScopeType_sql2014 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
