...
@XmlEnum
public enum SetPredicateType_sql2008 {
    ...
    SetPredicateType_sql2008(String v) {
        value = v;
    }
    ...
    public static SetPredicateType_sql2008 fromValue(String v) {
        for (SetPredicateType_sql2008 c: SetPredicateType_sql2008 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
