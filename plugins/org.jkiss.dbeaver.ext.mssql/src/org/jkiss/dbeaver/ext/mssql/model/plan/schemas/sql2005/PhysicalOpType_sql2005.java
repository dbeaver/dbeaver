...
@XmlEnum
public enum PhysicalOpType_sql2005 {
    ...
    PhysicalOpType_sql2005(String v) {
        value = v;
    }
    ...
    public static PhysicalOpType_sql2005 fromValue(String v) {
        for (PhysicalOpType_sql2005 c: PhysicalOpType_sql2005 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
