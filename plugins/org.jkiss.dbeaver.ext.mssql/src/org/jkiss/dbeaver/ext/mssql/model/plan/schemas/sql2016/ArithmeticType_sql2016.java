...
public class ArithmeticType_sql2016 {

    @XmlElement(name = "ScalarOperator", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
    protected List<ScalarType_sql2016> scalarOperator;
    @XmlAttribute(name = "Operation", required = true)
    protected ArithmeticOperationType_sql2016 operation;
     ...
     * {@link ScalarType_sql2016 }
     * 
     * 
     */
    public List<ScalarType_sql2016> getScalarOperator() {
        if (scalarOperator == null) {
            scalarOperator = new ArrayList<ScalarType_sql2016>();
        }
     ...
     * @return
     *     possible object is
     *     {@link ArithmeticOperationType_sql2016 }
     *     
     */
    public ArithmeticOperationType_sql2016 getOperation() {
        return operation;
    }
     ...
     *     
     */
    public void setOperation(ArithmeticOperationType_sql2016 value) {
