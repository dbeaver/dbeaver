...
@XmlEnum
public enum LogicalOpType_sql2016sp1 {
    ...
    LogicalOpType_sql2016sp1(String v) {
        value = v;
    }
    ...
    public static LogicalOpType_sql2016sp1 fromValue(String v) {
        for (LogicalOpType_sql2016sp1 c: LogicalOpType_sql2016sp1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
