...
@XmlEnum
public enum SubqueryOperationType_sql2005sp2 {
    ...
    SubqueryOperationType_sql2005sp2(String v) {
        value = v;
    }
    ...
    public static SubqueryOperationType_sql2005sp2 fromValue(String v) {
        for (SubqueryOperationType_sql2005sp2 c: SubqueryOperationType_sql2005sp2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
