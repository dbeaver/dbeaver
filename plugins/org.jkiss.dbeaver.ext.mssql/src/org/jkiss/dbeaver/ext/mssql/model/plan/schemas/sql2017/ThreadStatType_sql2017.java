...
public class ThreadStatType_sql2017 {

    @XmlElement(name = "ThreadReservation", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
    protected List<ThreadReservationType_sql2017> threadReservation;
     ...
     * {@link ThreadReservationType_sql2017 }
     * 
     * 
     */
    public List<ThreadReservationType_sql2017> getThreadReservation() {
        if (threadReservation == null) {
            threadReservation = new ArrayList<ThreadReservationType_sql2017>();
        }
