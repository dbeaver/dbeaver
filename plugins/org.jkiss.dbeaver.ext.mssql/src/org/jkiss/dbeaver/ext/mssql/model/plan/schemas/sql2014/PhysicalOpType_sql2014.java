...
@XmlEnum
public enum PhysicalOpType_sql2014 {
    ...
    PhysicalOpType_sql2014(String v) {
        value = v;
    }
    ...
    public static PhysicalOpType_sql2014 fromValue(String v) {
        for (PhysicalOpType_sql2014 c: PhysicalOpType_sql2014 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
