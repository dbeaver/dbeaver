...
@XmlEnum
public enum PhysicalOpType_sql2012 {
    ...
    PhysicalOpType_sql2012(String v) {
        value = v;
    }
    ...
    public static PhysicalOpType_sql2012 fromValue(String v) {
        for (PhysicalOpType_sql2012 c: PhysicalOpType_sql2012 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
