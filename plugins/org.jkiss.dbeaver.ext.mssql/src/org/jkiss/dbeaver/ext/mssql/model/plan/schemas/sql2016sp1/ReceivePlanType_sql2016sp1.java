...
public class ReceivePlanType_sql2016sp1 {

    @XmlElement(name = "Operation", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
    protected List<ReceivePlanType_sql2016sp1 .Operation_sql2016sp1> operation;
     ...
     * {@link ReceivePlanType_sql2016sp1 .Operation_sql2016sp1 }
     * 
     * 
     */
    public List<ReceivePlanType_sql2016sp1 .Operation_sql2016sp1> getOperation() {
        if (operation == null) {
            operation = new ArrayList<ReceivePlanType_sql2016sp1 .Operation_sql2016sp1>();
        }
