...
@XmlEnum
public enum CursorType_sql2014 {
    ...
    public static CursorType_sql2014 fromValue(String v) {
        for (CursorType_sql2014 c: CursorType_sql2014 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
