...
public class MissingIndexesType_sql2016sp1 {
     ...
     * {@link MissingIndexGroupType_sql2016sp1 }
     * 
     * 
     */
    public List<MissingIndexGroupType_sql2016sp1> getMissingIndexGroup() {
        if (missingIndexGroup == null) {
            missingIndexGroup = new ArrayList<MissingIndexGroupType_sql2016sp1>();
        }
