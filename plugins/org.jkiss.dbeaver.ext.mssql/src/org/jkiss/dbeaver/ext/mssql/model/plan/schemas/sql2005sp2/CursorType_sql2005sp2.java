...
@XmlEnum
public enum CursorType_sql2005sp2 {
    ...
    CursorType_sql2005sp2(String v) {
        value = v;
    }
    ...
    public static CursorType_sql2005sp2 fromValue(String v) {
        for (CursorType_sql2005sp2 c: CursorType_sql2005sp2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
