...
@XmlEnum
public enum CursorType_sql2005 {
    ...
    public static CursorType_sql2005 fromValue(String v) {
        for (CursorType_sql2005 c: CursorType_sql2005 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
