...
@XmlEnum
public enum CompareOpType_sql2016sp1 {
    ...
    CompareOpType_sql2016sp1(String v) {
        value = v;
    }
    ...
    public static CompareOpType_sql2016sp1 fromValue(String v) {
        for (CompareOpType_sql2016sp1 c: CompareOpType_sql2016sp1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
