...
public class ShowPlanXML {
    ...
    protected ShowPlanXML.BatchSequence_sql2008 batchSequence;
     ...
     * @return
     *     possible object is
     *     {@link ShowPlanXML.BatchSequence_sql2008 }
     *     
     */
    public ShowPlanXML.BatchSequence_sql2008 getBatchSequence() {
     ...
     *     
     */
    public void setBatchSequence(ShowPlanXML.BatchSequence_sql2008 value) {
    ...
    public static class BatchSequence_sql2008 {

        @XmlElement(name = "Batch", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
        protected List<ShowPlanXML.BatchSequence_sql2008 .Batch_sql2008> batch;
         ...
         * {@link ShowPlanXML.BatchSequence_sql2008 .Batch_sql2008 }
         * 
         * 
         */
        public List<ShowPlanXML.BatchSequence_sql2008 .Batch_sql2008> getBatch() {
            if (batch == null) {
                batch = new ArrayList<ShowPlanXML.BatchSequence_sql2008 .Batch_sql2008>();
            }
            return this.batch;
        }
        ...
        public static class Batch_sql2008 {
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link StmtBlockType_sql2008 }
             * 
             * 
             */
            public List<StmtBlockType_sql2008> getStatements() {
                if (statements == null) {
                    statements = new ArrayList<StmtBlockType_sql2008>();
                }
