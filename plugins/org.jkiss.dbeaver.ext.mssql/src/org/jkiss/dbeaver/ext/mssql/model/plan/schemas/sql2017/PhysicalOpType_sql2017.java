 ...
 *     &lt;enumeration value="Adaptive Join"/>
...
@XmlEnum
public enum PhysicalOpType_sql2017 {

    @XmlEnumValue("Adaptive Join")
    ...
    PhysicalOpType_sql2017(String v) {
        value = v;
    }
    ...
    public static PhysicalOpType_sql2017 fromValue(String v) {
        for (PhysicalOpType_sql2017 c: PhysicalOpType_sql2017 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
