...
public class ColumnGroupType_sql2016 {
     ...
     * {@link ColumnType_sql2016 }
     * 
     * 
     */
    public List<ColumnType_sql2016> getColumn() {
        if (column == null) {
            column = new ArrayList<ColumnType_sql2016>();
        }
        return this.column;
    }
