...
@XmlEnum
public enum LogicalOperationType_sql2016 {
    ...
    LogicalOperationType_sql2016(String v) {
        value = v;
    }
    ...
    public static LogicalOperationType_sql2016 fromValue(String v) {
        for (LogicalOperationType_sql2016 c: LogicalOperationType_sql2016 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
