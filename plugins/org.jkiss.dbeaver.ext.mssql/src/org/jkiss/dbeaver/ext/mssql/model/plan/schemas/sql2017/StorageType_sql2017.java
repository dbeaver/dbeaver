...
@XmlEnum
public enum StorageType_sql2017 {
    ...
    public static StorageType_sql2017 fromValue(String v) {
        for (StorageType_sql2017 c: StorageType_sql2017 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
