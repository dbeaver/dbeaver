...
public class MissingIndexesType_sql2005 {
     ...
     * {@link MissingIndexGroupType_sql2005 }
     * 
     * 
     */
    public List<MissingIndexGroupType_sql2005> getMissingIndexGroup() {
        if (missingIndexGroup == null) {
            missingIndexGroup = new ArrayList<MissingIndexGroupType_sql2005>();
        }
