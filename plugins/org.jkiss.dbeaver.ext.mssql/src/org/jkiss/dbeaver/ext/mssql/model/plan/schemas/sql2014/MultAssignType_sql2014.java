...
public class MultAssignType_sql2014 {
     ...
     * 
     */
    public List<AssignType_sql2014> getAssign() {
        if (assign == null) {
            assign = new ArrayList<AssignType_sql2014>();
        }
        return this.assign;
    }
