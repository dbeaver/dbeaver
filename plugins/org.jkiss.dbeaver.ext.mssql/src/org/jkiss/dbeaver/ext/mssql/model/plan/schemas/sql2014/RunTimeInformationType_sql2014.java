...
public class RunTimeInformationType_sql2014 {

    @XmlElement(name = "RunTimeCountersPerThread", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
    protected List<RunTimeInformationType_sql2014 .RunTimeCountersPerThread_sql2014> runTimeCountersPerThread;
     ...
     * {@link RunTimeInformationType_sql2014 .RunTimeCountersPerThread_sql2014 }
     * 
     * 
     */
    public List<RunTimeInformationType_sql2014 .RunTimeCountersPerThread_sql2014> getRunTimeCountersPerThread() {
        if (runTimeCountersPerThread == null) {
            runTimeCountersPerThread = new ArrayList<RunTimeInformationType_sql2014 .RunTimeCountersPerThread_sql2014>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class RunTimeCountersPerThread_sql2014 {
        ...
        protected ExecutionModeType_sql2014 actualExecutionMode;
         ...
         *     
         */
        public ExecutionModeType_sql2014 getActualExecutionMode() {
         ...
         *     
         */
        public void setActualExecutionMode(ExecutionModeType_sql2014 value) {
