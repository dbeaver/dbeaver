...
@XmlEnum
public enum StorageType_sql2012 {
    ...
    public static StorageType_sql2012 fromValue(String v) {
        for (StorageType_sql2012 c: StorageType_sql2012 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
