...
public class MissingIndexGroupType_sql2014sp2 {
     ...
     * {@link MissingIndexType_sql2014sp2 }
     * 
     * 
     */
    public List<MissingIndexType_sql2014sp2> getMissingIndex() {
        if (missingIndex == null) {
            missingIndex = new ArrayList<MissingIndexType_sql2014sp2>();
        }
