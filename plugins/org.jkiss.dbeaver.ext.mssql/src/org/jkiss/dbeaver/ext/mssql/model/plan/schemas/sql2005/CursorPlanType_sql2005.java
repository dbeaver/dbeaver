...
public class CursorPlanType_sql2005 {

    @XmlElement(name = "Operation", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
    protected List<CursorPlanType_sql2005 .Operation_sql2005> operation;
    @XmlAttribute(name = "CursorName")
    protected String cursorName;
    @XmlAttribute(name = "CursorActualType")
    protected CursorType_sql2005 cursorActualType;
    @XmlAttribute(name = "CursorRequestedType")
    protected CursorType_sql2005 cursorRequestedType;
     ...
     * {@link CursorPlanType_sql2005 .Operation_sql2005 }
     * 
     * 
     */
    public List<CursorPlanType_sql2005 .Operation_sql2005> getOperation() {
        if (operation == null) {
            operation = new ArrayList<CursorPlanType_sql2005 .Operation_sql2005>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CursorType_sql2005 }
     *     
     */
    public CursorType_sql2005 getCursorActualType() {
     ...
     *     
     */
    public void setCursorActualType(CursorType_sql2005 value) {
     ...
     *     
     */
    public CursorType_sql2005 getCursorRequestedType() {
     ...
     *     
     */
    public void setCursorRequestedType(CursorType_sql2005 value) {
