...
@XmlEnum
public enum LogicalOperationType_sql2014sp2 {
    ...
    LogicalOperationType_sql2014sp2(String v) {
        value = v;
    }
    ...
    public static LogicalOperationType_sql2014sp2 fromValue(String v) {
        for (LogicalOperationType_sql2014sp2 c: LogicalOperationType_sql2014sp2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
