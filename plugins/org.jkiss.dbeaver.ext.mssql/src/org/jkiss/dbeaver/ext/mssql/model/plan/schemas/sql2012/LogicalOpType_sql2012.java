...
@XmlEnum
public enum LogicalOpType_sql2012 {
    ...
    LogicalOpType_sql2012(String v) {
        value = v;
    }
    ...
    public static LogicalOpType_sql2012 fromValue(String v) {
        for (LogicalOpType_sql2012 c: LogicalOpType_sql2012 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
