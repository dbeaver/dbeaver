...
public class IndexedViewInfoType_sql2005sp2 {

    @XmlElement(name = "Object", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
    protected List<ObjectType_sql2005sp2> object;
     ...
     * 
     */
    public List<ObjectType_sql2005sp2> getObject() {
        if (object == null) {
            object = new ArrayList<ObjectType_sql2005sp2>();
        }
        return this.object;
    }
