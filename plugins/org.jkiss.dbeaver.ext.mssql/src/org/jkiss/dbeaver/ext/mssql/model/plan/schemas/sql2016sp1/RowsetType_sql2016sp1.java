...
@XmlSeeAlso({
    CreateIndexType_sql2016sp1 .class,
    SimpleUpdateType_sql2016sp1 .class,
    TableScanType_sql2016sp1 .class,
    ScalarInsertType_sql2016sp1 .class,
    UpdateType_sql2016sp1 .class,
    IndexScanType_sql2016sp1 .class
})
public class RowsetType_sql2016sp1
