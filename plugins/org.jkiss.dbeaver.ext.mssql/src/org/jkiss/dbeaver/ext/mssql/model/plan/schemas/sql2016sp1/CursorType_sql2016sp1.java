...
@XmlEnum
public enum CursorType_sql2016sp1 {
    ...
    CursorType_sql2016sp1(String v) {
        value = v;
    }
    ...
    public static CursorType_sql2016sp1 fromValue(String v) {
        for (CursorType_sql2016sp1 c: CursorType_sql2016sp1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
