...
public class MissingIndexesType_sql2012 {
     ...
     * {@link MissingIndexGroupType_sql2012 }
     * 
     * 
     */
    public List<MissingIndexGroupType_sql2012> getMissingIndexGroup() {
        if (missingIndexGroup == null) {
            missingIndexGroup = new ArrayList<MissingIndexGroupType_sql2012>();
        }
