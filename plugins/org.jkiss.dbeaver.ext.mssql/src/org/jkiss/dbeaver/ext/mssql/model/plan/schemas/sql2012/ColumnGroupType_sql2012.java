...
public class ColumnGroupType_sql2012 {
     ...
     * {@link ColumnType_sql2012 }
     * 
     * 
     */
    public List<ColumnType_sql2012> getColumn() {
        if (column == null) {
            column = new ArrayList<ColumnType_sql2012>();
        }
        return this.column;
    }
