...
public class SeekPredicatesType_sql2016 {

    @XmlElement(name = "SeekPredicate", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
    protected List<SeekPredicateType_sql2016> seekPredicate;
    ...
    protected List<SeekPredicatePartType_sql2016> seekPredicatePart;
     ...
     * 
     */
    public List<SeekPredicateType_sql2016> getSeekPredicate() {
        if (seekPredicate == null) {
            seekPredicate = new ArrayList<SeekPredicateType_sql2016>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SeekPredicatePartType_sql2016 }
     * 
     * 
     */
    public List<SeekPredicatePartType_sql2016> getSeekPredicatePart() {
        if (seekPredicatePart == null) {
            seekPredicatePart = new ArrayList<SeekPredicatePartType_sql2016>();
        }
