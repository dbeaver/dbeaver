...
@XmlSeeAlso({
    MergeType_sql2014sp2 .class,
    TableValuedFunctionType_sql2014sp2 .class,
    CollapseType_sql2014sp2 .class,
    HashType_sql2014sp2 .class,
    TopType_sql2014sp2 .class,
    SequenceType_sql2014sp2 .class,
    GenericType_sql2014sp2 .class,
    SegmentType_sql2014sp2 .class,
    BatchHashTableBuildType_sql2014sp2 .class,
    RemoteType_sql2014sp2 .class,
    ConcatType_sql2014sp2 .class,
    FilterType_sql2014sp2 .class,
    WindowType_sql2014sp2 .class,
    BitmapType_sql2014sp2 .class,
    SpoolType_sql2014sp2 .class,
    StreamAggregateType_sql2014sp2 .class,
    ConstantScanType_sql2014sp2 .class,
    SimpleIteratorOneChildType_sql2014sp2 .class,
    ComputeScalarType_sql2014sp2 .class,
    NestedLoopsType_sql2014sp2 .class,
    SplitType_sql2014sp2 .class,
    ParallelismType_sql2014sp2 .class,
    RowsetType_sql2014sp2 .class,
    SortType_sql2014sp2 .class,
    UDXType_sql2014sp2 .class
})
public class RelOpBaseType_sql2014sp2 {

    @XmlElement(name = "DefinedValues", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
    protected DefinedValuesListType_sql2014sp2 definedValues;
     ...
     * @return
     *     possible object is
     *     {@link DefinedValuesListType_sql2014sp2 }
     *     
     */
    public DefinedValuesListType_sql2014sp2 getDefinedValues() {
     ...
     *     
     */
    public void setDefinedValues(DefinedValuesListType_sql2014sp2 value) {
