...
public class MissingIndexesType_sql2017 {
     ...
     * {@link MissingIndexGroupType_sql2017 }
     * 
     * 
     */
    public List<MissingIndexGroupType_sql2017> getMissingIndexGroup() {
        if (missingIndexGroup == null) {
            missingIndexGroup = new ArrayList<MissingIndexGroupType_sql2017>();
        }
