...
public class ColumnGroupType_sql2005sp2 {
     ...
     * {@link ColumnType_sql2005sp2 }
     * 
     * 
     */
    public List<ColumnType_sql2005sp2> getColumn() {
        if (column == null) {
            column = new ArrayList<ColumnType_sql2005sp2>();
        }
        return this.column;
    }
