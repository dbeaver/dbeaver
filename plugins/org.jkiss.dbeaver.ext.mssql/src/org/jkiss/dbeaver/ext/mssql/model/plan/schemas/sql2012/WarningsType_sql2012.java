...
public class WarningsType_sql2012 {

    @XmlElements({
        @XmlElement(name = "ColumnsWithNoStatistics", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = ColumnReferenceListType_sql2012 .class),
        @XmlElement(name = "SpillToTempDb", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = SpillToTempDbType_sql2012 .class),
        @XmlElement(name = "Wait", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = WaitWarningType_sql2012 .class),
        @XmlElement(name = "PlanAffectingConvert", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = AffectingConvertWarningType_sql2012 .class)
    })
     ...
     * {@link SpillToTempDbType_sql2012 }
     * {@link WaitWarningType_sql2012 }
     * {@link AffectingConvertWarningType_sql2012 }
     * 
     * 
     */
