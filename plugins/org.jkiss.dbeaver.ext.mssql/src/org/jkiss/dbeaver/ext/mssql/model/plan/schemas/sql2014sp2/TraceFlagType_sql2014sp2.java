...
public class TraceFlagType_sql2014sp2 {

    @XmlAttribute(name = "Value", required = true)
    @XmlSchemaType(name = "unsignedLong")
    protected BigInteger value;
    @XmlAttribute(name = "Scope", required = true)
    protected TraceFlagScopeType_sql2014sp2 scope;
     ...
     * @return
     *     possible object is
     *     {@link TraceFlagScopeType_sql2014sp2 }
     *     
     */
    public TraceFlagScopeType_sql2014sp2 getScope() {
        return scope;
    }
     ...
     *     
     */
    public void setScope(TraceFlagScopeType_sql2014sp2 value) {
        this.scope = value;
    }
