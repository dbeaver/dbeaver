...
@XmlEnum
public enum CursorType_sql2016 {
    ...
    public static CursorType_sql2016 fromValue(String v) {
        for (CursorType_sql2016 c: CursorType_sql2016 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
