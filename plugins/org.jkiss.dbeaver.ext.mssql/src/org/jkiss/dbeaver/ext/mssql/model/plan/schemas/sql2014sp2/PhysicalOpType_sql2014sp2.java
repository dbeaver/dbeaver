...
@XmlEnum
public enum PhysicalOpType_sql2014sp2 {
    ...
    PhysicalOpType_sql2014sp2(String v) {
        value = v;
    }
    ...
    public static PhysicalOpType_sql2014sp2 fromValue(String v) {
        for (PhysicalOpType_sql2014sp2 c: PhysicalOpType_sql2014sp2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
