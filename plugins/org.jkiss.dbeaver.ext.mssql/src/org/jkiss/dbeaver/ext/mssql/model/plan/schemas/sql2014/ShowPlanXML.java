...
public class ShowPlanXML {
    ...
    protected ShowPlanXML.BatchSequence_sql2014 batchSequence;
     ...
     * @return
     *     possible object is
     *     {@link ShowPlanXML.BatchSequence_sql2014 }
     *     
     */
    public ShowPlanXML.BatchSequence_sql2014 getBatchSequence() {
     ...
     *     
     */
    public void setBatchSequence(ShowPlanXML.BatchSequence_sql2014 value) {
    ...
    public static class BatchSequence_sql2014 {

        @XmlElement(name = "Batch", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
        protected List<ShowPlanXML.BatchSequence_sql2014 .Batch_sql2014> batch;
         ...
         * {@link ShowPlanXML.BatchSequence_sql2014 .Batch_sql2014 }
         * 
         * 
         */
        public List<ShowPlanXML.BatchSequence_sql2014 .Batch_sql2014> getBatch() {
            if (batch == null) {
                batch = new ArrayList<ShowPlanXML.BatchSequence_sql2014 .Batch_sql2014>();
            }
            return this.batch;
        }
        ...
        public static class Batch_sql2014 {
             ...
             * 
             */
            public List<StmtBlockType_sql2014> getStatements() {
                if (statements == null) {
                    statements = new ArrayList<StmtBlockType_sql2014>();
                }
