    ...
    extends RelOpBaseType_sql2005sp2
{
     ...
     * @return
     *     possible object is
     *     {@link ConstantScanType_sql2005sp2 .Values_sql2005sp2 }
     *     
     */
    public ConstantScanType_sql2005sp2 .Values_sql2005sp2 getValues() {
        return values;
    }
     ...
     *     
     */
    public void setValues(ConstantScanType_sql2005sp2 .Values_sql2005sp2 value) {
        this.values = value;
    }
    ...
    public static class Values_sql2005sp2 {

        @XmlElement(name = "Row", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
        protected List<ScalarExpressionListType_sql2005sp2> row;
         ...
         * 
         */
        public List<ScalarExpressionListType_sql2005sp2> getRow() {
            if (row == null) {
                row = new ArrayList<ScalarExpressionListType_sql2005sp2>();
            }
            return this.row;
        }
