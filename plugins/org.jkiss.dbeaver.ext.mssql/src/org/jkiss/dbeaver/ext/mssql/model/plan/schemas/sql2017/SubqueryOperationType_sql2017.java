...
@XmlEnum
public enum SubqueryOperationType_sql2017 {
    ...
    SubqueryOperationType_sql2017(String v) {
        value = v;
    }
    ...
    public static SubqueryOperationType_sql2017 fromValue(String v) {
        for (SubqueryOperationType_sql2017 c: SubqueryOperationType_sql2017 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
