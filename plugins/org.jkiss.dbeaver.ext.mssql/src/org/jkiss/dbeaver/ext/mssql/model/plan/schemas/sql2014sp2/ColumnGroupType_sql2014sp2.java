...
public class ColumnGroupType_sql2014sp2 {
     ...
     * {@link ColumnType_sql2014sp2 }
     * 
     * 
     */
    public List<ColumnType_sql2014sp2> getColumn() {
        if (column == null) {
            column = new ArrayList<ColumnType_sql2014sp2>();
        }
        return this.column;
    }
