...
public class CursorPlanType_sql2012 {

    @XmlElement(name = "Operation", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
    protected List<CursorPlanType_sql2012 .Operation_sql2012> operation;
    @XmlAttribute(name = "CursorName")
    protected String cursorName;
    @XmlAttribute(name = "CursorActualType")
    protected CursorType_sql2012 cursorActualType;
    @XmlAttribute(name = "CursorRequestedType")
    protected CursorType_sql2012 cursorRequestedType;
     ...
     * {@link CursorPlanType_sql2012 .Operation_sql2012 }
     * 
     * 
     */
    public List<CursorPlanType_sql2012 .Operation_sql2012> getOperation() {
        if (operation == null) {
            operation = new ArrayList<CursorPlanType_sql2012 .Operation_sql2012>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CursorType_sql2012 }
     *     
     */
    public CursorType_sql2012 getCursorActualType() {
     ...
     *     
     */
    public void setCursorActualType(CursorType_sql2012 value) {
     ...
     *     
     */
    public CursorType_sql2012 getCursorRequestedType() {
     ...
     *     
     */
    public void setCursorRequestedType(CursorType_sql2012 value) {
    ...
    public static class Operation_sql2012 {
