...
public class MultAssignType_sql2016 {
     ...
     * 
     */
    public List<AssignType_sql2016> getAssign() {
        if (assign == null) {
            assign = new ArrayList<AssignType_sql2016>();
        }
        return this.assign;
    }
