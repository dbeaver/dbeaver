...
public class ShowPlanXML {
    ...
    protected ShowPlanXML.BatchSequence_sql2016sp1 batchSequence;
     ...
     * @return
     *     possible object is
     *     {@link ShowPlanXML.BatchSequence_sql2016sp1 }
     *     
     */
    public ShowPlanXML.BatchSequence_sql2016sp1 getBatchSequence() {
     ...
     *     
     */
    public void setBatchSequence(ShowPlanXML.BatchSequence_sql2016sp1 value) {
    ...
    public static class BatchSequence_sql2016sp1 {

        @XmlElement(name = "Batch", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
        protected List<ShowPlanXML.BatchSequence_sql2016sp1 .Batch_sql2016sp1> batch;
         ...
         * {@link ShowPlanXML.BatchSequence_sql2016sp1 .Batch_sql2016sp1 }
         * 
         * 
         */
        public List<ShowPlanXML.BatchSequence_sql2016sp1 .Batch_sql2016sp1> getBatch() {
            if (batch == null) {
                batch = new ArrayList<ShowPlanXML.BatchSequence_sql2016sp1 .Batch_sql2016sp1>();
            }
            return this.batch;
        }
        ...
        public static class Batch_sql2016sp1 {
             ...
             * 
             */
            public List<StmtBlockType_sql2016sp1> getStatements() {
                if (statements == null) {
                    statements = new ArrayList<StmtBlockType_sql2016sp1>();
                }
