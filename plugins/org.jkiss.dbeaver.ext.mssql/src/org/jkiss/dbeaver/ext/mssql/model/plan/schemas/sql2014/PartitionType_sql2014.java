...
@XmlEnum
public enum PartitionType_sql2014 {
    ...
    PartitionType_sql2014(String v) {
        value = v;
    }
    ...
    public static PartitionType_sql2014 fromValue(String v) {
        for (PartitionType_sql2014 c: PartitionType_sql2014 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
