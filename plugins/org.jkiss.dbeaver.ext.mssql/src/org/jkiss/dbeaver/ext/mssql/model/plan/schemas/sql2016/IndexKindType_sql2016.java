...
@XmlEnum
public enum IndexKindType_sql2016 {
    ...
    IndexKindType_sql2016(String v) {
        value = v;
    }
    ...
    public static IndexKindType_sql2016 fromValue(String v) {
        for (IndexKindType_sql2016 c: IndexKindType_sql2016 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
