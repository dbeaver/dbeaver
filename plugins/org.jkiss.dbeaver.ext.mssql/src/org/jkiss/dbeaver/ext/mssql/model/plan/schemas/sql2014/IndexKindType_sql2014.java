...
@XmlEnum
public enum IndexKindType_sql2014 {
    ...
    IndexKindType_sql2014(String v) {
        value = v;
    }
    ...
    public static IndexKindType_sql2014 fromValue(String v) {
        for (IndexKindType_sql2014 c: IndexKindType_sql2014 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
