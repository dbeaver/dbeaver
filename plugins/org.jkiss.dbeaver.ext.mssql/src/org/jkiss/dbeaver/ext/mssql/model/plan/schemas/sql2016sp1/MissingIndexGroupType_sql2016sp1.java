...
public class MissingIndexGroupType_sql2016sp1 {
     ...
     * {@link MissingIndexType_sql2016sp1 }
     * 
     * 
     */
    public List<MissingIndexType_sql2016sp1> getMissingIndex() {
        if (missingIndex == null) {
            missingIndex = new ArrayList<MissingIndexType_sql2016sp1>();
        }
