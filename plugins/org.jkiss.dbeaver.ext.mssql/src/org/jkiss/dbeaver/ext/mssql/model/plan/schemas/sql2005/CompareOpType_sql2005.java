...
@XmlEnum
public enum CompareOpType_sql2005 {
    ...
    CompareOpType_sql2005(String v) {
        value = v;
    }
    ...
    public static CompareOpType_sql2005 fromValue(String v) {
        for (CompareOpType_sql2005 c: CompareOpType_sql2005 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
