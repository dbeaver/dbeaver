    ...
    extends RelOpBaseType_sql2008
{
     ...
     * @return
     *     possible object is
     *     {@link ConstantScanType_sql2008 .Values_sql2008 }
     *     
     */
    public ConstantScanType_sql2008 .Values_sql2008 getValues() {
        return values;
    }
     ...
     *     
     */
    public void setValues(ConstantScanType_sql2008 .Values_sql2008 value) {
        this.values = value;
    }
    ...
    public static class Values_sql2008 {

        @XmlElement(name = "Row", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
        protected List<ScalarExpressionListType_sql2008> row;
         ...
         * 
         */
        public List<ScalarExpressionListType_sql2008> getRow() {
            if (row == null) {
                row = new ArrayList<ScalarExpressionListType_sql2008>();
            }
            return this.row;
        }
