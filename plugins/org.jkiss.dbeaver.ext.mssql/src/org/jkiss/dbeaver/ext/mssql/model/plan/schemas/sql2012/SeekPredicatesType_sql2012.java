...
public class SeekPredicatesType_sql2012 {
     ...
     * 
     */
    public List<SeekPredicateType_sql2012> getSeekPredicate() {
        if (seekPredicate == null) {
            seekPredicate = new ArrayList<SeekPredicateType_sql2012>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SeekPredicateNewType_sql2012 }
     * 
     * 
     */
    public List<SeekPredicateNewType_sql2012> getSeekPredicateNew() {
        if (seekPredicateNew == null) {
            seekPredicateNew = new ArrayList<SeekPredicateNewType_sql2012>();
        }
