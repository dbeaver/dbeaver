    ...
    extends RelOpBaseType_sql2016
{
     ...
     * @return
     *     possible object is
     *     {@link ConstantScanType_sql2016 .Values_sql2016 }
     *     
     */
    public ConstantScanType_sql2016 .Values_sql2016 getValues() {
        return values;
    }
     ...
     *     
     */
    public void setValues(ConstantScanType_sql2016 .Values_sql2016 value) {
        this.values = value;
    }
    ...
    public static class Values_sql2016 {

        @XmlElement(name = "Row", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
        protected List<ScalarExpressionListType_sql2016> row;
         ...
         * 
         */
        public List<ScalarExpressionListType_sql2016> getRow() {
            if (row == null) {
                row = new ArrayList<ScalarExpressionListType_sql2016>();
            }
            return this.row;
        }
