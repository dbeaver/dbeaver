...
@XmlEnum
public enum LogicalOperationType_sql2008 {
    ...
    LogicalOperationType_sql2008(String v) {
        value = v;
    }
    ...
    public static LogicalOperationType_sql2008 fromValue(String v) {
        for (LogicalOperationType_sql2008 c: LogicalOperationType_sql2008 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
