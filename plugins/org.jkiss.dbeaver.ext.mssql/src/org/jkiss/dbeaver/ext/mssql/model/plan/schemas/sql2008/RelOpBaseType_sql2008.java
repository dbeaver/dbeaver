...
@XmlSeeAlso({
    MergeType_sql2008 .class,
    TableValuedFunctionType_sql2008 .class,
    CollapseType_sql2008 .class,
    HashType_sql2008 .class,
    TopType_sql2008 .class,
    SequenceType_sql2008 .class,
    GenericType_sql2008 .class,
    SegmentType_sql2008 .class,
    RemoteType_sql2008 .class,
    ConcatType_sql2008 .class,
    FilterType_sql2008 .class,
    BitmapType_sql2008 .class,
    SpoolType_sql2008 .class,
    StreamAggregateType_sql2008 .class,
    ConstantScanType_sql2008 .class,
    SimpleIteratorOneChildType_sql2008 .class,
    ComputeScalarType_sql2008 .class,
    NestedLoopsType_sql2008 .class,
    SplitType_sql2008 .class,
    ParallelismType_sql2008 .class,
    RowsetType_sql2008 .class,
    SortType_sql2008 .class,
    UDXType_sql2008 .class
})
public class RelOpBaseType_sql2008 {

    @XmlElement(name = "DefinedValues", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
    protected DefinedValuesListType_sql2008 definedValues;
     ...
     * @return
     *     possible object is
     *     {@link DefinedValuesListType_sql2008 }
     *     
     */
    public DefinedValuesListType_sql2008 getDefinedValues() {
     ...
     *     
     */
    public void setDefinedValues(DefinedValuesListType_sql2008 value) {
