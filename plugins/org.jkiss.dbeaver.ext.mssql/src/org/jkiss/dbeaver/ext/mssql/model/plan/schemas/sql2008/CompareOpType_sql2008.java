...
@XmlEnum
public enum CompareOpType_sql2008 {
    ...
    CompareOpType_sql2008(String v) {
        value = v;
    }
    ...
    public static CompareOpType_sql2008 fromValue(String v) {
        for (CompareOpType_sql2008 c: CompareOpType_sql2008 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
