...
@XmlEnum
public enum MemoryGrantWarningType_sql2017 {
    ...
    MemoryGrantWarningType_sql2017(String v) {
        value = v;
    }
    ...
    public static MemoryGrantWarningType_sql2017 fromValue(String v) {
        for (MemoryGrantWarningType_sql2017 c: MemoryGrantWarningType_sql2017 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
