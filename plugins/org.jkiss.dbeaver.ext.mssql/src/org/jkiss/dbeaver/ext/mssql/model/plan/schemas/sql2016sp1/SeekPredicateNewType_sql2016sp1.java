...
public class SeekPredicateNewType_sql2016sp1 {
     ...
     * 
     */
    public List<SeekPredicateType_sql2016sp1> getSeekKeys() {
        if (seekKeys == null) {
            seekKeys = new ArrayList<SeekPredicateType_sql2016sp1>();
        }
