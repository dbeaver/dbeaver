...
public class StmtBlockType_sql2008 {

    @XmlElements({
        @XmlElement(name = "StmtSimple", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtSimpleType_sql2008 .class),
        @XmlElement(name = "StmtCond", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtCondType_sql2008 .class),
        @XmlElement(name = "StmtCursor", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtCursorType_sql2008 .class),
        @XmlElement(name = "StmtReceive", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtReceiveType_sql2008 .class),
        @XmlElement(name = "StmtUseDb", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtUseDbType_sql2008 .class)
    })
    protected List<BaseStmtInfoType_sql2008> stmtSimpleOrStmtCondOrStmtCursor;
     ...
     * {@link StmtSimpleType_sql2008 }
     * {@link StmtCondType_sql2008 }
     * {@link StmtCursorType_sql2008 }
     * {@link StmtReceiveType_sql2008 }
     * {@link StmtUseDbType_sql2008 }
     * 
     * 
     */
    public List<BaseStmtInfoType_sql2008> getStmtSimpleOrStmtCondOrStmtCursor() {
        if (stmtSimpleOrStmtCondOrStmtCursor == null) {
            stmtSimpleOrStmtCondOrStmtCursor = new ArrayList<BaseStmtInfoType_sql2008>();
        }
