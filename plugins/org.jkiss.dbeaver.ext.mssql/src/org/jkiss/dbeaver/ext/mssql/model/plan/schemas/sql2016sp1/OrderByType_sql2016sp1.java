...
public class OrderByType_sql2016sp1 {

    @XmlElement(name = "OrderByColumn", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
    protected List<OrderByType_sql2016sp1 .OrderByColumn_sql2016sp1> orderByColumn;
     ...
     * {@link OrderByType_sql2016sp1 .OrderByColumn_sql2016sp1 }
     * 
     * 
     */
    public List<OrderByType_sql2016sp1 .OrderByColumn_sql2016sp1> getOrderByColumn() {
        if (orderByColumn == null) {
            orderByColumn = new ArrayList<OrderByType_sql2016sp1 .OrderByColumn_sql2016sp1>();
        }
    ...
    public static class OrderByColumn_sql2016sp1 {
         ...
         *     
         */
        public ColumnReferenceType_sql2016sp1 getColumnReference() {
         ...
         *     
         */
        public void setColumnReference(ColumnReferenceType_sql2016sp1 value) {
