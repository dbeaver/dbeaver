...
@XmlEnum
public enum LogicalOpType_sql2014 {
    ...
    LogicalOpType_sql2014(String v) {
        value = v;
    }
    ...
    public static LogicalOpType_sql2014 fromValue(String v) {
        for (LogicalOpType_sql2014 c: LogicalOpType_sql2014 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
