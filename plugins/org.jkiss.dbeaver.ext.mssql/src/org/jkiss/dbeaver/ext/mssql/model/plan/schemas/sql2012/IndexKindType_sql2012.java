...
@XmlEnum
public enum IndexKindType_sql2012 {
    ...
    IndexKindType_sql2012(String v) {
        value = v;
    }
    ...
    public static IndexKindType_sql2012 fromValue(String v) {
        for (IndexKindType_sql2012 c: IndexKindType_sql2012 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
