...
public class ShowPlanXML {
    ...
    protected ShowPlanXML.BatchSequence_sql2005sp2 batchSequence;
     ...
     * @return
     *     possible object is
     *     {@link ShowPlanXML.BatchSequence_sql2005sp2 }
     *     
     */
    public ShowPlanXML.BatchSequence_sql2005sp2 getBatchSequence() {
     ...
     *     
     */
    public void setBatchSequence(ShowPlanXML.BatchSequence_sql2005sp2 value) {
    ...
    public static class BatchSequence_sql2005sp2 {

        @XmlElement(name = "Batch", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
        protected List<ShowPlanXML.BatchSequence_sql2005sp2 .Batch_sql2005sp2> batch;
         ...
         * {@link ShowPlanXML.BatchSequence_sql2005sp2 .Batch_sql2005sp2 }
         * 
         * 
         */
        public List<ShowPlanXML.BatchSequence_sql2005sp2 .Batch_sql2005sp2> getBatch() {
            if (batch == null) {
                batch = new ArrayList<ShowPlanXML.BatchSequence_sql2005sp2 .Batch_sql2005sp2>();
            }
            return this.batch;
        }
        ...
        public static class Batch_sql2005sp2 {
             ...
             * 
             */
            public List<StmtBlockType_sql2005sp2> getStatements() {
                if (statements == null) {
                    statements = new ArrayList<StmtBlockType_sql2005sp2>();
                }
