...
@XmlEnum
public enum CursorType_sql2008 {
    ...
    public static CursorType_sql2008 fromValue(String v) {
        for (CursorType_sql2008 c: CursorType_sql2008 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
