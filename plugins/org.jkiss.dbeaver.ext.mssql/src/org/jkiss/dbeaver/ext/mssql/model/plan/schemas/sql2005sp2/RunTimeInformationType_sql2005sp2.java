...
public class RunTimeInformationType_sql2005sp2 {

    @XmlElement(name = "RunTimeCountersPerThread", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
    protected List<RunTimeInformationType_sql2005sp2 .RunTimeCountersPerThread_sql2005sp2> runTimeCountersPerThread;
     ...
     * {@link RunTimeInformationType_sql2005sp2 .RunTimeCountersPerThread_sql2005sp2 }
     * 
     * 
     */
    public List<RunTimeInformationType_sql2005sp2 .RunTimeCountersPerThread_sql2005sp2> getRunTimeCountersPerThread() {
        if (runTimeCountersPerThread == null) {
            runTimeCountersPerThread = new ArrayList<RunTimeInformationType_sql2005sp2 .RunTimeCountersPerThread_sql2005sp2>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class RunTimeCountersPerThread_sql2005sp2 {
