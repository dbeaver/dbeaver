...
@XmlEnum
public enum SetPredicateType_sql2016 {
    ...
    SetPredicateType_sql2016(String v) {
        value = v;
    }
    ...
    public static SetPredicateType_sql2016 fromValue(String v) {
        for (SetPredicateType_sql2016 c: SetPredicateType_sql2016 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
