...
@XmlEnum
public enum LogicalOperationType_sql2014 {
    ...
    LogicalOperationType_sql2014(String v) {
        value = v;
    }
    ...
    public static LogicalOperationType_sql2014 fromValue(String v) {
        for (LogicalOperationType_sql2014 c: LogicalOperationType_sql2014 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
