...
@XmlEnum
public enum LogicalOpType_sql2017 {
    ...
    LogicalOpType_sql2017(String v) {
        value = v;
    }
    ...
    public static LogicalOpType_sql2017 fromValue(String v) {
        for (LogicalOpType_sql2017 c: LogicalOpType_sql2017 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
