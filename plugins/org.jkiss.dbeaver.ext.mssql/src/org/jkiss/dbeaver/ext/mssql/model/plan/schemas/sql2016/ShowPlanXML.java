...
public class ShowPlanXML {
    ...
    protected ShowPlanXML.BatchSequence_sql2016 batchSequence;
     ...
     * @return
     *     possible object is
     *     {@link ShowPlanXML.BatchSequence_sql2016 }
     *     
     */
    public ShowPlanXML.BatchSequence_sql2016 getBatchSequence() {
     ...
     *     
     */
    public void setBatchSequence(ShowPlanXML.BatchSequence_sql2016 value) {
    ...
    public static class BatchSequence_sql2016 {

        @XmlElement(name = "Batch", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
        protected List<ShowPlanXML.BatchSequence_sql2016 .Batch_sql2016> batch;
         ...
         * {@link ShowPlanXML.BatchSequence_sql2016 .Batch_sql2016 }
         * 
         * 
         */
        public List<ShowPlanXML.BatchSequence_sql2016 .Batch_sql2016> getBatch() {
            if (batch == null) {
                batch = new ArrayList<ShowPlanXML.BatchSequence_sql2016 .Batch_sql2016>();
            }
            return this.batch;
        }
        ...
        public static class Batch_sql2016 {
             ...
             * 
             */
            public List<StmtBlockType_sql2016> getStatements() {
                if (statements == null) {
                    statements = new ArrayList<StmtBlockType_sql2016>();
                }
