...
@XmlEnum
public enum StorageType_sql2014 {
    ...
    public static StorageType_sql2014 fromValue(String v) {
        for (StorageType_sql2014 c: StorageType_sql2014 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
