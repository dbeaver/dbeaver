...
@XmlEnum
public enum SubqueryOperationType_sql2008 {
    ...
    SubqueryOperationType_sql2008(String v) {
        value = v;
    }
    ...
    public static SubqueryOperationType_sql2008 fromValue(String v) {
        for (SubqueryOperationType_sql2008 c: SubqueryOperationType_sql2008 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
