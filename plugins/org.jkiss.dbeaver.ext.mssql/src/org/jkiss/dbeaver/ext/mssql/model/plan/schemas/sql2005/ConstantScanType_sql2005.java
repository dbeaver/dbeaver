    ...
    extends RelOpBaseType_sql2005
{
     ...
     * @return
     *     possible object is
     *     {@link ConstantScanType_sql2005 .Values_sql2005 }
     *     
     */
    public ConstantScanType_sql2005 .Values_sql2005 getValues() {
        return values;
    }
     ...
     *     
     */
    public void setValues(ConstantScanType_sql2005 .Values_sql2005 value) {
        this.values = value;
    }
    ...
    public static class Values_sql2005 {

        @XmlElement(name = "Row", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
        protected List<ScalarExpressionListType_sql2005> row;
         ...
         * 
         */
        public List<ScalarExpressionListType_sql2005> getRow() {
            if (row == null) {
                row = new ArrayList<ScalarExpressionListType_sql2005>();
            }
            return this.row;
        }
