...
@XmlEnum
public enum PartitionType_sql2005sp2 {
    ...
    PartitionType_sql2005sp2(String v) {
        value = v;
    }
    ...
    public static PartitionType_sql2005sp2 fromValue(String v) {
        for (PartitionType_sql2005sp2 c: PartitionType_sql2005sp2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
