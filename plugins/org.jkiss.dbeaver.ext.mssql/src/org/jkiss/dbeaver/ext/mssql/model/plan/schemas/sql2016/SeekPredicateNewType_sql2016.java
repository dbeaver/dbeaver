...
public class SeekPredicateNewType_sql2016 {
     ...
     * 
     */
    public List<SeekPredicateType_sql2016> getSeekKeys() {
        if (seekKeys == null) {
            seekKeys = new ArrayList<SeekPredicateType_sql2016>();
        }
