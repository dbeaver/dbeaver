...
public class TraceFlagType_sql2017 {

    @XmlAttribute(name = "Value", required = true)
    @XmlSchemaType(name = "unsignedLong")
    protected BigInteger value;
    @XmlAttribute(name = "Scope", required = true)
    protected TraceFlagScopeType_sql2017 scope;
     ...
     * @return
     *     possible object is
     *     {@link TraceFlagScopeType_sql2017 }
     *     
     */
    public TraceFlagScopeType_sql2017 getScope() {
        return scope;
    }
     ...
     *     
     */
    public void setScope(TraceFlagScopeType_sql2017 value) {
        this.scope = value;
    }
