...
@XmlEnum
public enum StorageType_sql2016 {
    ...
    public static StorageType_sql2016 fromValue(String v) {
        for (StorageType_sql2016 c: StorageType_sql2016 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
