...
public class ColumnGroupType_sql2014 {
     ...
     * {@link ColumnType_sql2014 }
     * 
     * 
     */
    public List<ColumnType_sql2014> getColumn() {
        if (column == null) {
            column = new ArrayList<ColumnType_sql2014>();
        }
        return this.column;
    }
