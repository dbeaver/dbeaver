...
@XmlEnum
public enum PartitionType_sql2016sp1 {
    ...
    PartitionType_sql2016sp1(String v) {
        value = v;
    }
    ...
    public static PartitionType_sql2016sp1 fromValue(String v) {
        for (PartitionType_sql2016sp1 c: PartitionType_sql2016sp1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
