...
public class ShowPlanXML {
    ...
    protected ShowPlanXML.BatchSequence_sql2012 batchSequence;
     ...
     * @return
     *     possible object is
     *     {@link ShowPlanXML.BatchSequence_sql2012 }
     *     
     */
    public ShowPlanXML.BatchSequence_sql2012 getBatchSequence() {
     ...
     *     
     */
    public void setBatchSequence(ShowPlanXML.BatchSequence_sql2012 value) {
    ...
    public static class BatchSequence_sql2012 {

        @XmlElement(name = "Batch", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
        protected List<ShowPlanXML.BatchSequence_sql2012 .Batch_sql2012> batch;
         ...
         * {@link ShowPlanXML.BatchSequence_sql2012 .Batch_sql2012 }
         * 
         * 
         */
        public List<ShowPlanXML.BatchSequence_sql2012 .Batch_sql2012> getBatch() {
            if (batch == null) {
                batch = new ArrayList<ShowPlanXML.BatchSequence_sql2012 .Batch_sql2012>();
            }
            return this.batch;
        }
        ...
        public static class Batch_sql2012 {
             ...
             * 
             */
            public List<StmtBlockType_sql2012> getStatements() {
                if (statements == null) {
                    statements = new ArrayList<StmtBlockType_sql2012>();
                }
