...
@XmlEnum
public enum LogicalOpType_sql2005 {
    ...
    LogicalOpType_sql2005(String v) {
        value = v;
    }
    ...
    public static LogicalOpType_sql2005 fromValue(String v) {
        for (LogicalOpType_sql2005 c: LogicalOpType_sql2005 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
