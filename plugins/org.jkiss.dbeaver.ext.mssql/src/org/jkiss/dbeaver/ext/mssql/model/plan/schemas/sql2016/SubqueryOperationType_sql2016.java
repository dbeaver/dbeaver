...
@XmlEnum
public enum SubqueryOperationType_sql2016 {
    ...
    SubqueryOperationType_sql2016(String v) {
        value = v;
    }
    ...
    public static SubqueryOperationType_sql2016 fromValue(String v) {
        for (SubqueryOperationType_sql2016 c: SubqueryOperationType_sql2016 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
