...
@XmlEnum
public enum LogicalOperationType_sql2005 {
    ...
    LogicalOperationType_sql2005(String v) {
        value = v;
    }
    ...
    public static LogicalOperationType_sql2005 fromValue(String v) {
        for (LogicalOperationType_sql2005 c: LogicalOperationType_sql2005 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
