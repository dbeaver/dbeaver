...
@XmlEnum
public enum SetPredicateType_sql2017 {
    ...
    SetPredicateType_sql2017(String v) {
        value = v;
    }
    ...
    public static SetPredicateType_sql2017 fromValue(String v) {
        for (SetPredicateType_sql2017 c: SetPredicateType_sql2017 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
