...
@XmlEnum
public enum CloneAccessScopeType_sql2016sp1 {
    ...
    CloneAccessScopeType_sql2016sp1(String v) {
        value = v;
    }
    ...
    public static CloneAccessScopeType_sql2016sp1 fromValue(String v) {
        for (CloneAccessScopeType_sql2016sp1 c: CloneAccessScopeType_sql2016sp1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
