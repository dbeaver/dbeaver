...
@XmlEnum
public enum LogicalOpType_sql2014sp2 {
    ...
    LogicalOpType_sql2014sp2(String v) {
        value = v;
    }
    ...
    public static LogicalOpType_sql2014sp2 fromValue(String v) {
        for (LogicalOpType_sql2014sp2 c: LogicalOpType_sql2014sp2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
