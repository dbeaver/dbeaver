...
public class WarningsType_sql2016 {

    @XmlElements({
        @XmlElement(name = "ColumnsWithNoStatistics", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = ColumnReferenceListType_sql2016 .class),
        @XmlElement(name = "SpillToTempDb", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = SpillToTempDbType_sql2016 .class),
        @XmlElement(name = "Wait", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = WaitWarningType_sql2016 .class),
        @XmlElement(name = "PlanAffectingConvert", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = AffectingConvertWarningType_sql2016 .class),
        @XmlElement(name = "SortSpillDetails", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = SortSpillDetailsType_sql2016 .class),
        @XmlElement(name = "HashSpillDetails", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = HashSpillDetailsType_sql2016 .class)
    })
     ...
     * {@link SpillToTempDbType_sql2016 }
     * {@link WaitWarningType_sql2016 }
     * {@link AffectingConvertWarningType_sql2016 }
     * {@link SortSpillDetailsType_sql2016 }
     * {@link HashSpillDetailsType_sql2016 }
     * 
     * 
     */
