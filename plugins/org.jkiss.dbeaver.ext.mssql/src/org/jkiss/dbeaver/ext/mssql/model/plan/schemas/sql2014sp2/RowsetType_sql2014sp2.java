...
@XmlSeeAlso({
    CreateIndexType_sql2014sp2 .class,
    SimpleUpdateType_sql2014sp2 .class,
    TableScanType_sql2014sp2 .class,
    ScalarInsertType_sql2014sp2 .class,
    UpdateType_sql2014sp2 .class,
    IndexScanType_sql2014sp2 .class
})
public class RowsetType_sql2014sp2
    extends RelOpBaseType_sql2014sp2
{
    ...
    protected List<ObjectType_sql2014sp2> object;
     ...
     * 
     */
    public List<ObjectType_sql2014sp2> getObject() {
        if (object == null) {
            object = new ArrayList<ObjectType_sql2014sp2>();
        }
        return this.object;
    }
