...
@XmlEnum
public enum LogicalOperationType_sql2012 {
    ...
    LogicalOperationType_sql2012(String v) {
        value = v;
    }
    ...
    public static LogicalOperationType_sql2012 fromValue(String v) {
        for (LogicalOperationType_sql2012 c: LogicalOperationType_sql2012 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
