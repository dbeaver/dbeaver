...
public class WaitStatListType_sql2017 {
     ...
     * {@link WaitStatType_sql2017 }
     * 
     * 
     */
    public List<WaitStatType_sql2017> getWait() {
        if (wait == null) {
            wait = new ArrayList<WaitStatType_sql2017>();
        }
        return this.wait;
    }
