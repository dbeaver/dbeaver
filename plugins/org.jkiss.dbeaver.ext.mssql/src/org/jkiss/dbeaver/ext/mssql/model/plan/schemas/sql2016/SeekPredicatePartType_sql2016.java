...
public class SeekPredicatePartType_sql2016 {

    @XmlElement(name = "SeekPredicateNew", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
    protected List<SeekPredicateNewType_sql2016> seekPredicateNew;
     ...
     * 
     */
    public List<SeekPredicateNewType_sql2016> getSeekPredicateNew() {
        if (seekPredicateNew == null) {
            seekPredicateNew = new ArrayList<SeekPredicateNewType_sql2016>();
        }
