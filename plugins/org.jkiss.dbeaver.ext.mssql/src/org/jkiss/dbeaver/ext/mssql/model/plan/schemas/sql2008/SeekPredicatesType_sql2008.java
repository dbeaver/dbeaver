...
public class SeekPredicatesType_sql2008 {
     ...
     * 
     */
    public List<SeekPredicateType_sql2008> getSeekPredicate() {
        if (seekPredicate == null) {
            seekPredicate = new ArrayList<SeekPredicateType_sql2008>();
        }
     ...
     * 
     */
    public List<SeekPredicateNewType_sql2008> getSeekPredicateNew() {
        if (seekPredicateNew == null) {
            seekPredicateNew = new ArrayList<SeekPredicateNewType_sql2008>();
        }
