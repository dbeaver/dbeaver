...
@XmlSeeAlso({
    CreateIndexType_sql2016 .class,
    SimpleUpdateType_sql2016 .class,
    TableScanType_sql2016 .class,
    ScalarInsertType_sql2016 .class,
    UpdateType_sql2016 .class,
    IndexScanType_sql2016 .class
})
public class RowsetType_sql2016
    extends RelOpBaseType_sql2016
{
    ...
    protected List<ObjectType_sql2016> object;
     ...
     * 
     */
    public List<ObjectType_sql2016> getObject() {
        if (object == null) {
            object = new ArrayList<ObjectType_sql2016>();
        }
        return this.object;
    }
