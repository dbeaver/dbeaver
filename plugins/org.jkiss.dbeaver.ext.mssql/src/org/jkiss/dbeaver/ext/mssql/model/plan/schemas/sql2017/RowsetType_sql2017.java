...
@XmlSeeAlso({
    CreateIndexType_sql2017 .class,
    SimpleUpdateType_sql2017 .class,
    TableScanType_sql2017 .class,
    ScalarInsertType_sql2017 .class,
    UpdateType_sql2017 .class,
    IndexScanType_sql2017 .class
})
public class RowsetType_sql2017
    extends RelOpBaseType_sql2017
{
    ...
    protected List<ObjectType_sql2017> object;
     ...
     * 
     */
    public List<ObjectType_sql2017> getObject() {
        if (object == null) {
            object = new ArrayList<ObjectType_sql2017>();
        }
        return this.object;
    }
