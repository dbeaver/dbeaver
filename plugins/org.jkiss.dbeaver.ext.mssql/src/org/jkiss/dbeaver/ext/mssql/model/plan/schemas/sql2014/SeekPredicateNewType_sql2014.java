...
public class SeekPredicateNewType_sql2014 {
     ...
     * 
     */
    public List<SeekPredicateType_sql2014> getSeekKeys() {
        if (seekKeys == null) {
            seekKeys = new ArrayList<SeekPredicateType_sql2014>();
        }
