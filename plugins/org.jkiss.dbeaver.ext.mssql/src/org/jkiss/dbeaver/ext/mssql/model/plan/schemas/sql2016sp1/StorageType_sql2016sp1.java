...
@XmlEnum
public enum StorageType_sql2016sp1 {
    ...
    StorageType_sql2016sp1(String v) {
        value = v;
    }
    ...
    public static StorageType_sql2016sp1 fromValue(String v) {
        for (StorageType_sql2016sp1 c: StorageType_sql2016sp1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
