...
public class RunTimeInformationType_sql2016 {

    @XmlElement(name = "RunTimeCountersPerThread", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
    protected List<RunTimeInformationType_sql2016 .RunTimeCountersPerThread_sql2016> runTimeCountersPerThread;
     ...
     * {@link RunTimeInformationType_sql2016 .RunTimeCountersPerThread_sql2016 }
     * 
     * 
     */
    public List<RunTimeInformationType_sql2016 .RunTimeCountersPerThread_sql2016> getRunTimeCountersPerThread() {
        if (runTimeCountersPerThread == null) {
            runTimeCountersPerThread = new ArrayList<RunTimeInformationType_sql2016 .RunTimeCountersPerThread_sql2016>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class RunTimeCountersPerThread_sql2016 {
        ...
        protected ExecutionModeType_sql2016 actualExecutionMode;
         ...
         *     
         */
        public ExecutionModeType_sql2016 getActualExecutionMode() {
         ...
         *     
         */
        public void setActualExecutionMode(ExecutionModeType_sql2016 value) {
