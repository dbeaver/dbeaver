...
@XmlEnum
public enum SubqueryOperationType_sql2012 {
    ...
    SubqueryOperationType_sql2012(String v) {
        value = v;
    }
    ...
    public static SubqueryOperationType_sql2012 fromValue(String v) {
        for (SubqueryOperationType_sql2012 c: SubqueryOperationType_sql2012 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
