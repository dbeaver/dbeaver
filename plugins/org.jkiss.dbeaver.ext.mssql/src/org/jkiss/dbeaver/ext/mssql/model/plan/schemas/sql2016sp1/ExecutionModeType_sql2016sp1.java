...
@XmlEnum
public enum ExecutionModeType_sql2016sp1 {
    ...
    ExecutionModeType_sql2016sp1(String v) {
        value = v;
    }
    ...
    public static ExecutionModeType_sql2016sp1 fromValue(String v) {
        for (ExecutionModeType_sql2016sp1 c: ExecutionModeType_sql2016sp1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
