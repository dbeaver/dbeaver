...
@XmlEnum
public enum IndexKindType_sql2017 {
    ...
    IndexKindType_sql2017(String v) {
        value = v;
    }
    ...
    public static IndexKindType_sql2017 fromValue(String v) {
        for (IndexKindType_sql2017 c: IndexKindType_sql2017 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
