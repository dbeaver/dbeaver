...
@XmlEnum
public enum LogicalOpType_sql2005sp2 {
    ...
    LogicalOpType_sql2005sp2(String v) {
        value = v;
    }
    ...
    public static LogicalOpType_sql2005sp2 fromValue(String v) {
        for (LogicalOpType_sql2005sp2 c: LogicalOpType_sql2005sp2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
