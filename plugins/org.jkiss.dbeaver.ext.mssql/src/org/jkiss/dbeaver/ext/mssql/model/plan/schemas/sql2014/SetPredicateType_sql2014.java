...
@XmlEnum
public enum SetPredicateType_sql2014 {
    ...
    SetPredicateType_sql2014(String v) {
        value = v;
    }
    ...
    public static SetPredicateType_sql2014 fromValue(String v) {
        for (SetPredicateType_sql2014 c: SetPredicateType_sql2014 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
