...
@XmlEnum
public enum ExecutionModeType_sql2012 {
    ...
    ExecutionModeType_sql2012(String v) {
        value = v;
    }
    ...
    public static ExecutionModeType_sql2012 fromValue(String v) {
        for (ExecutionModeType_sql2012 c: ExecutionModeType_sql2012 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
