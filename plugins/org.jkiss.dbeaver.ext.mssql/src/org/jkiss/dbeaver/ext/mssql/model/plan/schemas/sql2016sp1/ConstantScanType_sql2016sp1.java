    ...
    extends RelOpBaseType_sql2016sp1
{
     ...
     * @return
     *     possible object is
     *     {@link ConstantScanType_sql2016sp1 .Values_sql2016sp1 }
     *     
     */
    public ConstantScanType_sql2016sp1 .Values_sql2016sp1 getValues() {
        return values;
    }
     ...
     *     
     */
    public void setValues(ConstantScanType_sql2016sp1 .Values_sql2016sp1 value) {
        this.values = value;
    }
    ...
    public static class Values_sql2016sp1 {

        @XmlElement(name = "Row", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
        protected List<ScalarExpressionListType_sql2016sp1> row;
         ...
         * 
         */
        public List<ScalarExpressionListType_sql2016sp1> getRow() {
            if (row == null) {
                row = new ArrayList<ScalarExpressionListType_sql2016sp1>();
            }
            return this.row;
        }
