...
@XmlEnum
public enum IndexKindType_sql2014sp2 {
    ...
    IndexKindType_sql2014sp2(String v) {
        value = v;
    }
    ...
    public static IndexKindType_sql2014sp2 fromValue(String v) {
        for (IndexKindType_sql2014sp2 c: IndexKindType_sql2014sp2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
