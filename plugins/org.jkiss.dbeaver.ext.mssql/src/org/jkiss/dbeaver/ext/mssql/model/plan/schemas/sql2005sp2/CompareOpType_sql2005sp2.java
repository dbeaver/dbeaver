...
@XmlEnum
public enum CompareOpType_sql2005sp2 {
    ...
    CompareOpType_sql2005sp2(String v) {
        value = v;
    }
    ...
    public static CompareOpType_sql2005sp2 fromValue(String v) {
        for (CompareOpType_sql2005sp2 c: CompareOpType_sql2005sp2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
