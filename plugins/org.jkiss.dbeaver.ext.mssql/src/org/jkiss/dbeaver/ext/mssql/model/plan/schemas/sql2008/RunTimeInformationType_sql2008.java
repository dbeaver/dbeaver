...
public class RunTimeInformationType_sql2008 {

    @XmlElement(name = "RunTimeCountersPerThread", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
    protected List<RunTimeInformationType_sql2008 .RunTimeCountersPerThread_sql2008> runTimeCountersPerThread;
     ...
     * {@link RunTimeInformationType_sql2008 .RunTimeCountersPerThread_sql2008 }
     * 
     * 
     */
    public List<RunTimeInformationType_sql2008 .RunTimeCountersPerThread_sql2008> getRunTimeCountersPerThread() {
        if (runTimeCountersPerThread == null) {
            runTimeCountersPerThread = new ArrayList<RunTimeInformationType_sql2008 .RunTimeCountersPerThread_sql2008>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class RunTimeCountersPerThread_sql2008 {
