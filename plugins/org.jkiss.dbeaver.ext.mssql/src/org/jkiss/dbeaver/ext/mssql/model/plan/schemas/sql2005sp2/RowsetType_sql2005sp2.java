...
@XmlSeeAlso({
    TableScanType_sql2005sp2 .class,
    ScalarInsertType_sql2005sp2 .class,
    UpdateType_sql2005sp2 .class,
    CreateIndexType_sql2005sp2 .class,
    SimpleUpdateType_sql2005sp2 .class,
    IndexScanType_sql2005sp2 .class
})
public class RowsetType_sql2005sp2
