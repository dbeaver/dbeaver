...
@XmlEnum
public enum SetPredicateType_sql2016sp1 {
    ...
    SetPredicateType_sql2016sp1(String v) {
        value = v;
    }
    ...
    public static SetPredicateType_sql2016sp1 fromValue(String v) {
        for (SetPredicateType_sql2016sp1 c: SetPredicateType_sql2016sp1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
