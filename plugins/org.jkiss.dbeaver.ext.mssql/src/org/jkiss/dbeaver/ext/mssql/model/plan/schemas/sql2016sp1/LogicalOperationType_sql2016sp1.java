...
@XmlEnum
public enum LogicalOperationType_sql2016sp1 {
    ...
    LogicalOperationType_sql2016sp1(String v) {
        value = v;
    }
    ...
    public static LogicalOperationType_sql2016sp1 fromValue(String v) {
        for (LogicalOperationType_sql2016sp1 c: LogicalOperationType_sql2016sp1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
