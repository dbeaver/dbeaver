...
public class ColumnGroupType_sql2016sp1 {
     ...
     * {@link ColumnType_sql2016sp1 }
     * 
     * 
     */
    public List<ColumnType_sql2016sp1> getColumn() {
        if (column == null) {
            column = new ArrayList<ColumnType_sql2016sp1>();
        }
        return this.column;
    }
