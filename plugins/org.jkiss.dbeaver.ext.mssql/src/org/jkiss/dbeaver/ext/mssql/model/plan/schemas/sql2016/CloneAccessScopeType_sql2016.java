...
@XmlEnum
public enum CloneAccessScopeType_sql2016 {
    ...
    CloneAccessScopeType_sql2016(String v) {
        value = v;
    }
    ...
    public static CloneAccessScopeType_sql2016 fromValue(String v) {
        for (CloneAccessScopeType_sql2016 c: CloneAccessScopeType_sql2016 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
