...
@XmlEnum
public enum SubqueryOperationType_sql2005 {
    ...
    SubqueryOperationType_sql2005(String v) {
        value = v;
    }
    ...
    public static SubqueryOperationType_sql2005 fromValue(String v) {
        for (SubqueryOperationType_sql2005 c: SubqueryOperationType_sql2005 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
