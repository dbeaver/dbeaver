...
public class StmtBlockType_sql2016 {

    @XmlElements({
        @XmlElement(name = "StmtSimple", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtSimpleType_sql2016 .class),
        @XmlElement(name = "StmtCond", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtCondType_sql2016 .class),
        @XmlElement(name = "StmtCursor", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtCursorType_sql2016 .class),
        @XmlElement(name = "StmtReceive", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtReceiveType_sql2016 .class),
        @XmlElement(name = "StmtUseDb", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtUseDbType_sql2016 .class)
    })
    protected List<BaseStmtInfoType_sql2016> stmtSimpleOrStmtCondOrStmtCursor;
     ...
     * {@link StmtSimpleType_sql2016 }
     * {@link StmtCondType_sql2016 }
     * {@link StmtCursorType_sql2016 }
     * {@link StmtReceiveType_sql2016 }
     * {@link StmtUseDbType_sql2016 }
     * 
     * 
     */
    public List<BaseStmtInfoType_sql2016> getStmtSimpleOrStmtCondOrStmtCursor() {
        if (stmtSimpleOrStmtCondOrStmtCursor == null) {
            stmtSimpleOrStmtCondOrStmtCursor = new ArrayList<BaseStmtInfoType_sql2016>();
        }
