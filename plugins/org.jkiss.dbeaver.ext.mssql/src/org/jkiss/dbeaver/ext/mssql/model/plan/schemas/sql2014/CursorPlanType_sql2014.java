...
public class CursorPlanType_sql2014 {

    @XmlElement(name = "Operation", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
    protected List<CursorPlanType_sql2014 .Operation_sql2014> operation;
    @XmlAttribute(name = "CursorName")
    protected String cursorName;
    @XmlAttribute(name = "CursorActualType")
    protected CursorType_sql2014 cursorActualType;
    @XmlAttribute(name = "CursorRequestedType")
    protected CursorType_sql2014 cursorRequestedType;
     ...
     * {@link CursorPlanType_sql2014 .Operation_sql2014 }
     * 
     * 
     */
    public List<CursorPlanType_sql2014 .Operation_sql2014> getOperation() {
        if (operation == null) {
            operation = new ArrayList<CursorPlanType_sql2014 .Operation_sql2014>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CursorType_sql2014 }
     *     
     */
    public CursorType_sql2014 getCursorActualType() {
     ...
     *     
     */
    public void setCursorActualType(CursorType_sql2014 value) {
     ...
     *     
     */
    public CursorType_sql2014 getCursorRequestedType() {
     ...
     *     
     */
    public void setCursorRequestedType(CursorType_sql2014 value) {
