...
public class SeekPredicatesType_sql2014sp2 {
     ...
     * {@link SeekPredicateType_sql2014sp2 }
     * 
     * 
     */
    public List<SeekPredicateType_sql2014sp2> getSeekPredicate() {
        if (seekPredicate == null) {
            seekPredicate = new ArrayList<SeekPredicateType_sql2014sp2>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SeekPredicateNewType_sql2014sp2 }
     * 
     * 
     */
    public List<SeekPredicateNewType_sql2014sp2> getSeekPredicateNew() {
        if (seekPredicateNew == null) {
            seekPredicateNew = new ArrayList<SeekPredicateNewType_sql2014sp2>();
        }
