...
public class SeekPredicateNewType_sql2008 {
     ...
     * 
     */
    public List<SeekPredicateType_sql2008> getSeekKeys() {
        if (seekKeys == null) {
            seekKeys = new ArrayList<SeekPredicateType_sql2008>();
        }
