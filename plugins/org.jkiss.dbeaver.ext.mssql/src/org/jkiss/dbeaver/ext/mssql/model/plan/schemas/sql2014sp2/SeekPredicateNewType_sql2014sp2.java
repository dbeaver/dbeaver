...
public class SeekPredicateNewType_sql2014sp2 {
     ...
     * 
     */
    public List<SeekPredicateType_sql2014sp2> getSeekKeys() {
        if (seekKeys == null) {
            seekKeys = new ArrayList<SeekPredicateType_sql2014sp2>();
        }
