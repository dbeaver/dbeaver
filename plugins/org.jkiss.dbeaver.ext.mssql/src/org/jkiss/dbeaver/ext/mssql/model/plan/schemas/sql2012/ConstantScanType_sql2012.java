    ...
    extends RelOpBaseType_sql2012
{
     ...
     * @return
     *     possible object is
     *     {@link ConstantScanType_sql2012 .Values_sql2012 }
     *     
     */
    public ConstantScanType_sql2012 .Values_sql2012 getValues() {
        return values;
    }
     ...
     *     
     */
    public void setValues(ConstantScanType_sql2012 .Values_sql2012 value) {
        this.values = value;
    }
    ...
    public static class Values_sql2012 {

        @XmlElement(name = "Row", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan")
        protected List<ScalarExpressionListType_sql2012> row;
         ...
         * 
         */
        public List<ScalarExpressionListType_sql2012> getRow() {
            if (row == null) {
                row = new ArrayList<ScalarExpressionListType_sql2012>();
            }
            return this.row;
        }
