...
public class SeekPredicatesType_sql2005sp2 {
     ...
     * 
     */
    public List<SeekPredicateType_sql2005sp2> getSeekPredicate() {
        if (seekPredicate == null) {
            seekPredicate = new ArrayList<SeekPredicateType_sql2005sp2>();
        }
