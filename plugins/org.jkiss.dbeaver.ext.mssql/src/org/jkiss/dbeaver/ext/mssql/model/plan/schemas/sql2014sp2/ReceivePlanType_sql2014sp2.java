...
public class ReceivePlanType_sql2014sp2 {

    @XmlElement(name = "Operation", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", required = true)
    protected List<ReceivePlanType_sql2014sp2 .Operation_sql2014sp2> operation;
     ...
     * {@link ReceivePlanType_sql2014sp2 .Operation_sql2014sp2 }
     * 
     * 
     */
    public List<ReceivePlanType_sql2014sp2 .Operation_sql2014sp2> getOperation() {
        if (operation == null) {
            operation = new ArrayList<ReceivePlanType_sql2014sp2 .Operation_sql2014sp2>();
        }
