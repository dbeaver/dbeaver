...
public class StmtBlockType_sql2017 {

    @XmlElements({
        @XmlElement(name = "StmtSimple", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtSimpleType_sql2017 .class),
        @XmlElement(name = "StmtCond", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtCondType_sql2017 .class),
        @XmlElement(name = "StmtCursor", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtCursorType_sql2017 .class),
        @XmlElement(name = "StmtReceive", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtReceiveType_sql2017 .class),
        @XmlElement(name = "StmtUseDb", namespace = "http://schemas.microsoft.com/sqlserver/2004/07/showplan", type = StmtUseDbType_sql2017 .class)
    })
    protected List<BaseStmtInfoType_sql2017> stmtSimpleOrStmtCondOrStmtCursor;
     ...
     * {@link StmtSimpleType_sql2017 }
     * {@link StmtCondType_sql2017 }
     * {@link StmtCursorType_sql2017 }
     * {@link StmtReceiveType_sql2017 }
     * {@link StmtUseDbType_sql2017 }
     * 
     * 
     */
    public List<BaseStmtInfoType_sql2017> getStmtSimpleOrStmtCondOrStmtCursor() {
        if (stmtSimpleOrStmtCondOrStmtCursor == null) {
            stmtSimpleOrStmtCondOrStmtCursor = new ArrayList<BaseStmtInfoType_sql2017>();
        }
