...
public abstract class SQLGenerator<OBJECT> extends DBRRunnableWithResult<String> {
    ...
    private boolean useSeparateConstraintIndexes = false;
    ...
    public boolean isUseSeparateConstraintIndexes() {
        return useSeparateConstraintIndexes;
    }

    public void setUseSeparateConstraintIndexes(boolean useSeparateConstraintIndexes) {
        this.useSeparateConstraintIndexes = useSeparateConstraintIndexes;
    }
    ...
    protected void addOptions(Map<String, Object> options) {
        ...
        options.put(DBPScriptObject.OPTION_DDL_SEPARATE_CONSTRAINT_INDEXES, isUseSeparateConstraintIndexes());
