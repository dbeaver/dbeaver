...
public class SQLScriptParser {
        ...
        final boolean keepDelimiters)
    {
        ...
        for (; ; ) {
            ...
            if ((firstKeyword !=null && lastKeyword != null) && (firstKeyword.equalsIgnoreCase("DROP")
                    || firstKeyword.equalsIgnoreCase("CREATE"))
            && lastKeyword.equalsIgnoreCase("IF")){
                prevNotEmptyTokenType=SQLTokenType.T_KEYWORD;
                hasBlocks=false;
                curBlock=null;
            }
