...
public class DB2ConnectionPage extends ConnectionPageAbstract implements ICompositeDialogPage {
   ...
   public void createControl(Composite composite) {
...

      {
         ...
         urlLabel.setText(DB2Messages.dialog_connection_jdbc_url_);
      ...
      }
      {
         ...
         hostLabel.setText(DB2Messages.dialog_connection_host_label);
         ...
         portLabel.setText(DB2Messages.dialog_connection_port_label);
...

      {
         ...
         serverLabel.setText(DB2Messages.dialog_connection_server_label);
...

      {
         ...
         dbLabel.setText(DB2Messages.dialog_connection_database_schema_label);
...

      {
         ...
         pathLabel.setText(DB2Messages.dialog_connection_path_label);
         ...
         browseButton.setText(DB2Messages.dialog_connection_browse_button);
         gd = new GridData(GridData.FILL_HORIZONTAL);
         gd.horizontalSpan = 2;
         ...
         browseButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
               if (metaURL.getAvailableProperties().contains(DriverDescriptor.PROP_FILE)) {
                  ...
                  dialog.setText(DB2Messages.dialog_connection_db_file_chooser_text);
                  ...
                  dialog.setText(DB2Messages.dialog_connection_db_folder_chooser_text);
                  dialog.setMessage(DB2Messages.dialog_connection_db_folder_chooser_message);
...

      {
         ...
         userNameLabel.setText(DB2Messages.dialog_connection_user_name_label);
         ...
         passwordLabel.setText(DB2Messages.dialog_connection_password_label);
...

      {
         ...
         driverButton.setText(DB2Messages.dialog_connection_edit_driver_button);
   ...
   protected void saveSettings(DBPConnectionInfo connectionInfo) {
      if (connectionInfo != null) {
         ...
         if (pathText != null
                  && (properties.contains(DriverDescriptor.PROP_FOLDER) || properties.contains(DriverDescriptor.PROP_FILE))) {
