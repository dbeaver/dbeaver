...
options {
    ...
    superClass=org.jkiss.dbeaver.model.sql.lsm.mapping.internal.ParserOverrides;
    contextSuperClass=org.jkiss.dbeaver.model.sql.lsm.mapping.internal.TreeRuleNode;
}
