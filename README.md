...
- [We are happy to reward](https://dbeaver.com/help-beaver/) our most active contributors every major sprint. The most significant contribution to our code for the major release 24.2.0 was made by: [GaussDB-Fans](https://github.com/GaussDB-Fans), [longhaseng52](https://github.com/longhaseng52), [rathana-pvs](https://github.com/rathana-pvs), [zennken](https://github.com/zennken), [v613](https://github.com/v613), [ask9](https://github.com/dbeaver/dbeaver/issues/created_by/ask9), [Stkai](https://github.com/Stkai), [Jean-BaptisteC](https://github.com/Jean-BaptisteC), [kai-morich](https://github.com/kai-morich), and [Sargul](https://github.com/Sargul).
