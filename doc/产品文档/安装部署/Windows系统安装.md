...
<div align="left">
<img src="image/Windows系统安装/jdk文件目录.png" width="688" height="340"/>
</div>

在系统中搜索*环境变量*并打开*编辑系统环境变量*：
<div align="left">
<img src="image/Windows系统安装/环境变量.png" width="700" height="266"/>
</div>

选中*系统环境变量*中的*Path*变量并点击编辑按钮，弹出编辑环境变量的编辑框：
<div align="left">
<img src="image/Windows系统安装/编辑环境变量.png" width="899" height="500"/>
</div>

在编辑框中点击新建按钮，新增Java环境变量值。例如，本地解压的JDK路径为：*D:\jdk-17.0.8*,在新建变量值时定位到此路径下的*bin*目录即可。
<div align="left">
<img src="image/Windows系统安装/配置jdk变量.png" height="580" width="500"/>
</div>

配置完成后点击确定，关闭环境变量窗口，以应用修改。然后使用*Win+R*组合键调出运行窗口，在窗口输入框键入*cmd*，点击确定，弹出cmd命令窗口。在命令窗口中键入*Java -version*，会输出Java版本号，说明Java环境变量配置成功。
``` java
...
<div align="left">
<img src="image/Windows系统安装/Windows版本DBeaver文件夹目录.png" width="700" height="362"/>
</div>

双击*DBeaver.exe*应用程序文件，即可启动DBeaver，初始界面如下图所示：
<div align="left">
<img src="image/Windows系统安装/dbeaver初始化界面.png" />
</div>
