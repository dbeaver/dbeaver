...
public class GeneralUtilsTest {
    private static final String VALID_INPUT_STRING = "test key word"; //$NON-NLS-1$
    private static final String NON_VALID_INPUT_STRING_SPACE_BEGINAFTER = "   test key word "; //$NON-NLS-1$
    private static final int[] VALID_STRING_ARRAY = {
        116, 101, 115, 116, 32, 107, 101, 121, 32, 119, 111, 114, 100 // test key word
    };
    private static final int[] NON_VALID_STRING_ARRAY = {
        160, 32, 160, // spaces
        116, 101, 115, 116, 32, 107, 101, 121, 32, 119, 111, 114, 100, // test key word
        160, 32, 32 // spaces
    };
    ...
    @Test
    public void removeInvalidUnicodeSymbolFromNullOrEmptyStringTest() {
        String result = GeneralUtils.removeInValidUnicodeSymbol("");
        Assert.assertTrue(result.isEmpty());
        result = GeneralUtils.removeInValidUnicodeSymbol(null);
