...
public class AlphanumericComparatorTest {
    ...
    public void testAlphanumericComparator() {
        alphanumericComparatorTest(this::alphanumericComparatorTestImpl);
    }

    @Test
    public void testAlphanumericComparatorIgnoreCaseTestInsensitive() {
        alphanumericComparatorTest(this::alphanumericComparatorIgnoreCaseTestImpl);
    }
    ...
    public void comparatorIgnoreCaseContractTest() {
        ...
        alphanumericComparatorIgnoreCaseTestImpl(input, expected);
    }

    private void alphanumericComparatorTest(AssertionMethod  assertionMethod) {
        assertionMethod.assertCondition(
    ...
    private void alphanumericComparatorIgnoreCaseTestImpl(
        @NotNull Collection<? extends CharSequence> input,
        @NotNull Collection<? extends CharSequence> expected
    ) {
        final ArrayList<? extends CharSequence> sorted = new ArrayList<>(input);
        sorted.sort(AlphanumericComparator.getInstance()::compareIgnoreCase);

        assertEquals(expected, sorted);
    }

    private interface AssertionMethod {
