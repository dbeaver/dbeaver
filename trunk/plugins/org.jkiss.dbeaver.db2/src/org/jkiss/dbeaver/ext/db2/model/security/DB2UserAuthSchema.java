...
/**
 * DB2 User or Group Authorisations on Schemas
 * 
 * @author Denis Forveille
 */
public class DB2UserAuthSchema extends DB2UserAuthBase {
    ...
    // Constructors
    // -----------------------
    public DB2UserAuthSchema(DBRProgressMonitor monitor, DB2UserBase userOrGroup, DB2Schema db2Schema, ResultSet resultSet)
        throws DBException
    {
        super(monitor, userOrGroup, db2Schema, resultSet);
