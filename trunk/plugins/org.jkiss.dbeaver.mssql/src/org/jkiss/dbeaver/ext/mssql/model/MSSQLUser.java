...
public class MSSQLUser implements DBAUser, DBPRefreshableObject, DBPSaveableObject
{
    ...
    private List<MSSQLGrant> grants;
    private boolean persisted;

    public MSSQLUser(MSSQLDataSource dataSource, ResultSet resultSet) {
    ...
    public List<MSSQLGrant> getGrants(DBRProgressMonitor monitor)
        throws DBException
    {
        if (this.grants != null) {
            return this.grants;
                ...
                try {
                    ...
                    while (dbResult.next()) {
                        ...
                        if (grantString.endsWith(" WITH GRANT OPTION")) {
                            grantOption = true;//privileges.add(getDataSource().getPrivilege(monitor, MSSQLPrivilege.GRANT_PRIVILEGE));
                        }
