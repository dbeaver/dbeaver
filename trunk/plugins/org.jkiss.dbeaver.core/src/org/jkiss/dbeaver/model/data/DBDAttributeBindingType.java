...
public class DBDAttributeBindingType extends DBDAttributeBinding implements DBCAttributeMetaData, IObjectImageProvider {
    ...
    {
        super(parent.getDataSource(), parent, DBUtils.findValueHandler(parent.getDataSource(), entityAttribute));
    ...
    public boolean isAutoGenerated() {
        return entityAttribute.isAutoGenerated();
    }

    @Override
    public boolean isPseudoAttribute() {
        return entityAttribute.isPseudoAttribute();
    }
    ...
    public String getTypeName() {
        return entityAttribute.getTypeName();
    }

    @Override
    public int getTypeID() {
        return entityAttribute.getTypeID();
    }

    @Override
    public DBPDataKind getDataKind() {
        return entityAttribute.getDataKind();
    }

    @Override
    public int getScale() {
        return entityAttribute.getScale();
    }

    @Override
    public int getPrecision() {
        return entityAttribute.getPrecision();
    }

    @Override
    public long getMaxLength() {
        return entityAttribute.getMaxLength();
    }
}
